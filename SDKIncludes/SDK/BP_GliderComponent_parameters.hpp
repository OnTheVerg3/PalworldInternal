...
static_assert(sizeof(BP_GliderComponent_C_CheckReturnSpawnedOtomo) == 0x000038, "Wrong size on BP_GliderComponent_C_CheckReturnSpawnedOtomo");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, CallFunc_HasGliderPal_ReturnValue) == 0x000000, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::CallFunc_HasGliderPal_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, CallFunc_GetOwner_ReturnValue) == 0x000008, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, CallFunc_GetController_ReturnValue) == 0x000010, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, K2Node_DynamicCast_AsPal_Player_Controller) == 0x000018, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::K2Node_DynamicCast_AsPal_Player_Controller' has a wrong offset!");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, CallFunc_GetComponentByClass_ReturnValue) == 0x000028, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GliderComponent_C_CheckReturnSpawnedOtomo, CallFunc_IsValid_ReturnValue) == 0x000030, "Member 'BP_GliderComponent_C_CheckReturnSpawnedOtomo::CallFunc_IsValid_ReturnValue' has a wrong offset!");
