...
static_assert(sizeof(BP_OilrigMachineSpawnerComponent_C_On_Dead) == 0x000070, "Wrong size on BP_OilrigMachineSpawnerComponent_C_On_Dead");
...
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_On_Dead, CallFunc_GetExpDatabase_ReturnValue) == 0x000050, "Member 'BP_OilrigMachineSpawnerComponent_C_On_Dead::CallFunc_GetExpDatabase_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_On_Dead, K2Node_CreateDelegate_OutputDelegate) == 0x000058, "Member 'BP_OilrigMachineSpawnerComponent_C_On_Dead::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_OilrigMachineSpawnerComponent_C_On_Dead, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000068, "Member 'BP_OilrigMachineSpawnerComponent_C_On_Dead::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
