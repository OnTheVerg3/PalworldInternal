...
static_assert(sizeof(UBP_ActionFriendlyLookat_C) == 0x000180, "Wrong size on UBP_ActionFriendlyLookat_C");
static_assert(offsetof(UBP_ActionFriendlyLookat_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionFriendlyLookat_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_ActionFriendlyLookat_C, Niagra) == 0x000168, "Member 'UBP_ActionFriendlyLookat_C::Niagra' has a wrong offset!");
static_assert(offsetof(UBP_ActionFriendlyLookat_C, Offset) == 0x000170, "Member 'UBP_ActionFriendlyLookat_C::Offset' has a wrong offset!");
