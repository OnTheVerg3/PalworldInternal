...
static_assert(sizeof(UBP_ActionDiscoveryLookat_C) == 0x000170, "Wrong size on UBP_ActionDiscoveryLookat_C");
static_assert(offsetof(UBP_ActionDiscoveryLookat_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionDiscoveryLookat_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_ActionDiscoveryLookat_C, Niagra) == 0x000168, "Member 'UBP_ActionDiscoveryLookat_C::Niagra' has a wrong offset!");
