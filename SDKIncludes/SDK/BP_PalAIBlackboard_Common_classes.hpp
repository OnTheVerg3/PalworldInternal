...
static_assert(sizeof(UBP_PalAIBlackboard_Common_C) == 0x000128, "Wrong size on UBP_PalAIBlackboard_Common_C");
...
static_assert(offsetof(UBP_PalAIBlackboard_Common_C, ReturnRadiusRate_Combat_BB) == 0x000120, "Member 'UBP_PalAIBlackboard_Common_C::ReturnRadiusRate_Combat_BB' has a wrong offset!");
