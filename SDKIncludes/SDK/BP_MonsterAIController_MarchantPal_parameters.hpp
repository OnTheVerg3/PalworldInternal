...
static_assert(alignof(BP_MonsterAIController_MarchantPal_C_カスタムイベント) == 0x000008, "Wrong alignment on BP_MonsterAIController_MarchantPal_C_カスタムイベント");
static_assert(sizeof(BP_MonsterAIController_MarchantPal_C_カスタムイベント) == 0x000030, "Wrong size on BP_MonsterAIController_MarchantPal_C_カスタムイベント");
static_assert(offsetof(BP_MonsterAIController_MarchantPal_C_カスタムイベント, ID) == 0x000000, "Member 'BP_MonsterAIController_MarchantPal_C_カスタムイベント::ID' has a wrong offset!");
...
static_assert(alignof(BP_MonsterAIController_MarchantPal_C_カスタムイベント_1) == 0x000008, "Wrong alignment on BP_MonsterAIController_MarchantPal_C_カスタムイベント_1");
static_assert(sizeof(BP_MonsterAIController_MarchantPal_C_カスタムイベント_1) == 0x000050, "Wrong size on BP_MonsterAIController_MarchantPal_C_カスタムイベント_1");
static_assert(offsetof(BP_MonsterAIController_MarchantPal_C_カスタムイベント_1, DeadInfo) == 0x000000, "Member 'BP_MonsterAIController_MarchantPal_C_カスタムイベント_1::DeadInfo' has a wrong offset!");
...
static_assert(alignof(BP_MonsterAIController_MarchantPal_C_カスタムイベント_2) == 0x000008, "Wrong alignment on BP_MonsterAIController_MarchantPal_C_カスタムイベント_2");
static_assert(sizeof(BP_MonsterAIController_MarchantPal_C_カスタムイベント_2) == 0x000008, "Wrong size on BP_MonsterAIController_MarchantPal_C_カスタムイベント_2");
static_assert(offsetof(BP_MonsterAIController_MarchantPal_C_カスタムイベント_2, VisualEffect) == 0x000000, "Member 'BP_MonsterAIController_MarchantPal_C_カスタムイベント_2::VisualEffect' has a wrong offset!");
