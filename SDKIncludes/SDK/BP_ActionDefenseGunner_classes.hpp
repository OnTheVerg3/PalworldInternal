...
static_assert(sizeof(UBP_ActionDefenseGunner_C) == 0x0001A0, "Wrong size on UBP_ActionDefenseGunner_C");
static_assert(offsetof(UBP_ActionDefenseGunner_C, UberGraphFrame_BP_ActionDefenseGunner_C) == 0x000190, "Member 'UBP_ActionDefenseGunner_C::UberGraphFrame_BP_ActionDefenseGunner_C' has a wrong offset!");
