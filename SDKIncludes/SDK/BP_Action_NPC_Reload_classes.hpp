...
static_assert(sizeof(UBP_Action_NPC_Reload_C) == 0x000170, "Wrong size on UBP_Action_NPC_Reload_C");
static_assert(offsetof(UBP_Action_NPC_Reload_C, UberGraphFrame) == 0x000160, "Member 'UBP_Action_NPC_Reload_C::UberGraphFrame' has a wrong offset!");
