...
static_assert(sizeof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction) == 0x000118, "Wrong size on BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_GetActionComponent_ReturnValue) == 0x000000, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_GetActionComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_PlayAction_ReturnValue) == 0x000008, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_PlayAction_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_IsValidClass_ReturnValue) == 0x000010, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_K2_SetActorLocationAndRotation_SweepHitResult) == 0x000018, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_K2_SetActorLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_K2_SetActorLocationAndRotation_ReturnValue) == 0x000100, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_K2_SetActorLocationAndRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_GetActionComponent_ReturnValue_1) == 0x000108, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_GetActionComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction, CallFunc_PlayActionByType_ReturnValue) == 0x000110, "Member 'BP_AIAction_NPC_RelaxBase_C_PlayDefaultAction::CallFunc_PlayActionByType_ReturnValue' has a wrong offset!");
