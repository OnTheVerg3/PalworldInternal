...
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_ExecuteUbergraph_WBP_IngameMenu_PalBox_PalDetail) == 0x0001B8, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_ExecuteUbergraph_WBP_IngameMenu_PalBox_PalDetail");
...
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_ExecuteUbergraph_WBP_IngameMenu_PalBox_PalDetail, K2Node_CreateDelegate_OutputDelegate_12) == 0x0001A8, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_ExecuteUbergraph_WBP_IngameMenu_PalBox_PalDetail::K2Node_CreateDelegate_OutputDelegate_12' has a wrong offset!");
...
static_assert(alignof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode) == 0x000008, "Wrong alignment on WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode");
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode) == 0x0000A0, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, IsTip) == 0x000000, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::IsTip' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_bool_Variable) == 0x000001, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_struct_Variable) == 0x000008, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_struct_Variable_1) == 0x000018, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_struct_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_bool_Variable_1) == 0x000028, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_byte_Variable) == 0x000029, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_byte_Variable_1) == 0x00002A, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_bool_Variable_2) == 0x00002B, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, K2Node_Select_Default) == 0x00002C, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_byte_Variable_2) == 0x00002D, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, Temp_byte_Variable_3) == 0x00002E, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, K2Node_Select_Default_1) == 0x00002F, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, CallFunc_SelectFloat_ReturnValue) == 0x000030, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, K2Node_MakeStruct_Margin) == 0x000038, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, K2Node_Select_Default_2) == 0x000048, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, CallFunc_SlotAsCanvasSlot_ReturnValue) == 0x000058, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::CallFunc_SlotAsCanvasSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, K2Node_MakeStruct_WidgetTransform) == 0x000060, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::K2Node_MakeStruct_WidgetTransform' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode, K2Node_MakeStruct_Bottom_ImplicitCast) == 0x000098, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_Set_Detail_Mode::K2Node_MakeStruct_Bottom_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded) == 0x000090, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded, NewIndex) == 0x000000, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded::NewIndex' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded, Effects) == 0x000008, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded::Effects' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded, CallFunc_GetFavoriteIcon_IconTexutre) == 0x000058, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded::CallFunc_GetFavoriteIcon_IconTexutre' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded, CallFunc_IsValidSoftObjectReference_ReturnValue) == 0x000088, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFavoriteBinded::CallFunc_IsValidSoftObjectReference_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded) == 0x000008, "Wrong alignment on WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded");
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded) == 0x000018, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded, NewPoint) == 0x000000, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded::NewPoint' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded, CallFunc_GetDatabaseCharacterParameter_ReturnValue) == 0x000008, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded::CallFunc_GetDatabaseCharacterParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded, CallFunc_CalcFriendshipProgress_ReturnValue) == 0x000010, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded::CallFunc_CalcFriendshipProgress_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded, CallFunc_GetFriendshipRank_ReturnValue) == 0x000014, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_UpdateFriendshipPoint_Binded::CallFunc_GetFriendshipRank_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship) == 0x000008, "Wrong alignment on WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship");
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship) == 0x000050, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, FriendshipRank) == 0x000000, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::FriendshipRank' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, FriendshipPoint) == 0x000004, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::FriendshipPoint' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, CallFunc_GetFriendshipUIColor_IconColor) == 0x000008, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::CallFunc_GetFriendshipUIColor_IconColor' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, CallFunc_GetFriendshipUIColor_GaugeColor) == 0x000018, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::CallFunc_GetFriendshipUIColor_GaugeColor' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, CallFunc_GetDatabaseCharacterParameter_ReturnValue) == 0x000028, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::CallFunc_GetDatabaseCharacterParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, CallFunc_CalcFriendshipProgress_ReturnValue) == 0x000030, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::CallFunc_CalcFriendshipProgress_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship, CallFunc_Conv_IntToText_ReturnValue) == 0x000038, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetFriendship::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag) == 0x000001, "Wrong alignment on WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag");
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag) == 0x000005, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag, bImportedFlag) == 0x000000, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag::bImportedFlag' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag, Temp_bool_Variable) == 0x000001, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag, Temp_byte_Variable) == 0x000002, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag, Temp_byte_Variable_1) == 0x000003, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag, K2Node_Select_Default) == 0x000004, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetImportedFlag::K2Node_Select_Default' has a wrong offset!");
...
static_assert(sizeof(WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill) == 0x000018, "Wrong size on WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill");
...
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill, Temp_bool_Variable) == 0x000010, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill, Temp_byte_Variable) == 0x000011, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill, Temp_byte_Variable_1) == 0x000012, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill, K2Node_Select_Default) == 0x000013, "Member 'WBP_IngameMenu_PalBox_PalDetail_C_SetPassiveSkill::K2Node_Select_Default' has a wrong offset!");
