...
public:
	...
	struct FPalRaidBossSpawnInfo                  CallFunc_FindRaidBossInfoByCharacterID_ReturnValue; // 0x0150(0x0060)()
	EPalVisualEffectID                            CallFunc_FindModeChangeVisualEffectType_VisualEffect; // 0x01B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1B1[0x7];                                      // 0x01B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   CallFunc_FindModeChangeVisualEffectType_Value;     // 0x01B8(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	...
	class UClass*                                 K2Node_ClassDynamicCast_AsPal_Visual_Effect_Base;  // 0x01F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UObject*                                CallFunc_GetDefaultObject_ReturnValue;             // 0x0200(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UBP_VisualEffect_ChangeElementBase_C*   K2Node_DynamicCast_AsBP_Visual_Effect_Change_Element_Base; // 0x0208(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, CallFunc_FindModeChangeVisualEffectType_VisualEffect) == 0x0001B0, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::CallFunc_FindModeChangeVisualEffectType_VisualEffect' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, CallFunc_FindModeChangeVisualEffectType_Value) == 0x0001B8, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::CallFunc_FindModeChangeVisualEffectType_Value' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, CallFunc_Conv_SoftClassReferenceToClass_ReturnValue) == 0x0001E8, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::CallFunc_Conv_SoftClassReferenceToClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, K2Node_ClassDynamicCast_AsPal_Visual_Effect_Base) == 0x0001F0, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::K2Node_ClassDynamicCast_AsPal_Visual_Effect_Base' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, K2Node_ClassDynamicCast_bSuccess) == 0x0001F8, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, CallFunc_GetDefaultObject_ReturnValue) == 0x000200, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::CallFunc_GetDefaultObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, K2Node_DynamicCast_AsBP_Visual_Effect_Change_Element_Base) == 0x000208, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::K2Node_DynamicCast_AsBP_Visual_Effect_Change_Element_Base' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, K2Node_DynamicCast_bSuccess) == 0x000210, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x000218, "Member 'BP_Action_RaidBossModeChange_C_ExecuteUbergraph_BP_Action_RaidBossModeChange::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
