...
static_assert(alignof(WBP_Title_WorldSettings_ListContent_C_SetupFlag) == 0x000001, "Wrong alignment on WBP_Title_WorldSettings_ListContent_C_SetupFlag");
static_assert(sizeof(WBP_Title_WorldSettings_ListContent_C_SetupFlag) == 0x000005, "Wrong size on WBP_Title_WorldSettings_ListContent_C_SetupFlag");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_SetupFlag, IsSteam) == 0x000000, "Member 'WBP_Title_WorldSettings_ListContent_C_SetupFlag::IsSteam' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_SetupFlag, IsXbox) == 0x000001, "Member 'WBP_Title_WorldSettings_ListContent_C_SetupFlag::IsXbox' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_SetupFlag, IsPS5) == 0x000002, "Member 'WBP_Title_WorldSettings_ListContent_C_SetupFlag::IsPS5' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_SetupFlag, IsMac) == 0x000003, "Member 'WBP_Title_WorldSettings_ListContent_C_SetupFlag::IsMac' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_SetupFlag, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000004, "Member 'WBP_Title_WorldSettings_ListContent_C_SetupFlag::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal) == 0x000008, "Wrong alignment on WBP_Title_WorldSettings_ListContent_C_Initialize_Internal");
static_assert(sizeof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal) == 0x0000E8, "Wrong size on WBP_Title_WorldSettings_ListContent_C_Initialize_Internal");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, CallFunc_GetLocalizedTextFromHandle_Text) == 0x000000, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::CallFunc_GetLocalizedTextFromHandle_Text' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, CallFunc_GetLocalizedTextFromHandle_Text_1) == 0x000018, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::CallFunc_GetLocalizedTextFromHandle_Text_1' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, CallFunc_GetDisplayName_ReturnValue) == 0x000030, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, K2Node_SwitchEnum_CmpSuccess) == 0x000040, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, CallFunc_Conv_StringToText_ReturnValue) == 0x000048, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, K2Node_MakeStruct_FormatArgumentData) == 0x000060, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, K2Node_MakeArray_Array) == 0x0000B0, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, CallFunc_Format_ReturnValue) == 0x0000C0, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_WorldSettings_ListContent_C_Initialize_Internal, CallFunc_Conv_TextToString_ReturnValue) == 0x0000D8, "Member 'WBP_Title_WorldSettings_ListContent_C_Initialize_Internal::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
