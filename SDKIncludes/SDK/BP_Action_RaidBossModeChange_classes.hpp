...
static_assert(sizeof(UBP_Action_RaidBossModeChange_C) == 0x000180, "Wrong size on UBP_Action_RaidBossModeChange_C");
static_assert(offsetof(UBP_Action_RaidBossModeChange_C, UberGraphFrame) == 0x000160, "Member 'UBP_Action_RaidBossModeChange_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_Action_RaidBossModeChange_C, AddStatusEventDispatcher) == 0x000168, "Member 'UBP_Action_RaidBossModeChange_C::AddStatusEventDispatcher' has a wrong offset!");
