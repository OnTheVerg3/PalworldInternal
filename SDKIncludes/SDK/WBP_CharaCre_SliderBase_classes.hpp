...
static_assert(sizeof(UWBP_CharaCre_SliderBase_C) == 0x0002B0, "Wrong size on UWBP_CharaCre_SliderBase_C");
...
static_assert(offsetof(UWBP_CharaCre_SliderBase_C, SliderSlot) == 0x000288, "Member 'UWBP_CharaCre_SliderBase_C::SliderSlot' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_SliderBase_C, Text_Slider) == 0x000290, "Member 'UWBP_CharaCre_SliderBase_C::Text_Slider' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_SliderBase_C, Text_SliderNum) == 0x000298, "Member 'UWBP_CharaCre_SliderBase_C::Text_SliderNum' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_SliderBase_C, MsgID) == 0x0002A0, "Member 'UWBP_CharaCre_SliderBase_C::MsgID' has a wrong offset!");
