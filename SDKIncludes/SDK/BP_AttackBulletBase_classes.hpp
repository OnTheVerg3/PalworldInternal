...
public:
	...
	class UNiagaraSystem*                         WaterHitEffect;                                    // 0x03B8(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TMap<class FName, double>                     WaterHitEffectParameterMap;                        // 0x03C0(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly)
...
static_assert(sizeof(ABP_AttackBulletBase_C) == 0x000410, "Wrong size on ABP_AttackBulletBase_C");
static_assert(offsetof(ABP_AttackBulletBase_C, UberGraphFrame) == 0x0003B0, "Member 'ABP_AttackBulletBase_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_AttackBulletBase_C, WaterHitEffect) == 0x0003B8, "Member 'ABP_AttackBulletBase_C::WaterHitEffect' has a wrong offset!");
static_assert(offsetof(ABP_AttackBulletBase_C, WaterHitEffectParameterMap) == 0x0003C0, "Member 'ABP_AttackBulletBase_C::WaterHitEffectParameterMap' has a wrong offset!");
