...
static_assert(offsetof(UWBP_Title_MenuButton_C, Test_Content) == 0x0002B8, "Member 'UWBP_Title_MenuButton_C::Test_Content' has a wrong offset!");
static_assert(offsetof(UWBP_Title_MenuButton_C, WBP_PalInvisibleButton) == 0x0002C0, "Member 'UWBP_Title_MenuButton_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_Title_MenuButton_C, OnClicked) == 0x0002C8, "Member 'UWBP_Title_MenuButton_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UWBP_Title_MenuButton_C, buttonType) == 0x0002D8, "Member 'UWBP_Title_MenuButton_C::buttonType' has a wrong offset!");
static_assert(offsetof(UWBP_Title_MenuButton_C, MsgIDMap) == 0x0002E0, "Member 'UWBP_Title_MenuButton_C::MsgIDMap' has a wrong offset!");
