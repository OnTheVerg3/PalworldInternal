...
static_assert(sizeof(WBP_IngameMenu_Task_Tutorial_List_C_Setup) == 0x000010, "Wrong size on WBP_IngameMenu_Task_Tutorial_List_C_Setup");
...
static_assert(offsetof(WBP_IngameMenu_Task_Tutorial_List_C_Setup, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'WBP_IngameMenu_Task_Tutorial_List_C_Setup::CallFunc_IsValid_ReturnValue' has a wrong offset!");
