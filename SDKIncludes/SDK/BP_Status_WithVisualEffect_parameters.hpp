...
static_assert(alignof(BP_Status_WithVisualEffect_C_カスタムイベント_Dead) == 0x000008, "Wrong alignment on BP_Status_WithVisualEffect_C_カスタムイベント_Dead");
static_assert(sizeof(BP_Status_WithVisualEffect_C_カスタムイベント_Dead) == 0x000050, "Wrong size on BP_Status_WithVisualEffect_C_カスタムイベント_Dead");
static_assert(offsetof(BP_Status_WithVisualEffect_C_カスタムイベント_Dead, DeadInfo) == 0x000000, "Member 'BP_Status_WithVisualEffect_C_カスタムイベント_Dead::DeadInfo' has a wrong offset!");
...
static_assert(alignof(BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd) == 0x000008, "Wrong alignment on BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd");
static_assert(sizeof(BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd) == 0x000018, "Wrong size on BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd");
static_assert(offsetof(BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd, StatusComponent) == 0x000000, "Member 'BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd::StatusComponent' has a wrong offset!");
static_assert(offsetof(BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd, statusID_0) == 0x000008, "Member 'BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd::statusID_0' has a wrong offset!");
static_assert(offsetof(BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd, Status) == 0x000010, "Member 'BP_Status_WithVisualEffect_C_カスタムイベント_OtherStatusAdd::Status' has a wrong offset!");
