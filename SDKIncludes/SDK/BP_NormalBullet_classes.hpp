...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_NormalBullet_C;                  // 0x0410(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UStaticMeshComponent*                   One4_5_x_114_mm_Bullet;                            // 0x0418(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_NormalBullet_C) == 0x000420, "Wrong size on ABP_NormalBullet_C");
static_assert(offsetof(ABP_NormalBullet_C, UberGraphFrame_BP_NormalBullet_C) == 0x000410, "Member 'ABP_NormalBullet_C::UberGraphFrame_BP_NormalBullet_C' has a wrong offset!");
static_assert(offsetof(ABP_NormalBullet_C, One4_5_x_114_mm_Bullet) == 0x000418, "Member 'ABP_NormalBullet_C::One4_5_x_114_mm_Bullet' has a wrong offset!");
