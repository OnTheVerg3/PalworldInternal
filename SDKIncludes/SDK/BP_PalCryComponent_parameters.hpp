...
static_assert(sizeof(BP_PalCryComponent_C_GetPalId) == 0x000014, "Wrong size on BP_PalCryComponent_C_GetPalId");
...
static_assert(offsetof(BP_PalCryComponent_C_GetPalId, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000010, "Member 'BP_PalCryComponent_C_GetPalId::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
