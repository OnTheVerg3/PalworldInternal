...
static_assert(sizeof(ABP_NPCAIController_Invader_C) == 0x0005C0, "Wrong size on ABP_NPCAIController_Invader_C");
static_assert(offsetof(ABP_NPCAIController_Invader_C, UberGraphFrame_BP_NPCAIController_Invader_C) == 0x0005A8, "Member 'ABP_NPCAIController_Invader_C::UberGraphFrame_BP_NPCAIController_Invader_C' has a wrong offset!");
static_assert(offsetof(ABP_NPCAIController_Invader_C, OnInvaderArrivedDelegate) == 0x0005B0, "Member 'ABP_NPCAIController_Invader_C::OnInvaderArrivedDelegate' has a wrong offset!");
