...
static_assert(sizeof(WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo) == 0x000220, "Wrong size on WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo");
...
static_assert(offsetof(WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo, CallFunc_Subtract_IntInt_ReturnValue) == 0x000208, "Member 'WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo, CallFunc_Array_Get_Item) == 0x000210, "Member 'WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo, CallFunc_IsValid_ReturnValue) == 0x000218, "Member 'WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x000219, "Member 'WBP_CharaCre_ScrollBoxContent_Voice_C_ApplyMakeInfo::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
