...
static_assert(sizeof(UBP_ActionTurnToTarget_C) == 0x000170, "Wrong size on UBP_ActionTurnToTarget_C");
static_assert(offsetof(UBP_ActionTurnToTarget_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionTurnToTarget_C::UberGraphFrame' has a wrong offset!");
