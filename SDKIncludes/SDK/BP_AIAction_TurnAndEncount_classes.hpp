...
static_assert(sizeof(UBP_AIAction_TurnAndEncount_C) == 0x000188, "Wrong size on UBP_AIAction_TurnAndEncount_C");
...
static_assert(offsetof(UBP_AIAction_TurnAndEncount_C, SkipEncout) == 0x000180, "Member 'UBP_AIAction_TurnAndEncount_C::SkipEncout' has a wrong offset!");
