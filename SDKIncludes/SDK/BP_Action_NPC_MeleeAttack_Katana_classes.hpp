...
static_assert(sizeof(UBP_Action_NPC_MeleeAttack_Katana_C) == 0x000170, "Wrong size on UBP_Action_NPC_MeleeAttack_Katana_C");
static_assert(offsetof(UBP_Action_NPC_MeleeAttack_Katana_C, UberGraphFrame) == 0x000160, "Member 'UBP_Action_NPC_MeleeAttack_Katana_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_Action_NPC_MeleeAttack_Katana_C, AttackAnime) == 0x000168, "Member 'UBP_Action_NPC_MeleeAttack_Katana_C::AttackAnime' has a wrong offset!");
