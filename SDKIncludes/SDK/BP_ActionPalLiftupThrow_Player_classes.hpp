...
static_assert(sizeof(UBP_ActionPalLiftupThrow_Player_C) == 0x000170, "Wrong size on UBP_ActionPalLiftupThrow_Player_C");
static_assert(offsetof(UBP_ActionPalLiftupThrow_Player_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionPalLiftupThrow_Player_C::UberGraphFrame' has a wrong offset!");
