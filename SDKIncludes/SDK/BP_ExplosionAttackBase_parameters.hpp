...
static_assert(sizeof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check) == 0x0002C8, "Wrong size on BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check");
...
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_Add_VectorVector_ReturnValue_1) == 0x0000E8, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_LineTraceSingle_OutHit) == 0x000100, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_LineTraceSingle_OutHit' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_LineTraceSingle_ReturnValue) == 0x0001E8, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_LineTraceSingle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_bBlockingHit) == 0x0001E9, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_bBlockingHit' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_bInitialOverlap) == 0x0001EA, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_bInitialOverlap' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_Time) == 0x0001EC, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_Time' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_Distance) == 0x0001F0, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_Distance' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_Location) == 0x0001F8, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_Location' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_ImpactPoint) == 0x000210, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_ImpactPoint' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_Normal) == 0x000228, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_Normal' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_ImpactNormal) == 0x000240, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_ImpactNormal' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_PhysMat) == 0x000258, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_PhysMat' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_HitActor) == 0x000260, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_HitActor' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_HitComponent) == 0x000268, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_HitComponent' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_HitBoneName) == 0x000270, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_HitBoneName' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_BoneName) == 0x000278, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_BoneName' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_HitItem) == 0x000280, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_HitItem' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_ElementIndex) == 0x000284, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_ElementIndex' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_FaceIndex) == 0x000288, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_FaceIndex' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_TraceStart) == 0x000290, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_TraceStart' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_BreakHitResult_TraceEnd) == 0x0002A8, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_BreakHitResult_TraceEnd' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x0002C0, "Member 'BP_ExplosionAttackBase_C_Can_Damage_by_Ray_Check::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
...
public:
	...
	class FName                                   K2Node_CustomEvent_OwnerStaticItemId;              // 0x0004(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UPalHitFilter*                          CallFunc_SpawnObject_ReturnValue;                  // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase) == 0x0000A0, "Wrong size on BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase");
...
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, K2Node_CustomEvent_OwnerStaticItemId) == 0x000004, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::K2Node_CustomEvent_OwnerStaticItemId' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, K2Node_CreateDelegate_OutputDelegate) == 0x00000C, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_SpawnObject_ReturnValue) == 0x000020, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000028, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, K2Node_CreateDelegate_OutputDelegate_1) == 0x000030, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000040, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x000058, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000060, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_IsValid_ReturnValue) == 0x000078, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_K2_GetActorLocation_ReturnValue_2) == 0x000080, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_K2_GetActorLocation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_IsDedicatedServer_ReturnValue) == 0x000098, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x00009C, "Member 'BP_ExplosionAttackBase_C_ExecuteUbergraph_BP_ExplosionAttackBase::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(BP_ExplosionAttackBase_C_FindAttacker) == 0x000040, "Wrong size on BP_ExplosionAttackBase_C_FindAttacker");
...
static_assert(offsetof(BP_ExplosionAttackBase_C_FindAttacker, CallFunc_GetOwner_ReturnValue_1) == 0x000010, "Member 'BP_ExplosionAttackBase_C_FindAttacker::CallFunc_GetOwner_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_ExplosionAttackBase_C_FindAttacker, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x000030, "Member 'BP_ExplosionAttackBase_C_FindAttacker::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_FindAttacker, CallFunc_IsValid_ReturnValue) == 0x000038, "Member 'BP_ExplosionAttackBase_C_FindAttacker::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FPalMakeDamageInfo                     K2Node_MakeStruct_PalMakeDamageInfo;               // 0x0128(0x01A0)(ContainsInstancedReference)
	struct FPalDamageInfo                         CallFunc_MakeDamageInfo_ReturnValue;               // 0x02C8(0x0118)()
	float                                         K2Node_MakeStruct_WeaponDamageRatePvP_ImplicitCast; // 0x03E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_MakeStruct_SneakAttackRate_ImplicitCast;    // 0x03E4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_ExplosionAttackBase_C_OnHit) == 0x000008, "Wrong alignment on BP_ExplosionAttackBase_C_OnHit");
static_assert(sizeof(BP_ExplosionAttackBase_C_OnHit) == 0x0003E8, "Wrong size on BP_ExplosionAttackBase_C_OnHit");
...
static_assert(offsetof(BP_ExplosionAttackBase_C_OnHit, CallFunc_MakeDamageInfo_ReturnValue) == 0x0002C8, "Member 'BP_ExplosionAttackBase_C_OnHit::CallFunc_MakeDamageInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_OnHit, K2Node_MakeStruct_WeaponDamageRatePvP_ImplicitCast) == 0x0003E0, "Member 'BP_ExplosionAttackBase_C_OnHit::K2Node_MakeStruct_WeaponDamageRatePvP_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_ExplosionAttackBase_C_OnHit, K2Node_MakeStruct_SneakAttackRate_ImplicitCast) == 0x0003E4, "Member 'BP_ExplosionAttackBase_C_OnHit::K2Node_MakeStruct_SneakAttackRate_ImplicitCast' has a wrong offset!");
...
static_assert(alignof(BP_ExplosionAttackBase_C_SetOwnerStaticItemId) == 0x000004, "Wrong alignment on BP_ExplosionAttackBase_C_SetOwnerStaticItemId");
static_assert(sizeof(BP_ExplosionAttackBase_C_SetOwnerStaticItemId) == 0x000008, "Wrong size on BP_ExplosionAttackBase_C_SetOwnerStaticItemId");
static_assert(offsetof(BP_ExplosionAttackBase_C_SetOwnerStaticItemId, OwnerStaticItemId_0) == 0x000000, "Member 'BP_ExplosionAttackBase_C_SetOwnerStaticItemId::OwnerStaticItemId_0' has a wrong offset!");
...
static_assert(sizeof(BP_ExplosionAttackBase_C_SetPower) == 0x000018, "Wrong size on BP_ExplosionAttackBase_C_SetPower");
...
static_assert(offsetof(BP_ExplosionAttackBase_C_SetPower, PvPDamageRate) == 0x000010, "Member 'BP_ExplosionAttackBase_C_SetPower::PvPDamageRate' has a wrong offset!");
