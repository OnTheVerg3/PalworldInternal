...
static_assert(offsetof(WBP_PalCharacterIconBase_C_Setup, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_PalCharacterIconBase_C_Setup::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterIconBase_C_Setup, CallFunc_GetCharacterIconTexture_ReturnValue) == 0x000018, "Member 'WBP_PalCharacterIconBase_C_Setup::CallFunc_GetCharacterIconTexture_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterIconBase_C_Setup, CallFunc_IsValidSoftObjectReference_ReturnValue) == 0x000048, "Member 'WBP_PalCharacterIconBase_C_Setup::CallFunc_IsValidSoftObjectReference_ReturnValue' has a wrong offset!");
