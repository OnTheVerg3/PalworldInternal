...
static_assert(sizeof(WBP_Title_BackupSelect_C_SetBackupDisplayData) == 0x0000E0, "Wrong size on WBP_Title_BackupSelect_C_SetBackupDisplayData");
...
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, Temp_int_Array_Index_Variable) == 0x000014, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, Temp_int_Loop_Counter_Variable) == 0x000018, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, CallFunc_Add_IntInt_ReturnValue) == 0x00001C, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, K2Node_CreateDelegate_OutputDelegate) == 0x000020, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, Temp_bool_Variable) == 0x000030, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::Temp_bool_Variable' has a wrong offset!");
...
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, CallFunc_Array_Length_ReturnValue) == 0x000088, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, Temp_byte_Variable_2) == 0x00008C, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, CallFunc_Less_IntInt_ReturnValue) == 0x00008D, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, K2Node_CreateDelegate_OutputDelegate_1) == 0x000090, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, CallFunc_GetScrollBox_ScrollBox_1) == 0x0000A0, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::CallFunc_GetScrollBox_ScrollBox_1' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, Temp_byte_Variable_3) == 0x0000A8, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, Temp_bool_Variable_1) == 0x0000A9, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, CallFunc_GetLocalPlayerController_ReturnValue) == 0x0000B0, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, K2Node_Select_Default_1) == 0x0000B8, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_Title_BackupSelect_C_SetBackupDisplayData, CallFunc_Create_ReturnValue) == 0x0000C0, "Member 'WBP_Title_BackupSelect_C_SetBackupDisplayData::CallFunc_Create_ReturnValue' has a wrong offset!");
