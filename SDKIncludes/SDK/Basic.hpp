...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08E09D80;
	constexpr int32 AppendString      = 0x030BA3C0;
	constexpr int32 GNames            = 0x08D6A680;
	constexpr int32 GWorld            = 0x08F785B0;
	constexpr int32 ProcessEvent      = 0x03238930;
