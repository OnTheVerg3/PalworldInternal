...
static_assert(sizeof(UBP_AIAction_CombatPal_C) == 0x0001E8, "Wrong size on UBP_AIAction_CombatPal_C");
...
static_assert(offsetof(UBP_AIAction_CombatPal_C, DisableTurn) == 0x0001E0, "Member 'UBP_AIAction_CombatPal_C::DisableTurn' has a wrong offset!");
