...
static_assert(sizeof(UBP_ActionWakeupFromRagdoll_C) == 0x000170, "Wrong size on UBP_ActionWakeupFromRagdoll_C");
static_assert(offsetof(UBP_ActionWakeupFromRagdoll_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionWakeupFromRagdoll_C::UberGraphFrame' has a wrong offset!");
