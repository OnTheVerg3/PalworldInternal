...
static_assert(sizeof(UBP_ActionReturnToBaseCamp_C) == 0x0001A0, "Wrong size on UBP_ActionReturnToBaseCamp_C");
static_assert(offsetof(UBP_ActionReturnToBaseCamp_C, UberGraphFrame_BP_ActionReturnToBaseCamp_C) == 0x000190, "Member 'UBP_ActionReturnToBaseCamp_C::UberGraphFrame_BP_ActionReturnToBaseCamp_C' has a wrong offset!");
static_assert(offsetof(UBP_ActionReturnToBaseCamp_C, flagName) == 0x000198, "Member 'UBP_ActionReturnToBaseCamp_C::flagName' has a wrong offset!");
