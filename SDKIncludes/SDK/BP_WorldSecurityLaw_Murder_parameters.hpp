...
static_assert(sizeof(BP_WorldSecurityLaw_Murder_C_IsNPC) == 0x000007, "Wrong size on BP_WorldSecurityLaw_Murder_C_IsNPC");
...
static_assert(offsetof(BP_WorldSecurityLaw_Murder_C_IsNPC, CallFunc_IsEnemyOrganization_ReturnValue) == 0x000003, "Member 'BP_WorldSecurityLaw_Murder_C_IsNPC::CallFunc_IsEnemyOrganization_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_Murder_C_IsNPC, CallFunc_Not_PreBool_ReturnValue) == 0x000004, "Member 'BP_WorldSecurityLaw_Murder_C_IsNPC::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_Murder_C_IsNPC, CallFunc_BooleanAND_ReturnValue) == 0x000005, "Member 'BP_WorldSecurityLaw_Murder_C_IsNPC::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_Murder_C_IsNPC, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000006, "Member 'BP_WorldSecurityLaw_Murder_C_IsNPC::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
