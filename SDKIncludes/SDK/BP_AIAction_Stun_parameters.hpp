...
static_assert(sizeof(BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun) == 0x0001A0, "Wrong size on BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun");
...
static_assert(offsetof(BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun, K2Node_Event_ControlledPawn) == 0x000170, "Member 'BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun::K2Node_Event_ControlledPawn' has a wrong offset!");
static_assert(offsetof(BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun, CallFunc_PlayActionParameter_ReturnValue) == 0x000178, "Member 'BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun::CallFunc_PlayActionParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun, CallFunc_GetComponentByClass_ReturnValue_1) == 0x000180, "Member 'BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun::CallFunc_GetComponentByClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun, CallFunc_GetComponentByClass_ReturnValue_2) == 0x000188, "Member 'BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun::CallFunc_GetComponentByClass_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun, CallFunc_IsFlyPal_ReturnValue) == 0x000190, "Member 'BP_AIAction_Stun_C_ExecuteUbergraph_BP_AIAction_Stun::CallFunc_IsFlyPal_ReturnValue' has a wrong offset!");
