...
static_assert(alignof(ALI_MonsterBase_C_CustomOverride) == 0x000008, "Wrong alignment on ALI_MonsterBase_C_CustomOverride");
static_assert(sizeof(ALI_MonsterBase_C_CustomOverride) == 0x000068, "Wrong size on ALI_MonsterBase_C_CustomOverride");
static_assert(offsetof(ALI_MonsterBase_C_CustomOverride, PrePose) == 0x000000, "Member 'ALI_MonsterBase_C_CustomOverride::PrePose' has a wrong offset!");
static_assert(offsetof(ALI_MonsterBase_C_CustomOverride, CustomData) == 0x000010, "Member 'ALI_MonsterBase_C_CustomOverride::CustomData' has a wrong offset!");
static_assert(offsetof(ALI_MonsterBase_C_CustomOverride, CustomOverride_0) == 0x000058, "Member 'ALI_MonsterBase_C_CustomOverride::CustomOverride_0' has a wrong offset!");
