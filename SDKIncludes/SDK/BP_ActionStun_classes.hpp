...
static_assert(sizeof(UBP_ActionStun_C) == 0x000170, "Wrong size on UBP_ActionStun_C");
static_assert(offsetof(UBP_ActionStun_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionStun_C::UberGraphFrame' has a wrong offset!");
