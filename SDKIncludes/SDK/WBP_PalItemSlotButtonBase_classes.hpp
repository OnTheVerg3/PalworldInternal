...
static_assert(sizeof(UWBP_PalItemSlotButtonBase_C) == 0x0005A8, "Wrong size on UWBP_PalItemSlotButtonBase_C");
...
static_assert(offsetof(UWBP_PalItemSlotButtonBase_C, Override_Num_Count_Text) == 0x000588, "Member 'UWBP_PalItemSlotButtonBase_C::Override_Num_Count_Text' has a wrong offset!");
static_assert(offsetof(UWBP_PalItemSlotButtonBase_C, bShouldDisplayItemInfo) == 0x0005A0, "Member 'UWBP_PalItemSlotButtonBase_C::bShouldDisplayItemInfo' has a wrong offset!");
