...
static_assert(sizeof(UBP_Action_NPC_MeleeAttack_C) == 0x000170, "Wrong size on UBP_Action_NPC_MeleeAttack_C");
static_assert(offsetof(UBP_Action_NPC_MeleeAttack_C, UberGraphFrame) == 0x000160, "Member 'UBP_Action_NPC_MeleeAttack_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_Action_NPC_MeleeAttack_C, AttackAnime) == 0x000168, "Member 'UBP_Action_NPC_MeleeAttack_C::AttackAnime' has a wrong offset!");
