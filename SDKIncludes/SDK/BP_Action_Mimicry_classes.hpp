...
static_assert(sizeof(UBP_Action_Mimicry_C) == 0x000170, "Wrong size on UBP_Action_Mimicry_C");
static_assert(offsetof(UBP_Action_Mimicry_C, UberGraphFrame) == 0x000160, "Member 'UBP_Action_Mimicry_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_Action_Mimicry_C, MimicMontage) == 0x000168, "Member 'UBP_Action_Mimicry_C::MimicMontage' has a wrong offset!");
