...
static_assert(sizeof(UBP_AIAction_WildPalDrinkWater_C) == 0x000188, "Wrong size on UBP_AIAction_WildPalDrinkWater_C");
static_assert(offsetof(UBP_AIAction_WildPalDrinkWater_C, UberGraphFrame_BP_AIAction_WildPalDrinkWater_C) == 0x000160, "Member 'UBP_AIAction_WildPalDrinkWater_C::UberGraphFrame_BP_AIAction_WildPalDrinkWater_C' has a wrong offset!");
static_assert(offsetof(UBP_AIAction_WildPalDrinkWater_C, GoalPos) == 0x000168, "Member 'UBP_AIAction_WildPalDrinkWater_C::GoalPos' has a wrong offset!");
static_assert(offsetof(UBP_AIAction_WildPalDrinkWater_C, EatAction) == 0x000180, "Member 'UBP_AIAction_WildPalDrinkWater_C::EatAction' has a wrong offset!");
