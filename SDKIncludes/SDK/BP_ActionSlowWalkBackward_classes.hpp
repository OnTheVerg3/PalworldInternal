...
static_assert(sizeof(UBP_ActionSlowWalkBackward_C) == 0x000170, "Wrong size on UBP_ActionSlowWalkBackward_C");
static_assert(offsetof(UBP_ActionSlowWalkBackward_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionSlowWalkBackward_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_ActionSlowWalkBackward_C, PlayRate) == 0x000168, "Member 'UBP_ActionSlowWalkBackward_C::PlayRate' has a wrong offset!");
