...
static_assert(sizeof(UBP_DownWidgetParameter_C) == 0x000048, "Wrong size on UBP_DownWidgetParameter_C");
...
static_assert(offsetof(UBP_DownWidgetParameter_C, IsPartnerSkillRevive) == 0x000040, "Member 'UBP_DownWidgetParameter_C::IsPartnerSkillRevive' has a wrong offset!");
