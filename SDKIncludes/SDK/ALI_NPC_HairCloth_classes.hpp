...
static_assert(alignof(IALI_NPC_HairCloth_C) == 0x000001, "Wrong alignment on IALI_NPC_HairCloth_C");
static_assert(sizeof(IALI_NPC_HairCloth_C) == 0x000001, "Wrong size on IALI_NPC_HairCloth_C");
