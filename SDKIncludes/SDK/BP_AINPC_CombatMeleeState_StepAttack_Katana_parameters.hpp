...
static_assert(sizeof(BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana) == 0x000150, "Wrong size on BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana");
...
static_assert(offsetof(BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana, CallFunc_GetBodyActionComponentRef_ActionComp) == 0x000120, "Member 'BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana::CallFunc_GetBodyActionComponentRef_ActionComp' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana, CallFunc_GetCombatAIActionRef_BPAIActionNPCCombat_1) == 0x000128, "Member 'BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana::CallFunc_GetCombatAIActionRef_BPAIActionNPCCombat_1' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana, CallFunc_PlayActionParameter_ReturnValue) == 0x000130, "Member 'BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana::CallFunc_PlayActionParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana, CallFunc_GetController_ReturnValue) == 0x000138, "Member 'BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana, CallFunc_GetSelfActor_SelfActor) == 0x000140, "Member 'BP_AINPC_CombatMeleeState_StepAttack_Katana_C_ExecuteUbergraph_BP_AINPC_CombatMeleeState_StepAttack_Katana::CallFunc_GetSelfActor_SelfActor' has a wrong offset!");
