...
static_assert(sizeof(UBP_ActionCutPalMeat_Player_C) == 0x000180, "Wrong size on UBP_ActionCutPalMeat_Player_C");
static_assert(offsetof(UBP_ActionCutPalMeat_Player_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionCutPalMeat_Player_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_ActionCutPalMeat_Player_C, TargetCharacter) == 0x000168, "Member 'UBP_ActionCutPalMeat_Player_C::TargetCharacter' has a wrong offset!");
static_assert(offsetof(UBP_ActionCutPalMeat_Player_C, IsDeletePal) == 0x000170, "Member 'UBP_ActionCutPalMeat_Player_C::IsDeletePal' has a wrong offset!");
