...
static_assert(alignof(PalBossBattleSequence_Opening_C_カスタムイベント_0) == 0x000008, "Wrong alignment on PalBossBattleSequence_Opening_C_カスタムイベント_0");
static_assert(sizeof(PalBossBattleSequence_Opening_C_カスタムイベント_0) == 0x000008, "Wrong size on PalBossBattleSequence_Opening_C_カスタムイベント_0");
static_assert(offsetof(PalBossBattleSequence_Opening_C_カスタムイベント_0, SpawnedCharacter) == 0x000000, "Member 'PalBossBattleSequence_Opening_C_カスタムイベント_0::SpawnedCharacter' has a wrong offset!");
