...
static_assert(sizeof(WBP_PalCharacterSlotButtonBase_C_BindButtonEvents) == 0x000058, "Wrong size on WBP_PalCharacterSlotButtonBase_C_BindButtonEvents");
...
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_BindButtonEvents, CallFunc_IsValid_ReturnValue) == 0x000020, "Member 'WBP_PalCharacterSlotButtonBase_C_BindButtonEvents::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_BindButtonEvents, K2Node_CreateDelegate_OutputDelegate_4) == 0x000044, "Member 'WBP_PalCharacterSlotButtonBase_C_BindButtonEvents::K2Node_CreateDelegate_OutputDelegate_4' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_BindButtonEvents, CallFunc_IsValid_ReturnValue_1) == 0x000054, "Member 'WBP_PalCharacterSlotButtonBase_C_BindButtonEvents::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(WBP_PalCharacterSlotButtonBase_C_ExecuteUbergraph_WBP_PalCharacterSlotButtonBase) == 0x000018, "Wrong size on WBP_PalCharacterSlotButtonBase_C_ExecuteUbergraph_WBP_PalCharacterSlotButtonBase");
...
static_assert(alignof(WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter) == 0x000008, "Wrong alignment on WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter");
static_assert(sizeof(WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter) == 0x000010, "Wrong size on WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter, IndividualParameter) == 0x000000, "Member 'WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter::IndividualParameter' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter, CallFunc_GetIndividualParameter_Parameter) == 0x000008, "Member 'WBP_PalCharacterSlotButtonBase_C_GetIndividualParameter::CallFunc_GetIndividualParameter_Parameter' has a wrong offset!");
...
static_assert(alignof(WBP_PalCharacterSlotButtonBase_C_OnUpdateSlot_Binded) == 0x000008, "Wrong alignment on WBP_PalCharacterSlotButtonBase_C_OnUpdateSlot_Binded");
static_assert(sizeof(WBP_PalCharacterSlotButtonBase_C_OnUpdateSlot_Binded) == 0x000008, "Wrong size on WBP_PalCharacterSlotButtonBase_C_OnUpdateSlot_Binded");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_OnUpdateSlot_Binded, TargetSlot) == 0x000000, "Member 'WBP_PalCharacterSlotButtonBase_C_OnUpdateSlot_Binded::TargetSlot' has a wrong offset!");
...
static_assert(alignof(WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID) == 0x000008, "Wrong alignment on WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID");
static_assert(sizeof(WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID) == 0x000018, "Wrong size on WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID, CharacterID) == 0x000000, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID::CharacterID' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID, K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot) == 0x000008, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID::K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID, CallFunc_IsValid_ReturnValue) == 0x000011, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByCharacterID::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId) == 0x000058, "Wrong size on WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId");
...
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, Temp_byte_Variable) == 0x000030, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, CallFunc_GetIndividualCharacterParameterByIstanceID_ReturnValue) == 0x000038, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::CallFunc_GetIndividualCharacterParameterByIstanceID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, CallFunc_IsValid_ReturnValue) == 0x000040, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, CallFunc_IsImportedCharacter_ReturnValue) == 0x000041, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::CallFunc_IsImportedCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, Temp_bool_Variable) == 0x000042, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, Temp_byte_Variable_1) == 0x000043, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, K2Node_Select_Default) == 0x000044, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot) == 0x000048, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::K2Node_DynamicCast_AsWBP_Pal_Common_Character_Slot' has a wrong offset!");
static_assert(offsetof(WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId, K2Node_DynamicCast_bSuccess) == 0x000050, "Member 'WBP_PalCharacterSlotButtonBase_C_SetupByIndividualId::K2Node_DynamicCast_bSuccess' has a wrong offset!");
