...
static_assert(sizeof(BP_ArenaSequence_Result_C_End_Process) == 0x000050, "Wrong size on BP_ArenaSequence_Result_C_End_Process");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetOwnerType_ReturnValue) == 0x000000, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetOwnerType_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetLocalPalPlayerController_ReturnValue) == 0x000008, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetLocalPalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000010, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetNetworkTransmitter_ReturnValue) == 0x000018, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetNetworkTransmitter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetOwnerType_ReturnValue_1) == 0x000020, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetOwnerType_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetArena_ReturnValue) == 0x000028, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetArena_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_IsPlayerOwnerType_ReturnValue) == 0x000030, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_IsPlayerOwnerType_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetInstanceModel_ReturnValue) == 0x000038, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetInstanceModel_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetNetworkTransmitter_ReturnValue_1) == 0x000040, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetNetworkTransmitter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_End_Process, CallFunc_GetArena_ReturnValue_1) == 0x000048, "Member 'BP_ArenaSequence_Result_C_End_Process::CallFunc_GetArena_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result) == 0x0001E0, "Wrong size on BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, K2Node_CreateDelegate_OutputDelegate) == 0x00000C, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, Temp_byte_Variable_1) == 0x000029, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, K2Node_DynamicCast_AsPal_Player_Controller) == 0x000038, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::K2Node_DynamicCast_AsPal_Player_Controller' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetInstanceModel_ReturnValue) == 0x000048, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetInstanceModel_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, K2Node_CustomEvent_bIsSkipped) == 0x0000C9, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::K2Node_CustomEvent_bIsSkipped' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, Temp_byte_Variable_3) == 0x0000CA, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::Temp_byte_Variable_3' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_IsValid_ReturnValue) == 0x0000D8, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_Array_Length_ReturnValue) == 0x0000DC, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, Temp_byte_Variable_4) == 0x0000E0, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::Temp_byte_Variable_4' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetOuterSequencer_ReturnValue_1) == 0x0000E8, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetOuterSequencer_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetArenaPlayerInfoMap_ReturnValue) == 0x0000F0, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetArenaPlayerInfoMap_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, K2Node_Select_Default) == 0x000140, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_Map_Find_Value) == 0x000148, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_Map_Find_ReturnValue) == 0x0001A0, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_IsValid_ReturnValue_1) == 0x0001A1, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetNickNameWithOnlineID_OutName) == 0x0001A8, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetNickNameWithOnlineID_OutName' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetOwnerType_ReturnValue) == 0x0001B8, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetOwnerType_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetLocalPalPlayerController_ReturnValue) == 0x0001C0, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetLocalPalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x0001C8, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_IsSpectating_ReturnValue) == 0x0001C9, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_IsSpectating_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, Temp_int_Loop_Counter_Variable) == 0x0001CC, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_Less_IntInt_ReturnValue) == 0x0001D0, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_Add_IntInt_ReturnValue) == 0x0001D4, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_GetOwnerType_ReturnValue_1) == 0x0001D8, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_GetOwnerType_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result, CallFunc_IsPlayerOwnerType_ReturnValue) == 0x0001D9, "Member 'BP_ArenaSequence_Result_C_ExecuteUbergraph_BP_ArenaSequence_Result::CallFunc_IsPlayerOwnerType_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_ArenaSequence_Result_C_GetOffAllPlayer) == 0x000100, "Wrong size on BP_ArenaSequence_Result_C_GetOffAllPlayer");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_GetOwnerType_ReturnValue) == 0x00000C, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_GetOwnerType_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_IsServerOwnerType_ReturnValue) == 0x00000D, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_IsServerOwnerType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_Map_Find_ReturnValue) == 0x0000D8, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_GetIndividualActor_ReturnValue) == 0x0000E0, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_GetIndividualActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_IsValid_ReturnValue) == 0x0000E8, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_IsValid_ReturnValue_1) == 0x0000E9, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_GetOffFromPal_ReturnValue) == 0x0000EA, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_GetOffFromPal_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_GetComponentByClass_ReturnValue) == 0x0000F0, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_IsRiding_ReturnValue) == 0x0000F8, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_IsRiding_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_GetOffAllPlayer, CallFunc_IsValid_ReturnValue_2) == 0x0000F9, "Member 'BP_ArenaSequence_Result_C_GetOffAllPlayer::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
...
static_assert(sizeof(BP_ArenaSequence_Result_C_PlayResultMontage) == 0x000038, "Wrong size on BP_ArenaSequence_Result_C_PlayResultMontage");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultMontage, CallFunc_GetOwnerType_ReturnValue) == 0x000010, "Member 'BP_ArenaSequence_Result_C_PlayResultMontage::CallFunc_GetOwnerType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultMontage, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000020, "Member 'BP_ArenaSequence_Result_C_PlayResultMontage::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultMontage, CallFunc_GetAnimInstance_ReturnValue) == 0x000028, "Member 'BP_ArenaSequence_Result_C_PlayResultMontage::CallFunc_GetAnimInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultMontage, CallFunc_Montage_Play_ReturnValue) == 0x000030, "Member 'BP_ArenaSequence_Result_C_PlayResultMontage::CallFunc_Montage_Play_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultMontage, CallFunc_Array_AddUnique_ReturnValue) == 0x000034, "Member 'BP_ArenaSequence_Result_C_PlayResultMontage::CallFunc_Array_AddUnique_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_ArenaSequence_Result_C_PlayResultSound) == 0x000050, "Wrong size on BP_ArenaSequence_Result_C_PlayResultSound");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000003, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000004, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_GetPalmi_ReturnValue_1) == 0x000010, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_GetPalmi_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_GetOuterSequencer_ReturnValue) == 0x000018, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_GetOuterSequencer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, K2Node_SwitchEnum_CmpSuccess) == 0x000020, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_GetLocalPlayerIndex_ReturnValue) == 0x000021, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_GetLocalPlayerIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, Temp_delegate_Variable) == 0x000024, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::Temp_delegate_Variable' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, Temp_delegate_Variable_1) == 0x000034, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::Temp_delegate_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_PostEvent_ReturnValue) == 0x000044, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_PostEvent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_PlayResultSound, CallFunc_PostEvent_ReturnValue_1) == 0x000048, "Member 'BP_ArenaSequence_Result_C_PlayResultSound::CallFunc_PostEvent_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(BP_ArenaSequence_Result_C_SetupFormation) == 0x0006C0, "Wrong size on BP_ArenaSequence_Result_C_SetupFormation");
...
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Map_Find_ReturnValue) == 0x000348, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_GetIndividualActor_ReturnValue) == 0x000350, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_GetIndividualActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Array_Get_Item_1) == 0x000358, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_GetIndividualActor_ReturnValue_1) == 0x000360, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_GetIndividualActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Array_Get_Item_2) == 0x000368, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Array_Get_Item_3) == 0x000370, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Array_Length_ReturnValue_1) == 0x000378, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_GetIndividualActor_ReturnValue_2) == 0x000380, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_GetIndividualActor_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Less_IntInt_ReturnValue_1) == 0x000388, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_AdjustActorToFloor_ReturnValue) == 0x000390, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_AdjustActorToFloor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_K2_SetActorLocationAndRotation_SweepHitResult) == 0x000398, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_K2_SetActorLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_K2_SetActorLocationAndRotation_ReturnValue) == 0x000480, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_K2_SetActorLocationAndRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_FindMontange_bExist) == 0x000481, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_FindMontange_bExist' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_FindMontange_ReturnValue) == 0x000488, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_FindMontange_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_FindMontange_bExist_1) == 0x000490, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_FindMontange_bExist_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_FindMontange_ReturnValue_1) == 0x000498, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_FindMontange_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_IsValid_ReturnValue) == 0x0004A0, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, K2Node_Select_Default) == 0x0004A8, "Member 'BP_ArenaSequence_Result_C_SetupFormation::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Array_Length_ReturnValue_2) == 0x0004B0, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_Less_IntInt_ReturnValue_2) == 0x0004B4, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_K2_SetActorLocationAndRotation_SweepHitResult_1) == 0x0004B8, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_K2_SetActorLocationAndRotation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_K2_SetActorLocationAndRotation_ReturnValue_1) == 0x0005A0, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_K2_SetActorLocationAndRotation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_AdjustActorToFloor_ReturnValue_1) == 0x0005A8, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_AdjustActorToFloor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_IsValid_ReturnValue_1) == 0x0005B0, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_IsValid_ReturnValue_2) == 0x0005B1, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_GetIndividualActor_ReturnValue_3) == 0x0005B8, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_GetIndividualActor_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_IsValid_ReturnValue_3) == 0x0005C0, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_IsValid_ReturnValue_4) == 0x0005C1, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_K2_SetActorLocation_SweepHitResult) == 0x0005C8, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_K2_SetActorLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_ArenaSequence_Result_C_SetupFormation, CallFunc_K2_SetActorLocation_ReturnValue) == 0x0006B0, "Member 'BP_ArenaSequence_Result_C_SetupFormation::CallFunc_K2_SetActorLocation_ReturnValue' has a wrong offset!");
