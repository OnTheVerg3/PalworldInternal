...
static_assert(sizeof(BP_BuildObject_PalBoxV2_C_ExecuteUbergraph_BP_BuildObject_PalBoxV2) == 0x0001B8, "Wrong size on BP_BuildObject_PalBoxV2_C_ExecuteUbergraph_BP_BuildObject_PalBoxV2");
...
static_assert(offsetof(BP_BuildObject_PalBoxV2_C_ExecuteUbergraph_BP_BuildObject_PalBoxV2, K2Node_Event_DeltaSeconds) == 0x0001B0, "Member 'BP_BuildObject_PalBoxV2_C_ExecuteUbergraph_BP_BuildObject_PalBoxV2::K2Node_Event_DeltaSeconds' has a wrong offset!");
