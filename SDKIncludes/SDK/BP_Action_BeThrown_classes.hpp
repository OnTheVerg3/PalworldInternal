...
static_assert(sizeof(UBP_Action_BeThrown_C) == 0x000180, "Wrong size on UBP_Action_BeThrown_C");
static_assert(offsetof(UBP_Action_BeThrown_C, UberGraphFrame) == 0x000170, "Member 'UBP_Action_BeThrown_C::UberGraphFrame' has a wrong offset!");
