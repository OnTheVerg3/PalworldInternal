...
static_assert(alignof(WBP_Option_NoteContent_C_SetText) == 0x000008, "Wrong alignment on WBP_Option_NoteContent_C_SetText");
static_assert(sizeof(WBP_Option_NoteContent_C_SetText) == 0x000018, "Wrong size on WBP_Option_NoteContent_C_SetText");
static_assert(offsetof(WBP_Option_NoteContent_C_SetText, InText) == 0x000000, "Member 'WBP_Option_NoteContent_C_SetText::InText' has a wrong offset!");
...
static_assert(alignof(WBP_Option_NoteContent_C_SetImage) == 0x000008, "Wrong alignment on WBP_Option_NoteContent_C_SetImage");
static_assert(sizeof(WBP_Option_NoteContent_C_SetImage) == 0x000030, "Wrong size on WBP_Option_NoteContent_C_SetImage");
static_assert(offsetof(WBP_Option_NoteContent_C_SetImage, SoftTexture) == 0x000000, "Member 'WBP_Option_NoteContent_C_SetImage::SoftTexture' has a wrong offset!");
