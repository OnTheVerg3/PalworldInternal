...
static_assert(sizeof(BP_PalMonsterCaptureSet_C_Reset) == 0x000250, "Wrong size on BP_PalMonsterCaptureSet_C_Reset");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_Reset, CallFunc_IsValid_ReturnValue) == 0x000000, "Member 'BP_PalMonsterCaptureSet_C_Reset::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_Reset, CallFunc_MakeTransform_ReturnValue) == 0x000010, "Member 'BP_PalMonsterCaptureSet_C_Reset::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_Reset, CallFunc_K2_SetActorTransform_SweepHitResult) == 0x000070, "Member 'BP_PalMonsterCaptureSet_C_Reset::CallFunc_K2_SetActorTransform_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_Reset, CallFunc_K2_SetActorTransform_ReturnValue) == 0x000158, "Member 'BP_PalMonsterCaptureSet_C_Reset::CallFunc_K2_SetActorTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_Reset, CallFunc_Array_RemoveItem_ReturnValue) == 0x000159, "Member 'BP_PalMonsterCaptureSet_C_Reset::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_Reset, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x000160, "Member 'BP_PalMonsterCaptureSet_C_Reset::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
...
static_assert(alignof(BP_PalMonsterCaptureSet_C_ReceiveEndPlay) == 0x000001, "Wrong alignment on BP_PalMonsterCaptureSet_C_ReceiveEndPlay");
static_assert(sizeof(BP_PalMonsterCaptureSet_C_ReceiveEndPlay) == 0x000001, "Wrong size on BP_PalMonsterCaptureSet_C_ReceiveEndPlay");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ReceiveEndPlay, EndPlayReason) == 0x000000, "Member 'BP_PalMonsterCaptureSet_C_ReceiveEndPlay::EndPlayReason' has a wrong offset!");
...
public:
	...
	TSoftClassPtr<class UClass>                   CallFunc_Map_Find_Value_1;                         // 0x0040(0x0030)(HasGetValueTypeHash)
	...
	class UClass*                                 K2Node_ClassDynamicCast_AsActor;                   // 0x0080(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName; // 0x008C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USkeletalMesh*                          CallFunc_Map_Find_Value_2;                         // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName_1; // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_NameName_ReturnValue_1;        // 0x0138(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalUICaptureCameraOffsetData          CallFunc_GetDataTableRowFromName_OutRow;           // 0x0148(0x00B0)()
	...
	struct FHitResult                             CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult; // 0x0200(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeRotation_SweepHitResult;    // 0x02E8(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult;    // 0x03D0(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_1;  // 0x04B8(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                             CallFunc_K2_SetRelativeLocation_SweepHitResult_2;  // 0x05A0(0x00E8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
...
static_assert(sizeof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class) == 0x000690, "Wrong size on BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class");
...
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, NewLocalVar) == 0x000008, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::NewLocalVar' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, Temp_byte_Variable) == 0x000010, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetStaticParameteComponentFromActorClassr_ReturnValue) == 0x000018, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetStaticParameteComponentFromActorClassr_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_Value) == 0x000028, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_ReturnValue) == 0x000030, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetSkeletalMeshAsset_ReturnValue) == 0x000038, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetSkeletalMeshAsset_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_Value_1) == 0x000040, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_ReturnValue_1) == 0x000070, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_LoadClassAsset_Blocking_ReturnValue) == 0x000078, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_LoadClassAsset_Blocking_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, K2Node_ClassDynamicCast_AsActor) == 0x000080, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::K2Node_ClassDynamicCast_AsActor' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, K2Node_ClassDynamicCast_bSuccess) == 0x000088, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName) == 0x00008C, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000094, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, Temp_name_Variable) == 0x000098, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::Temp_name_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_AttachToComponent_ReturnValue) == 0x0000A0, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_Value_2) == 0x0000A8, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_Value_2' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Find_ReturnValue_2) == 0x0000B0, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Find_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Map_Contains_ReturnValue) == 0x0000B1, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Map_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetTransform_ReturnValue) == 0x0000C0, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x000120, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_FinishSpawningActor_ReturnValue) == 0x000128, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName_1) == 0x000130, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetTribeIDNameFromCharacterID_outTribeIDName_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x000138, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, Temp_bool_Variable) == 0x000139, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_Array_Add_ReturnValue) == 0x00013C, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, K2Node_Select_Default) == 0x000140, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetDataTableRowFromName_OutRow) == 0x000148, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0001F8, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult) == 0x000200, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x0002E8, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocation_SweepHitResult) == 0x0003D0, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocation_SweepHitResult_1) == 0x0004B8, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocation_SweepHitResult_1' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class, CallFunc_K2_SetRelativeLocation_SweepHitResult_2) == 0x0005A0, "Member 'BP_PalMonsterCaptureSet_C_On_Loaded_Pal_Class::CallFunc_K2_SetRelativeLocation_SweepHitResult_2' has a wrong offset!");
...
static_assert(sizeof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet) == 0x000180, "Wrong size on BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet");
...
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, Temp_class_Variable) == 0x000008, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::Temp_class_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, K2Node_ClassDynamicCast_AsPal_Character) == 0x000010, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::K2Node_ClassDynamicCast_AsPal_Character' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, K2Node_ClassDynamicCast_bSuccess) == 0x000018, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::K2Node_ClassDynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, K2Node_CustomEvent_NewParam) == 0x000020, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::K2Node_CustomEvent_NewParam' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, K2Node_CreateDelegate_OutputDelegate) == 0x000050, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, K2Node_CustomEvent_Loaded) == 0x000060, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::K2Node_CustomEvent_Loaded' has a wrong offset!");
...
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, K2Node_Event_EndPlayReason) == 0x000070, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::K2Node_Event_EndPlayReason' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, CallFunc_RLerp_ReturnValue) == 0x000078, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::CallFunc_RLerp_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x000090, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, CallFunc_IsValid_ReturnValue) == 0x000178, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet, CallFunc_RLerp_Alpha_ImplicitCast) == 0x00017C, "Member 'BP_PalMonsterCaptureSet_C_ExecuteUbergraph_BP_PalMonsterCaptureSet::CallFunc_RLerp_Alpha_ImplicitCast' has a wrong offset!");
