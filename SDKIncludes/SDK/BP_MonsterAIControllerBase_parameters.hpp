...
static_assert(sizeof(BP_MonsterAIControllerBase_C_ExecuteUbergraph_BP_MonsterAIControllerBase) == 0x000070, "Wrong size on BP_MonsterAIControllerBase_C_ExecuteUbergraph_BP_MonsterAIControllerBase");
...
static_assert(offsetof(BP_MonsterAIControllerBase_C_ExecuteUbergraph_BP_MonsterAIControllerBase, CallFunc_GetComponentByClass_ReturnValue) == 0x000068, "Member 'BP_MonsterAIControllerBase_C_ExecuteUbergraph_BP_MonsterAIControllerBase::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BP_MonsterAIControllerBase_C_カスタムイベント_0) == 0x000008, "Wrong alignment on BP_MonsterAIControllerBase_C_カスタムイベント_0");
static_assert(sizeof(BP_MonsterAIControllerBase_C_カスタムイベント_0) == 0x000008, "Wrong size on BP_MonsterAIControllerBase_C_カスタムイベント_0");
static_assert(offsetof(BP_MonsterAIControllerBase_C_カスタムイベント_0, InCharacter) == 0x000000, "Member 'BP_MonsterAIControllerBase_C_カスタムイベント_0::InCharacter' has a wrong offset!");
