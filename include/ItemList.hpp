...
namespace itemlist
{
    const std::vector<const char*> accessories =
    {
    ...
    const std::vector<const char*> eggs =
    {
    ...
    const std::vector<const char*> food =
    {
        "BLT|Burrito",
    ...
    static const std::map<std::string, const std::vector<const char*>*> itemCategories = {
    ...
    { "Crafting Materials", &craftingmaterials },
    { "Eggs", &eggs },
    { "Food", &food },
    { "Medicine", &medicine },
    { "Pal Spheres", &palspheres },
    { "Seeds", &seeds },
    { "Tools", &tools },
    { "Weapons", &weapons },
    { "Other", &other },
