...
namespace database
{
    ...
    static const std::vector<const char*> palNames =
    {
    "Alpaca",
    "AmaterasuWolf",
    "Anubis",
    ...
    {"Chillet (Lv.11)", { -315195, 236714, 2452.12 }},
    {"Gumoss (Lv.11)", { -409885.46, 108120.6, -1949.58 }},
    {"Sweepa (Lv.11)", { -393427, 51430, -1485 }},
    {"Damud (Lv.14)", { -119623, 17957, -1291 }},
    {"Penking (Lv.15)", { -285343.94, 210129.58, 854.23 }},
    {"Azurobe (Lv.17)", { -300596, 136090, -2033.13 }},
    {"Grintale (Lv.17)", { -234807, 321166, -1826.19 }},
    {"Nitewing (Lv.18)", { -157475, 30628.2, -1894.64 }},
    {"Broncherry (Lv.23)", { -430777.18, 56266.50, -1774.57 }},
    {"Bushi (Lv.23)", { -349079.05, 104564.46, -121.11 }},
    {"Felbat (Lv.23)", { -149024, -30562.7, -1291.73 }},
    {"Katress (Lv.23)", { -276223, 268992, -1209.67 }},
    {"Kingpaca (Lv.23)", { -336105, 181639, 901.022 }},
    {"Quivern (Lv.23)", { -183795, 40661.4, 8547.3 }},
    {"Fenglope (Lv.25)", { -332470, 40256.4, 1333.93 }},
    {"Petallia (Lv.28)", { -245440, 149098, 913.216 }},
    {"Beakon (Lv.29)", { -237981, 2559.41, 8413.65 }},
    {"BroncherryAqua (Lv.30)", { -330059.98, 81386.99, -1929.8 }},
    {"Elphidran (Lv.30)", { -251895, 180540, 4089 }},
    {"Warsect (Lv.30)", { -226359, 231970, -1807.45 }},
    {"Elizabee (Lv.31)", { -197627, 167101, -1964.75 }},
    {"MossandaLux (Lv.31)", { -208233, 364318, 1167.46 }},
    {"RelaxasaurusLux (Lv.31)", { -282860, 64923.7, 5357.72 }},
    {"Univolt (Lv.31)", { -372419.57, 102508.29, -392 }},
    {"Lunaris (Lv.32)", { -426589.48, 90677.8, 215.90 }},
    {"Verdash (Lv.35)", { -119349, 288954, 3186.98 }},
    {"Mammorest (Lv.38)", { -341702, 243628, -533.76 }},
    {"Vaelet (Lv.38)", { -147042, 217357, 2857.45 }},
    {"WumpoBotan (Lv.38)", { -148826, 364859, -1831.33 }},
    {"Siblex (Lv.40)", { -92023.6, 273762, 18967.3 }},
    {"Kingpaca Cryst (Lv.43)", { 92433, 51564, 17606 }},
    {"Menasting (Lv.44)", { -77943, 393182, 665.51 }},
    {"Jormuntide (Lv.45)", { -163184, 314483, -2100.13 }},
    {"Jormuntide (Lv.45)", { -244207, 74851.5, -1157.08 }},
    {"Suzaku (Lv.45)", { -4320.07, 340927, 205.005 }},
    {"Anubis (Lv.47)", { -170269, 94163.7, -1527.83 }},
    {"DinossomLux (Lv.47)", { 125311, 318722, 266.384 }},
    {"Astegon (Lv.48)", { -320312, -120265, 18576 }},
    {"Blazamut (Lv.49)", { -377246, -43725, 8626 }},
    {"Lyleen Noct (Lv.49)", { 31477, 85873, 5448 }},
    {"Frostallion (Lv.50)", { 111978, -6394.85, 21940.2 }},
    {"Jetragon (Lv.50)", { -270762, -205837, 3834.92 }},
