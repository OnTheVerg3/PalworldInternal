...
static_assert(alignof(WBP_EnemyMark_C_カスタムイベント_0) == 0x000008, "Wrong alignment on WBP_EnemyMark_C_カスタムイベント_0");
static_assert(sizeof(WBP_EnemyMark_C_カスタムイベント_0) == 0x000008, "Wrong size on WBP_EnemyMark_C_カスタムイベント_0");
static_assert(offsetof(WBP_EnemyMark_C_カスタムイベント_0, TargetCharacter) == 0x000000, "Member 'WBP_EnemyMark_C_カスタムイベント_0::TargetCharacter' has a wrong offset!");
...
static_assert(alignof(WBP_EnemyMark_C_カスタムイベント_1) == 0x000008, "Wrong alignment on WBP_EnemyMark_C_カスタムイベント_1");
static_assert(sizeof(WBP_EnemyMark_C_カスタムイベント_1) == 0x000008, "Wrong size on WBP_EnemyMark_C_カスタムイベント_1");
static_assert(offsetof(WBP_EnemyMark_C_カスタムイベント_1, TargetCharacter) == 0x000000, "Member 'WBP_EnemyMark_C_カスタムイベント_1::TargetCharacter' has a wrong offset!");
