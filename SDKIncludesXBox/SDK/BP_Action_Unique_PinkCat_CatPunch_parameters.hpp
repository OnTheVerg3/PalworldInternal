...
static_assert(alignof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove) == 0x000008, "Wrong alignment on BP_Action_Unique_PinkCat_CatPunch_C_SetMove");
static_assert(sizeof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove) == 0x000068, "Wrong size on BP_Action_Unique_PinkCat_CatPunch_C_SetMove");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, EnableMove) == 0x000000, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::EnableMove' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, CallFunc_GetActionCharacter_ReturnValue) == 0x000008, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::CallFunc_GetActionCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, CallFunc_GetActionCharacter_ReturnValue_1) == 0x000010, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::CallFunc_GetActionCharacter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, CallFunc_GetComponentByClass_ReturnValue) == 0x000018, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, CallFunc_GetActorForwardVector_ReturnValue) == 0x000020, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::CallFunc_GetActorForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, CallFunc_SelectVector_ReturnValue) == 0x000038, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::CallFunc_SelectVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, CallFunc_IsValid_ReturnValue) == 0x000050, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, Temp_real_Variable) == 0x000054, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::Temp_real_Variable' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, Temp_bool_Variable) == 0x000058, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, K2Node_Select_Default) == 0x00005C, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_SetMove, K2Node_Select_Option_1_ImplicitCast) == 0x000060, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_SetMove::K2Node_Select_Option_1_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget) == 0x0000A8, "Wrong size on BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget");
...
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, K2Node_SwitchEnum_CmpSuccess) == 0x000008, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x000009, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_GetActionCharacter_ReturnValue) == 0x000010, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_GetActionCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_GetActorForwardVector_ReturnValue) == 0x000018, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_GetActorForwardVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_GetComponentByClass_ReturnValue) == 0x000030, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_GetActionCharacter_ReturnValue_1) == 0x000038, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_GetActionCharacter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_Get_Target_Rotation_TargetRotation) == 0x000040, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_Get_Target_Rotation_TargetRotation' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_VSize_ReturnValue) == 0x000058, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_VSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_K2_SetActorRotation_ReturnValue) == 0x000060, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_K2_SetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_Conv_DoubleToVector_ReturnValue) == 0x000068, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_Conv_DoubleToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_GetActionTarget_ReturnValue) == 0x000080, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_GetActionTarget_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_Multiply_VectorVector_ReturnValue) == 0x000088, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget, CallFunc_IsValid_ReturnValue) == 0x0000A0, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_MoveToTarget::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_ExecuteUbergraph_BP_Action_Unique_PinkCat_CatPunch, CallFunc_CreateProxyObjectForPlayMontage_ReturnValue_2) == 0x0001F0, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_ExecuteUbergraph_BP_Action_Unique_PinkCat_CatPunch::CallFunc_CreateProxyObjectForPlayMontage_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_Action_Unique_PinkCat_CatPunch_C_ExecuteUbergraph_BP_Action_Unique_PinkCat_CatPunch, K2Node_CustomEvent_NotifyName_14) == 0x0001F8, "Member 'BP_Action_Unique_PinkCat_CatPunch_C_ExecuteUbergraph_BP_Action_Unique_PinkCat_CatPunch::K2Node_CustomEvent_NotifyName_14' has a wrong offset!");
