...
static_assert(alignof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton) == 0x000008, "Wrong alignment on WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton");
static_assert(sizeof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton) == 0x000020, "Wrong size on WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000000, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, K2Node_DynamicCast_AsPal_Player_Controller) == 0x000010, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::K2Node_DynamicCast_AsPal_Player_Controller' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, K2Node_DynamicCast_bSuccess) == 0x000018, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, CallFunc_IsSameTriggeringActionType_IsSame) == 0x000019, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::CallFunc_IsSameTriggeringActionType_IsSame' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, CallFunc_IsToggleInteract_ReturnValue) == 0x00001A, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::CallFunc_IsToggleInteract_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, CallFunc_BooleanAND_ReturnValue) == 0x00001B, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton, K2Node_SwitchEnum_CmpSuccess) == 0x00001C, "Member 'WBP_PalInteractiveObjectIndicatorUI_C_ReleaseInteractButton::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
