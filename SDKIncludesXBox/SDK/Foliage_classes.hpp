...
static_assert(offsetof(UFoliageInstancedStaticMeshComponent, OnInstanceTakePointDamage) == 0x0008D8, "Member 'UFoliageInstancedStaticMeshComponent::OnInstanceTakePointDamage' has a wrong offset!");
...
static_assert(sizeof(UGrassInstancedStaticMeshComponent) == 0x0008E0, "Wrong size on UGrassInstancedStaticMeshComponent");
