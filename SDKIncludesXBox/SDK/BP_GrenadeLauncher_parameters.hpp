...
static_assert(alignof(BP_GrenadeLauncher_C_OnShoot) == 0x000008, "Wrong alignment on BP_GrenadeLauncher_C_OnShoot");
static_assert(sizeof(BP_GrenadeLauncher_C_OnShoot) == 0x000008, "Wrong size on BP_GrenadeLauncher_C_OnShoot");
static_assert(offsetof(BP_GrenadeLauncher_C_OnShoot, BulletActor) == 0x000000, "Member 'BP_GrenadeLauncher_C_OnShoot::BulletActor' has a wrong offset!");
...
static_assert(alignof(BP_GrenadeLauncher_C_OnReloadStart) == 0x000004, "Wrong alignment on BP_GrenadeLauncher_C_OnReloadStart");
static_assert(sizeof(BP_GrenadeLauncher_C_OnReloadStart) == 0x000004, "Wrong size on BP_GrenadeLauncher_C_OnReloadStart");
static_assert(offsetof(BP_GrenadeLauncher_C_OnReloadStart, InReloadSpeedPlayRate) == 0x000000, "Member 'BP_GrenadeLauncher_C_OnReloadStart::InReloadSpeedPlayRate' has a wrong offset!");
...
public:
	...
	class AActor*                                 K2Node_Event_detachActor;                          // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher) == 0x000050, "Wrong size on BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher");
...
static_assert(offsetof(BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher, K2Node_Event_InReloadSpeedPlayRate) == 0x000038, "Member 'BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher::K2Node_Event_InReloadSpeedPlayRate' has a wrong offset!");
static_assert(offsetof(BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher, K2Node_Event_detachActor) == 0x000040, "Member 'BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher::K2Node_Event_detachActor' has a wrong offset!");
static_assert(offsetof(BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher, K2Node_Event_attachActor) == 0x000048, "Member 'BP_GrenadeLauncher_C_ExecuteUbergraph_BP_GrenadeLauncher::K2Node_Event_attachActor' has a wrong offset!");
