...
static_assert(sizeof(WBP_PalLogWidget_C_CREATEDELEGATE_PROXYFUNCTION_0) == 0x000068, "Wrong size on WBP_PalLogWidget_C_CREATEDELEGATE_PROXYFUNCTION_0");
...
public:
	...
	class UPalLogWidgetBase*                      CallFunc_CreateLogWidget_createdWidget_1;          // 0x00B0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLogWidgetBase*                      CallFunc_Array_Get_Item;                           // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_CreateItemGetLogText_ReturnValue;         // 0x00C8(0x0018)()
	bool                                          CallFunc_LessEqual_ByteByte_ReturnValue;           // 0x00E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalStaticItemIdAndNum                 K2Node_MakeStruct_PalStaticItemIdAndNum;           // 0x00E8(0x000C)(NoDestructor)
	...
	class UPalLogWidgetBase*                      CallFunc_Array_Get_Item_1;                         // 0x00F8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_PalLogWidget_C_On_Added_Normal_Log) == 0x000120, "Wrong size on WBP_PalLogWidget_C_On_Added_Normal_Log");
...
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, K2Node_MakeStruct_Margin) == 0x000068, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_AddChild_ReturnValue) == 0x000078, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_AddChild_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Array_Length_ReturnValue) == 0x000080, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_SlotAsScrollBoxSlot_ReturnValue) == 0x000088, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_SlotAsScrollBoxSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, Temp_int_Loop_Counter_Variable_1) == 0x000090, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Less_IntInt_ReturnValue) == 0x000094, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Add_IntInt_ReturnValue_1) == 0x000098, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_CreateLogWidget_createdWidget) == 0x0000A0, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_CreateLogWidget_createdWidget' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_IsValidClass_ReturnValue) == 0x0000A8, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_CreateLogWidget_createdWidget_1) == 0x0000B0, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_CreateLogWidget_createdWidget_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, Temp_int_Array_Index_Variable_1) == 0x0000B8, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Array_Get_Item) == 0x0000C0, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_CreateItemGetLogText_ReturnValue) == 0x0000C8, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_CreateItemGetLogText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_LessEqual_ByteByte_ReturnValue) == 0x0000E0, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_LessEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Add_IntInt_ReturnValue_2) == 0x0000E4, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, K2Node_MakeStruct_PalStaticItemIdAndNum) == 0x0000E8, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::K2Node_MakeStruct_PalStaticItemIdAndNum' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_EqualEqual_NameName_ReturnValue) == 0x0000F4, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_BooleanAND_ReturnValue) == 0x0000F5, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Array_Get_Item_1) == 0x0000F8, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Array_Length_ReturnValue_1) == 0x000100, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Less_IntInt_ReturnValue_1) == 0x000104, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Array_Length_ReturnValue_2) == 0x000108, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, K2Node_SwitchEnum_CmpSuccess) == 0x00010C, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Greater_IntInt_ReturnValue_1) == 0x00010D, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Greater_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Array_Add_ReturnValue) == 0x000110, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_On_Added_Normal_Log, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000118, "Member 'WBP_PalLogWidget_C_On_Added_Normal_Log::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_PalLogWidget_C_OnAddedDeathLog) == 0x0000A8, "Wrong size on WBP_PalLogWidget_C_OnAddedDeathLog");
...
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, K2Node_CreateDelegate_OutputDelegate) == 0x000068, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000078, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, CallFunc_Create_ReturnValue) == 0x000080, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000088, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, CallFunc_Array_Add_ReturnValue) == 0x000090, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, CallFunc_SetDisplayTime_ShortDisplayTime_ImplicitCast) == 0x000098, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::CallFunc_SetDisplayTime_ShortDisplayTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedDeathLog, CallFunc_SetDisplayTime_LongDisplayTime_ImplicitCast) == 0x0000A0, "Member 'WBP_PalLogWidget_C_OnAddedDeathLog::CallFunc_SetDisplayTime_LongDisplayTime_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(WBP_PalLogWidget_C_OnAddedKillLog) == 0x0000A8, "Wrong size on WBP_PalLogWidget_C_OnAddedKillLog");
...
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, K2Node_CreateDelegate_OutputDelegate) == 0x000068, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000078, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, CallFunc_Create_ReturnValue) == 0x000080, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000088, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, CallFunc_Array_Add_ReturnValue) == 0x000090, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, CallFunc_SetDisplayTime_ShortDisplayTime_ImplicitCast) == 0x000098, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::CallFunc_SetDisplayTime_ShortDisplayTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_PalLogWidget_C_OnAddedKillLog, CallFunc_SetDisplayTime_LongDisplayTime_ImplicitCast) == 0x0000A0, "Member 'WBP_PalLogWidget_C_OnAddedKillLog::CallFunc_SetDisplayTime_LongDisplayTime_ImplicitCast' has a wrong offset!");
