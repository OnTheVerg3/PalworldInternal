...
static_assert(alignof(WBP_CompassIconBase_C_GetLocation) == 0x000008, "Wrong alignment on WBP_CompassIconBase_C_GetLocation");
static_assert(sizeof(WBP_CompassIconBase_C_GetLocation) == 0x000020, "Wrong size on WBP_CompassIconBase_C_GetLocation");
static_assert(offsetof(WBP_CompassIconBase_C_GetLocation, Location) == 0x000000, "Member 'WBP_CompassIconBase_C_GetLocation::Location' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_GetLocation, CallFunc_GetLocationManager_ReturnValue) == 0x000008, "Member 'WBP_CompassIconBase_C_GetLocation::CallFunc_GetLocationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_GetLocation, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_CompassIconBase_C_GetLocation::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_GetLocation, CallFunc_GetLocation_ReturnValue) == 0x000018, "Member 'WBP_CompassIconBase_C_GetLocation::CallFunc_GetLocation_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_CompassIconBase_C_SetTargetLocation) == 0x000020, "Wrong size on WBP_CompassIconBase_C_SetTargetLocation");
...
static_assert(offsetof(WBP_CompassIconBase_C_SetTargetLocation, bInDistanceXY) == 0x000018, "Member 'WBP_CompassIconBase_C_SetTargetLocation::bInDistanceXY' has a wrong offset!");
...
static_assert(sizeof(WBP_CompassIconBase_C_UpdateDistance) == 0x000058, "Wrong size on WBP_CompassIconBase_C_UpdateDistance");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, LocalPlayerLocation) == 0x000000, "Member 'WBP_CompassIconBase_C_UpdateDistance::LocalPlayerLocation' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, CallFunc_GetPalmi_ReturnValue) == 0x000018, "Member 'WBP_CompassIconBase_C_UpdateDistance::CallFunc_GetPalmi_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, CallFunc_IsValid_ReturnValue) == 0x000020, "Member 'WBP_CompassIconBase_C_UpdateDistance::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000028, "Member 'WBP_CompassIconBase_C_UpdateDistance::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, CallFunc_Vector_Distance_ReturnValue) == 0x000040, "Member 'WBP_CompassIconBase_C_UpdateDistance::CallFunc_Vector_Distance_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, CallFunc_Vector_Distance2D_ReturnValue) == 0x000048, "Member 'WBP_CompassIconBase_C_UpdateDistance::CallFunc_Vector_Distance2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIconBase_C_UpdateDistance, CallFunc_SelectFloat_ReturnValue) == 0x000050, "Member 'WBP_CompassIconBase_C_UpdateDistance::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
