...
static_assert(alignof(WBP_IngameSmesTop_C_On_Player_Level_Up) == 0x000004, "Wrong alignment on WBP_IngameSmesTop_C_On_Player_Level_Up");
static_assert(sizeof(WBP_IngameSmesTop_C_On_Player_Level_Up) == 0x000004, "Wrong size on WBP_IngameSmesTop_C_On_Player_Level_Up");
static_assert(offsetof(WBP_IngameSmesTop_C_On_Player_Level_Up, DisplayLevel) == 0x000000, "Member 'WBP_IngameSmesTop_C_On_Player_Level_Up::DisplayLevel' has a wrong offset!");
