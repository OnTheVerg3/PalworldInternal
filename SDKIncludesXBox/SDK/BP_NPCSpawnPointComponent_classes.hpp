...
static_assert(sizeof(UBP_NPCSpawnPointComponent_C) == 0x000630, "Wrong size on UBP_NPCSpawnPointComponent_C");
...
static_assert(offsetof(UBP_NPCSpawnPointComponent_C, OtomoName) == 0x000620, "Member 'UBP_NPCSpawnPointComponent_C::OtomoName' has a wrong offset!");
