...
static_assert(offsetof(WBP_Ingame_PalHPGauge_C_OnActivatedOtomo, CallFunc_GetSpawnedOtomoID_ReturnValue) == 0x000008, "Member 'WBP_Ingame_PalHPGauge_C_OnActivatedOtomo::CallFunc_GetSpawnedOtomoID_ReturnValue' has a wrong offset!");
