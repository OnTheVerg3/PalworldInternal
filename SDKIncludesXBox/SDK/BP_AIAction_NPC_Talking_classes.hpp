...
static_assert(sizeof(UBP_AIAction_NPC_Talking_C) == 0x000180, "Wrong size on UBP_AIAction_NPC_Talking_C");
...
static_assert(offsetof(UBP_AIAction_NPC_Talking_C, ActionBase) == 0x000170, "Member 'UBP_AIAction_NPC_Talking_C::ActionBase' has a wrong offset!");
static_assert(offsetof(UBP_AIAction_NPC_Talking_C, IsSetAction) == 0x000178, "Member 'UBP_AIAction_NPC_Talking_C::IsSetAction' has a wrong offset!");
