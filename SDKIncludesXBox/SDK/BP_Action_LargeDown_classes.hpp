...
static_assert(sizeof(UBP_Action_LargeDown_C) == 0x000170, "Wrong size on UBP_Action_LargeDown_C");
static_assert(offsetof(UBP_Action_LargeDown_C, UberGraphFrame) == 0x000160, "Member 'UBP_Action_LargeDown_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_Action_LargeDown_C, Const_DownTime) == 0x000168, "Member 'UBP_Action_LargeDown_C::Const_DownTime' has a wrong offset!");
