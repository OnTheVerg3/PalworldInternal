...
static_assert(alignof(BP_Flamethrower_C_OnReloadStart) == 0x000004, "Wrong alignment on BP_Flamethrower_C_OnReloadStart");
static_assert(sizeof(BP_Flamethrower_C_OnReloadStart) == 0x000004, "Wrong size on BP_Flamethrower_C_OnReloadStart");
static_assert(offsetof(BP_Flamethrower_C_OnReloadStart, InReloadSpeedPlayRate) == 0x000000, "Member 'BP_Flamethrower_C_OnReloadStart::InReloadSpeedPlayRate' has a wrong offset!");
...
static_assert(sizeof(BP_Flamethrower_C_ExecuteUbergraph_BP_Flamethrower) == 0x000020, "Wrong size on BP_Flamethrower_C_ExecuteUbergraph_BP_Flamethrower");
...
static_assert(offsetof(BP_Flamethrower_C_ExecuteUbergraph_BP_Flamethrower, K2Node_Event_InReloadSpeedPlayRate) == 0x000014, "Member 'BP_Flamethrower_C_ExecuteUbergraph_BP_Flamethrower::K2Node_Event_InReloadSpeedPlayRate' has a wrong offset!");
static_assert(offsetof(BP_Flamethrower_C_ExecuteUbergraph_BP_Flamethrower, CallFunc_IsEmptyMagazine_ReturnValue) == 0x000018, "Member 'BP_Flamethrower_C_ExecuteUbergraph_BP_Flamethrower::CallFunc_IsEmptyMagazine_ReturnValue' has a wrong offset!");
