...
public:
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetCharacterSaveParameter_ReturnValue;    // 0x0088(0x0320)(ConstParm)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue;      // 0x03A8(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	class FName                                   CallFunc_GetSaveParameterValue_CharacterID_ReturnValue; // 0x03D8(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue_1;    // 0x03E0(0x0030)(UObjectWrapper, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_CompassIcon_ForPal_C_SetupTexture) == 0x000410, "Wrong size on WBP_CompassIcon_ForPal_C_SetupTexture");
...
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetCharacterIconTexture_ReturnValue) == 0x0003A8, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetCharacterIconTexture_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetSaveParameterValue_CharacterID_ReturnValue) == 0x0003D8, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetSaveParameterValue_CharacterID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetCharacterIconTexture_ReturnValue_1) == 0x0003E0, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetCharacterIconTexture_ReturnValue_1' has a wrong offset!");
