...
static_assert(sizeof(UWBP_InGame_Arena_C) == 0x0002C0, "Wrong size on UWBP_InGame_Arena_C");
...
static_assert(offsetof(UWBP_InGame_Arena_C, CurrentResultUI) == 0x0002B0, "Member 'UWBP_InGame_Arena_C::CurrentResultUI' has a wrong offset!");
static_assert(offsetof(UWBP_InGame_Arena_C, UISet) == 0x0002B8, "Member 'UWBP_InGame_Arena_C::UISet' has a wrong offset!");
