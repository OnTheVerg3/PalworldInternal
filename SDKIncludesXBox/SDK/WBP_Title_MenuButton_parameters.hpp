...
static_assert(alignof(WBP_Title_MenuButton_C_SetAttention) == 0x000001, "Wrong alignment on WBP_Title_MenuButton_C_SetAttention");
static_assert(sizeof(WBP_Title_MenuButton_C_SetAttention) == 0x000005, "Wrong size on WBP_Title_MenuButton_C_SetAttention");
static_assert(offsetof(WBP_Title_MenuButton_C_SetAttention, bEnableAttention) == 0x000000, "Member 'WBP_Title_MenuButton_C_SetAttention::bEnableAttention' has a wrong offset!");
static_assert(offsetof(WBP_Title_MenuButton_C_SetAttention, Temp_bool_Variable) == 0x000001, "Member 'WBP_Title_MenuButton_C_SetAttention::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Title_MenuButton_C_SetAttention, Temp_byte_Variable) == 0x000002, "Member 'WBP_Title_MenuButton_C_SetAttention::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Title_MenuButton_C_SetAttention, Temp_byte_Variable_1) == 0x000003, "Member 'WBP_Title_MenuButton_C_SetAttention::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_Title_MenuButton_C_SetAttention, K2Node_Select_Default) == 0x000004, "Member 'WBP_Title_MenuButton_C_SetAttention::K2Node_Select_Default' has a wrong offset!");
