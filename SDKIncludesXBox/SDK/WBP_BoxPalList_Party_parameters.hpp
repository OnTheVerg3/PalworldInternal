...
public:
	...
	bool                                          CallFunc_EqualEqual_NameName_ReturnValue_1;        // 0x004E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(WBP_BoxPalList_Party_C_ExecuteUbergraph_WBP_BoxPalList_Party, CallFunc_EqualEqual_NameName_ReturnValue) == 0x00004C, "Member 'WBP_BoxPalList_Party_C_ExecuteUbergraph_WBP_BoxPalList_Party::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_ExecuteUbergraph_WBP_BoxPalList_Party, K2Node_Event_IsDesignTime) == 0x00004D, "Member 'WBP_BoxPalList_Party_C_ExecuteUbergraph_WBP_BoxPalList_Party::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_ExecuteUbergraph_WBP_BoxPalList_Party, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x00004E, "Member 'WBP_BoxPalList_Party_C_ExecuteUbergraph_WBP_BoxPalList_Party::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
...
static_assert(alignof(WBP_BoxPalList_Party_C_GetLastFocusBoxSlot) == 0x000008, "Wrong alignment on WBP_BoxPalList_Party_C_GetLastFocusBoxSlot");
static_assert(sizeof(WBP_BoxPalList_Party_C_GetLastFocusBoxSlot) == 0x000010, "Wrong size on WBP_BoxPalList_Party_C_GetLastFocusBoxSlot");
static_assert(offsetof(WBP_BoxPalList_Party_C_GetLastFocusBoxSlot, TargetWidget) == 0x000000, "Member 'WBP_BoxPalList_Party_C_GetLastFocusBoxSlot::TargetWidget' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_GetLastFocusBoxSlot, CallFunc_GetLastHoveredFocusTarget_TargetWidget) == 0x000008, "Member 'WBP_BoxPalList_Party_C_GetLastFocusBoxSlot::CallFunc_GetLastHoveredFocusTarget_TargetWidget' has a wrong offset!");
...
static_assert(alignof(WBP_BoxPalList_Party_C_PreConstruct) == 0x000001, "Wrong alignment on WBP_BoxPalList_Party_C_PreConstruct");
static_assert(sizeof(WBP_BoxPalList_Party_C_PreConstruct) == 0x000001, "Wrong size on WBP_BoxPalList_Party_C_PreConstruct");
static_assert(offsetof(WBP_BoxPalList_Party_C_PreConstruct, IsDesignTime) == 0x000000, "Member 'WBP_BoxPalList_Party_C_PreConstruct::IsDesignTime' has a wrong offset!");
...
static_assert(alignof(WBP_BoxPalList_Party_C_Setup_Party_Slot) == 0x000008, "Wrong alignment on WBP_BoxPalList_Party_C_Setup_Party_Slot");
static_assert(sizeof(WBP_BoxPalList_Party_C_Setup_Party_Slot) == 0x000030, "Wrong size on WBP_BoxPalList_Party_C_Setup_Party_Slot");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, Temp_int_Array_Index_Variable) == 0x000000, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, Temp_int_Loop_Counter_Variable) == 0x000004, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, CallFunc_Add_IntInt_ReturnValue) == 0x000008, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, CallFunc_GetOtomoHolderComponent_ReturnValue) == 0x000010, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::CallFunc_GetOtomoHolderComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, CallFunc_Array_Get_Item) == 0x000018, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, CallFunc_GetOtomoIndividualCharacterSlot_ReturnValue) == 0x000020, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::CallFunc_GetOtomoIndividualCharacterSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, CallFunc_Array_Length_ReturnValue) == 0x000028, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_BoxPalList_Party_C_Setup_Party_Slot, CallFunc_Less_IntInt_ReturnValue) == 0x00002C, "Member 'WBP_BoxPalList_Party_C_Setup_Party_Slot::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
