...
static_assert(sizeof(ABP_CutsceneActor_Arena_PreBattle_C) == 0x000330, "Wrong size on ABP_CutsceneActor_Arena_PreBattle_C");
static_assert(offsetof(ABP_CutsceneActor_Arena_PreBattle_C, UberGraphFrame) == 0x000320, "Member 'ABP_CutsceneActor_Arena_PreBattle_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_CutsceneActor_Arena_PreBattle_C, PreBattleBindParameter) == 0x000328, "Member 'ABP_CutsceneActor_Arena_PreBattle_C::PreBattleBindParameter' has a wrong offset!");
