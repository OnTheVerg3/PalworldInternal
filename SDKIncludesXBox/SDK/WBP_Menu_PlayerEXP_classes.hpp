...
static_assert(sizeof(UWBP_Menu_PlayerEXP_C) == 0x000640, "Wrong size on UWBP_Menu_PlayerEXP_C");
static_assert(offsetof(UWBP_Menu_PlayerEXP_C, UberGraphFrame_WBP_Menu_PlayerEXP_C) == 0x000638, "Member 'UWBP_Menu_PlayerEXP_C::UberGraphFrame_WBP_Menu_PlayerEXP_C' has a wrong offset!");
