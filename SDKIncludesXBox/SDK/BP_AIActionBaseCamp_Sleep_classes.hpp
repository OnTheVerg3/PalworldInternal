...
static_assert(sizeof(UBP_AIActionBaseCamp_Sleep_C) == 0x0001E0, "Wrong size on UBP_AIActionBaseCamp_Sleep_C");
static_assert(offsetof(UBP_AIActionBaseCamp_Sleep_C, UberGraphFrame) == 0x0001D0, "Member 'UBP_AIActionBaseCamp_Sleep_C::UberGraphFrame' has a wrong offset!");
