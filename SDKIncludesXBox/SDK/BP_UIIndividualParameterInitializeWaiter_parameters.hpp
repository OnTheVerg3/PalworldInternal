...
static_assert(sizeof(BP_UIIndividualParameterInitializeWaiter_C_OnCompleteInitiaize) == 0x000018, "Wrong size on BP_UIIndividualParameterInitializeWaiter_C_OnCompleteInitiaize");
...
static_assert(sizeof(BP_UIIndividualParameterInitializeWaiter_C_Register) == 0x000030, "Wrong size on BP_UIIndividualParameterInitializeWaiter_C_Register");
...
static_assert(offsetof(BP_UIIndividualParameterInitializeWaiter_C_Register, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'BP_UIIndividualParameterInitializeWaiter_C_Register::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_UIIndividualParameterInitializeWaiter_C_Register, K2Node_CreateDelegate_OutputDelegate_1) == 0x000018, "Member 'BP_UIIndividualParameterInitializeWaiter_C_Register::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_UIIndividualParameterInitializeWaiter_C_Register, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000028, "Member 'BP_UIIndividualParameterInitializeWaiter_C_Register::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
