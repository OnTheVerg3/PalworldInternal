...
static_assert(sizeof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy) == 0x000078, "Wrong size on BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy");
...
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_IsInArenaByCharacter_ReturnValue) == 0x000011, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_IsInArenaByCharacter_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_Not_PreBool_ReturnValue) == 0x000020, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_BooleanAND_ReturnValue) == 0x000039, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_FindNearestAttackTarget_ReturnValue) == 0x000040, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_FindNearestAttackTarget_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_FindClosestActorToReticle_ReturnValue) == 0x000048, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_FindClosestActorToReticle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_IsValid_ReturnValue) == 0x000050, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetController_ReturnValue) == 0x000058, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetController_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_K2_GetPawn_ReturnValue) == 0x000060, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_GetTrainerPlayer_ReturnValue) == 0x000068, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_GetTrainerPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy, CallFunc_IsValid_ReturnValue_1) == 0x000070, "Member 'BP_AIAction_OtomoDefault_C_FindTrainerBattleEnemy::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
