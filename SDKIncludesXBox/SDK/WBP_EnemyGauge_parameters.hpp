...
static_assert(alignof(WBP_EnemyGauge_C_Change_Enemy_Mode) == 0x000004, "Wrong alignment on WBP_EnemyGauge_C_Change_Enemy_Mode");
static_assert(sizeof(WBP_EnemyGauge_C_Change_Enemy_Mode) == 0x00002C, "Wrong size on WBP_EnemyGauge_C_Change_Enemy_Mode");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, IsNeutral) == 0x000000, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::IsNeutral' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, Temp_bool_Variable) == 0x000001, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, Temp_bool_Variable_1) == 0x000002, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, K2Node_Select_Default) == 0x000004, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, CallFunc_Conv_ColorToLinearColor_ReturnValue) == 0x000008, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::CallFunc_Conv_ColorToLinearColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, K2Node_Select_Default_1) == 0x000018, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Change_Enemy_Mode, CallFunc_Conv_ColorToLinearColor_ReturnValue_1) == 0x00001C, "Member 'WBP_EnemyGauge_C_Change_Enemy_Mode::CallFunc_Conv_ColorToLinearColor_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(WBP_EnemyGauge_C_ChangeFriendMode) == 0x000020, "Wrong size on WBP_EnemyGauge_C_ChangeFriendMode");
...
static_assert(offsetof(WBP_EnemyGauge_C_ChangeFriendMode, CallFunc_Conv_ColorToLinearColor_ReturnValue_1) == 0x000010, "Member 'WBP_EnemyGauge_C_ChangeFriendMode::CallFunc_Conv_ColorToLinearColor_ReturnValue_1' has a wrong offset!");
...
public:
	...
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetSaveParameter_ReturnValue;             // 0x0018(0x0320)(ConstParm)
...
static_assert(sizeof(WBP_EnemyGauge_C_Set_Enable_Talent_Detail) == 0x000348, "Wrong size on WBP_EnemyGauge_C_Set_Enable_Talent_Detail");
...
static_assert(offsetof(WBP_EnemyGauge_C_Set_Enable_Talent_Detail, CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue) == 0x000338, "Member 'WBP_EnemyGauge_C_Set_Enable_Talent_Detail::CallFunc_GetSaveParameterValue_Talent_Defense_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Set_Enable_Talent_Detail, CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue) == 0x00033C, "Member 'WBP_EnemyGauge_C_Set_Enable_Talent_Detail::CallFunc_GetSaveParameterValue_Talent_Shot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_EnemyGauge_C_Set_Enable_Talent_Detail, CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue) == 0x000340, "Member 'WBP_EnemyGauge_C_Set_Enable_Talent_Detail::CallFunc_GetSaveParameterValue_Talent_HP_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_EnemyGauge_C_Set_Level) == 0x000020, "Wrong size on WBP_EnemyGauge_C_Set_Level");
...
static_assert(alignof(WBP_EnemyGauge_C_SetForParts) == 0x000001, "Wrong alignment on WBP_EnemyGauge_C_SetForParts");
static_assert(sizeof(WBP_EnemyGauge_C_SetForParts) == 0x000001, "Wrong size on WBP_EnemyGauge_C_SetForParts");
static_assert(offsetof(WBP_EnemyGauge_C_SetForParts, IsParts_0) == 0x000000, "Member 'WBP_EnemyGauge_C_SetForParts::IsParts_0' has a wrong offset!");
