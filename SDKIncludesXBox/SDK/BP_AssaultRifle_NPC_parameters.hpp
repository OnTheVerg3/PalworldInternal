...
struct BP_AssaultRifle_NPC_C_OnShoot final
{
public:
...
static_assert(alignof(BP_AssaultRifle_NPC_C_OnShoot) == 0x000008, "Wrong alignment on BP_AssaultRifle_NPC_C_OnShoot");
static_assert(sizeof(BP_AssaultRifle_NPC_C_OnShoot) == 0x000008, "Wrong size on BP_AssaultRifle_NPC_C_OnShoot");
static_assert(offsetof(BP_AssaultRifle_NPC_C_OnShoot, BulletActor) == 0x000000, "Member 'BP_AssaultRifle_NPC_C_OnShoot::BulletActor' has a wrong offset!");
