...
static_assert(sizeof(CreateSessionAsyncFunction_CreateSessionAsyncFunction) == 0x0000A8, "Wrong size on CreateSessionAsyncFunction_CreateSessionAsyncFunction");
...
static_assert(offsetof(CreateSessionAsyncFunction_CreateSessionAsyncFunction, IsCrossPlay) == 0x000098, "Member 'CreateSessionAsyncFunction_CreateSessionAsyncFunction::IsCrossPlay' has a wrong offset!");
static_assert(offsetof(CreateSessionAsyncFunction_CreateSessionAsyncFunction, ReturnValue) == 0x0000A0, "Member 'CreateSessionAsyncFunction_CreateSessionAsyncFunction::ReturnValue' has a wrong offset!");
...
static_assert(alignof(PocketpairConnectServerFunction_ConnectServer) == 0x000008, "Wrong alignment on PocketpairConnectServerFunction_ConnectServer");
static_assert(sizeof(PocketpairConnectServerFunction_ConnectServer) == 0x000058, "Wrong size on PocketpairConnectServerFunction_ConnectServer");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, Target) == 0x000000, "Member 'PocketpairConnectServerFunction_ConnectServer::Target' has a wrong offset!");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, Address) == 0x000008, "Member 'PocketpairConnectServerFunction_ConnectServer::Address' has a wrong offset!");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, Port) == 0x000018, "Member 'PocketpairConnectServerFunction_ConnectServer::Port' has a wrong offset!");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, AdminPassword) == 0x000020, "Member 'PocketpairConnectServerFunction_ConnectServer::AdminPassword' has a wrong offset!");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, ServerPassword) == 0x000030, "Member 'PocketpairConnectServerFunction_ConnectServer::ServerPassword' has a wrong offset!");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, WorldGUID) == 0x000040, "Member 'PocketpairConnectServerFunction_ConnectServer::WorldGUID' has a wrong offset!");
static_assert(offsetof(PocketpairConnectServerFunction_ConnectServer, ReturnValue) == 0x000050, "Member 'PocketpairConnectServerFunction_ConnectServer::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GDKActivityAsyncFunction_GDKActivityAsyncFunction) == 0x000030, "Wrong size on GDKActivityAsyncFunction_GDKActivityAsyncFunction");
...
static_assert(offsetof(GDKActivityAsyncFunction_GDKActivityAsyncFunction, bPublicSession) == 0x000020, "Member 'GDKActivityAsyncFunction_GDKActivityAsyncFunction::bPublicSession' has a wrong offset!");
static_assert(offsetof(GDKActivityAsyncFunction_GDKActivityAsyncFunction, ReturnValue) == 0x000028, "Member 'GDKActivityAsyncFunction_GDKActivityAsyncFunction::ReturnValue' has a wrong offset!");
