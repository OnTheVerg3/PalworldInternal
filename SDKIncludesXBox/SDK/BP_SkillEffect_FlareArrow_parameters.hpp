...
// Package: BP_SkillEffect_FlareArrow
...
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_BndEvt__BP_SkillEffect_FlareArrow_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature, HitCount) == 0x000120, "Member 'BP_SkillEffect_FlareArrow_C_BndEvt__BP_SkillEffect_FlareArrow_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature::HitCount' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_BndEvt__BP_SkillEffect_FlareArrow_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature, AttackerComponent) == 0x000128, "Member 'BP_SkillEffect_FlareArrow_C_BndEvt__BP_SkillEffect_FlareArrow_AttackFilter_K2Node_ComponentBoundEvent_1_OnAttackDelegate__DelegateSignature::AttackerComponent' has a wrong offset!");
...
public:
	...
	struct FPalDamageInfo                         K2Node_ComponentBoundEvent_damageInfo;             // 0x01F8(0x0118)()
	int32                                         K2Node_ComponentBoundEvent_hitCount;               // 0x0310(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_314[0x4];                                      // 0x0314(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_AttackerComponent;      // 0x0318(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	double                                        K2Node_Event_DeltaSecond;                          // 0x0320(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_IsClosed_Variable_3;                     // 0x0328(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_GetFloatValue_InTime_ImplicitCast_2;      // 0x034C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetVariableFloat_InValue_ImplicitCast_2;  // 0x0358(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow) == 0x000360, "Wrong size on BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow");
...
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, K2Node_ComponentBoundEvent_hitCount) == 0x000310, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::K2Node_ComponentBoundEvent_hitCount' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, K2Node_ComponentBoundEvent_AttackerComponent) == 0x000318, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::K2Node_ComponentBoundEvent_AttackerComponent' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, K2Node_Event_DeltaSecond) == 0x000320, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::K2Node_Event_DeltaSecond' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, Temp_bool_IsClosed_Variable_3) == 0x000328, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::Temp_bool_IsClosed_Variable_3' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_GetFloatValue_InTime_ImplicitCast) == 0x00032C, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_GetFloatValue_InTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000330, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_SetVariableFloat_InValue_ImplicitCast) == 0x000338, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_SetVariableFloat_InValue_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_GetFloatValue_InTime_ImplicitCast_1) == 0x00033C, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_GetFloatValue_InTime_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1) == 0x000340, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_SetVariableFloat_InValue_ImplicitCast_1) == 0x000348, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_SetVariableFloat_InValue_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_GetFloatValue_InTime_ImplicitCast_2) == 0x00034C, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_GetFloatValue_InTime_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_Multiply_DoubleDouble_A_ImplicitCast_2) == 0x000350, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_Multiply_DoubleDouble_A_ImplicitCast_2' has a wrong offset!");
static_assert(offsetof(BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow, CallFunc_SetVariableFloat_InValue_ImplicitCast_2) == 0x000358, "Member 'BP_SkillEffect_FlareArrow_C_ExecuteUbergraph_BP_SkillEffect_FlareArrow::CallFunc_SetVariableFloat_InValue_ImplicitCast_2' has a wrong offset!");
