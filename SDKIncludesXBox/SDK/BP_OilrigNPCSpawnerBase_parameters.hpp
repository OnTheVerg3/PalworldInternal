...
static_assert(sizeof(BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision) == 0x000140, "Wrong size on BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision");
...
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000008, "Member 'BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision, CallFunc_Add_VectorVector_ReturnValue) == 0x000020, "Member 'BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision, CallFunc_Add_VectorVector_ReturnValue_1) == 0x000038, "Member 'BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision, CallFunc_LineTraceSingleByPalTraceType_HitResult) == 0x000050, "Member 'BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision::CallFunc_LineTraceSingleByPalTraceType_HitResult' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision, CallFunc_LineTraceSingleByPalTraceType_ReturnValue) == 0x000138, "Member 'BP_OilrigNPCSpawnerBase_C_ExistSpawnableCollision::CallFunc_LineTraceSingleByPalTraceType_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_OilrigNPCSpawnerBase_C_Spawn) == 0x000428, "Wrong size on BP_OilrigNPCSpawnerBase_C_Spawn");
...
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_GetInitializedCharacterSaveParemter_outParameter) == 0x0000F8, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_GetInitializedCharacterSaveParemter_outParameter' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_GetInitializedCharacterSaveParemter_ReturnValue) == 0x000418, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_GetInitializedCharacterSaveParemter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OilrigNPCSpawnerBase_C_Spawn, CallFunc_SpawnNewCharacter_ReturnValue) == 0x000420, "Member 'BP_OilrigNPCSpawnerBase_C_Spawn::CallFunc_SpawnNewCharacter_ReturnValue' has a wrong offset!");
