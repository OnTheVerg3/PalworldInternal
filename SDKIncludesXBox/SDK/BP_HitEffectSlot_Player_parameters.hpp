...
public:
	...
	struct FPalDamageInfo                         K2Node_Event_info;                                 // 0x0038(0x0118)(ConstParm)
	TSoftObjectPtr<class UNiagaraSystem>          K2Node_CustomEvent_EffectPath;                     // 0x0150(0x0030)(HasGetValueTypeHash)
	struct FTransform                             K2Node_CustomEvent_Transform;                      // 0x0180(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APalCharacter*                          CallFunc_FindOwnerPalCharacter_ReturnValue;        // 0x0230(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player) == 0x000250, "Wrong size on BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player");
...
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, K2Node_CustomEvent_EffectPath) == 0x000150, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::K2Node_CustomEvent_EffectPath' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, K2Node_CustomEvent_Transform) == 0x000180, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::K2Node_CustomEvent_Transform' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_BreakTransform_Location) == 0x0001E0, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_BreakTransform_Rotation) == 0x0001F8, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_BreakTransform_Scale) == 0x000210, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000228, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, K2Node_SwitchEnum_CmpSuccess) == 0x000229, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x00022A, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_Array_AddUnique_ReturnValue) == 0x00022C, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_Array_AddUnique_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x000230, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_GetMainMesh_ReturnValue) == 0x000238, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player, CallFunc_SpawnSystemAttached_ReturnValue) == 0x000240, "Member 'BP_HitEffectSlot_Player_C_ExecuteUbergraph_BP_HitEffectSlot_Player::CallFunc_SpawnSystemAttached_ReturnValue' has a wrong offset!");
...
{
public:
	struct FPalDamageInfo                         Info;                                              // 0x0000(0x0118)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
static_assert(sizeof(BP_HitEffectSlot_Player_C_PlayHitEffect) == 0x000118, "Wrong size on BP_HitEffectSlot_Player_C_PlayHitEffect");
...
static_assert(alignof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far) == 0x000010, "Wrong alignment on BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far");
static_assert(sizeof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far) == 0x0001F0, "Wrong size on BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, Element) == 0x000000, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::Element' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, Location) == 0x000008, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::Location' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, EffectScale) == 0x000020, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::EffectScale' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, IsPoison) == 0x000028, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::IsPoison' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, OverrideEffect) == 0x000030, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::OverrideEffect' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, EffectScale_0) == 0x000060, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::EffectScale_0' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, EffectPath) == 0x000068, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::EffectPath' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_IsValidSoftObjectReference_ReturnValue) == 0x000098, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_IsValidSoftObjectReference_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, K2Node_SwitchEnum_CmpSuccess) == 0x000099, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x0000A0, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_K2_GetActorLocation_ReturnValue) == 0x0000A8, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_X) == 0x0000C0, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_Y) == 0x0000C8, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_Z) == 0x0000D0, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_Add_DoubleDouble_ReturnValue) == 0x0000D8, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_FindOwnerPalCharacter_ReturnValue_1) == 0x0000E0, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_FindOwnerPalCharacter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_GetMainMesh_ReturnValue) == 0x0000E8, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_Conv_FloatToVector_ReturnValue) == 0x0000F0, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_Conv_FloatToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_GetSocketLocation_ReturnValue) == 0x000108, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_GetSocketLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_X_1) == 0x000120, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_X_1' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_Y_1) == 0x000128, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_Y_1' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_Z_1) == 0x000130, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_Z_1' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_X_2) == 0x000138, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_X_2' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_Y_2) == 0x000140, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_Y_2' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_BreakVector_Z_2) == 0x000148, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_BreakVector_Z_2' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_Less_DoubleDouble_ReturnValue) == 0x000150, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_SelectFloat_ReturnValue) == 0x000158, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_MakeVector_ReturnValue) == 0x000160, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_MakeTransform_ReturnValue) == 0x000180, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_Add_DoubleDouble_A_ImplicitCast) == 0x0001E0, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_Add_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far, CallFunc_Conv_FloatToVector_InFloat_ImplicitCast) == 0x0001E8, "Member 'BP_HitEffectSlot_Player_C_Spawn_Elemental_Hit_Effect_Far::CallFunc_Conv_FloatToVector_InFloat_ImplicitCast' has a wrong offset!");
