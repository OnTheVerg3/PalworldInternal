...
static_assert(sizeof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher) == 0x000060, "Wrong size on BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher");
...
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_DeltaSeconds) == 0x000014, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_DeltaSeconds' has a wrong offset!");
...
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_InReloadSpeedPlayRate) == 0x00001C, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_InReloadSpeedPlayRate' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue) == 0x000020, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_detachActor) == 0x000028, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_detachActor' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue_1) == 0x000030, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_attachActor) == 0x000038, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_attachActor' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_IsEmptyMagazine_ReturnValue) == 0x000040, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_IsEmptyMagazine_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_IsEmptyMagazine_ReturnValue_1) == 0x000041, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_IsEmptyMagazine_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue_2) == 0x000042, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_Event_Notify) == 0x000043, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_Event_Notify' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, K2Node_SwitchEnum_CmpSuccess) == 0x000044, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_GetOwnerCharacter_ReturnValue) == 0x000048, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_GetOwnerCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_GetMainMesh_ReturnValue) == 0x000050, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher, CallFunc_K2_AttachToComponent_ReturnValue_3) == 0x000058, "Member 'BP_RocketLauncher_C_ExecuteUbergraph_BP_RocketLauncher::CallFunc_K2_AttachToComponent_ReturnValue_3' has a wrong offset!");
...
static_assert(alignof(BP_RocketLauncher_C_OnNotify) == 0x000001, "Wrong alignment on BP_RocketLauncher_C_OnNotify");
static_assert(sizeof(BP_RocketLauncher_C_OnNotify) == 0x000001, "Wrong size on BP_RocketLauncher_C_OnNotify");
static_assert(offsetof(BP_RocketLauncher_C_OnNotify, Notify) == 0x000000, "Member 'BP_RocketLauncher_C_OnNotify::Notify' has a wrong offset!");
...
static_assert(alignof(BP_RocketLauncher_C_OnReloadStart) == 0x000004, "Wrong alignment on BP_RocketLauncher_C_OnReloadStart");
static_assert(sizeof(BP_RocketLauncher_C_OnReloadStart) == 0x000004, "Wrong size on BP_RocketLauncher_C_OnReloadStart");
static_assert(offsetof(BP_RocketLauncher_C_OnReloadStart, InReloadSpeedPlayRate) == 0x000000, "Member 'BP_RocketLauncher_C_OnReloadStart::InReloadSpeedPlayRate' has a wrong offset!");
