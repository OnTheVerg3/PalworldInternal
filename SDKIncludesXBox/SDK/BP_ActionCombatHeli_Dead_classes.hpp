...
static_assert(sizeof(UBP_ActionCombatHeli_Dead_C) == 0x000170, "Wrong size on UBP_ActionCombatHeli_Dead_C");
static_assert(offsetof(UBP_ActionCombatHeli_Dead_C, UberGraphFrame) == 0x000160, "Member 'UBP_ActionCombatHeli_Dead_C::UberGraphFrame' has a wrong offset!");
