...
static_assert(alignof(WBP_DungeonInfo_C_OnReadyStageModel) == 0x000008, "Wrong alignment on WBP_DungeonInfo_C_OnReadyStageModel");
static_assert(sizeof(WBP_DungeonInfo_C_OnReadyStageModel) == 0x000010, "Wrong size on WBP_DungeonInfo_C_OnReadyStageModel");
static_assert(offsetof(WBP_DungeonInfo_C_OnReadyStageModel, SelfEntrance) == 0x000000, "Member 'WBP_DungeonInfo_C_OnReadyStageModel::SelfEntrance' has a wrong offset!");
static_assert(offsetof(WBP_DungeonInfo_C_OnReadyStageModel, CallFunc_GetStageModel_ReturnValue) == 0x000008, "Member 'WBP_DungeonInfo_C_OnReadyStageModel::CallFunc_GetStageModel_ReturnValue' has a wrong offset!");
...
static_assert(alignof(WBP_DungeonInfo_C_SetupByDungeonEntrance) == 0x000008, "Wrong alignment on WBP_DungeonInfo_C_SetupByDungeonEntrance");
static_assert(sizeof(WBP_DungeonInfo_C_SetupByDungeonEntrance) == 0x000030, "Wrong size on WBP_DungeonInfo_C_SetupByDungeonEntrance");
static_assert(offsetof(WBP_DungeonInfo_C_SetupByDungeonEntrance, Entrance) == 0x000000, "Member 'WBP_DungeonInfo_C_SetupByDungeonEntrance::Entrance' has a wrong offset!");
static_assert(offsetof(WBP_DungeonInfo_C_SetupByDungeonEntrance, StageModel) == 0x000008, "Member 'WBP_DungeonInfo_C_SetupByDungeonEntrance::StageModel' has a wrong offset!");
static_assert(offsetof(WBP_DungeonInfo_C_SetupByDungeonEntrance, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_DungeonInfo_C_SetupByDungeonEntrance::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_DungeonInfo_C_SetupByDungeonEntrance, CallFunc_GetStageModel_ReturnValue) == 0x000018, "Member 'WBP_DungeonInfo_C_SetupByDungeonEntrance::CallFunc_GetStageModel_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_DungeonInfo_C_SetupByDungeonEntrance, K2Node_CreateDelegate_OutputDelegate) == 0x000020, "Member 'WBP_DungeonInfo_C_SetupByDungeonEntrance::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
