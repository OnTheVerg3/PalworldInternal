...
static_assert(sizeof(UBP_PalCryComponent_C) == 0x0001B0, "Wrong size on UBP_PalCryComponent_C");
...
static_assert(offsetof(UBP_PalCryComponent_C, DisableCrying) == 0x0001A2, "Member 'UBP_PalCryComponent_C::DisableCrying' has a wrong offset!");
static_assert(offsetof(UBP_PalCryComponent_C, CryNPCId) == 0x0001A4, "Member 'UBP_PalCryComponent_C::CryNPCId' has a wrong offset!");
