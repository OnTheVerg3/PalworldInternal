...
static_assert(sizeof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox) == 0x000058, "Wrong size on BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox");
...
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, K2Node_CreateDelegate_OutputDelegate_1) == 0x000014, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, CallFunc_HasAuthority_ReturnValue) == 0x000024, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, CallFunc_IsValid_ReturnValue) == 0x000025, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, CallFunc_IsValid_ReturnValue_1) == 0x000040, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, K2Node_DynamicCast_AsBP_Treasure_Box_Visual_Base_1) == 0x000048, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::K2Node_DynamicCast_AsBP_Treasure_Box_Visual_Base_1' has a wrong offset!");
static_assert(offsetof(BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox, K2Node_DynamicCast_bSuccess_1) == 0x000050, "Member 'BP_MapObject_TreasureBox_C_ExecuteUbergraph_BP_MapObject_TreasureBox::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
