...
static_assert(sizeof(UWBP_PalCommonButtonBase_C) == 0x001540, "Wrong size on UWBP_PalCommonButtonBase_C");
...
static_assert(offsetof(UWBP_PalCommonButtonBase_C, OnButtonPressed) == 0x001518, "Member 'UWBP_PalCommonButtonBase_C::OnButtonPressed' has a wrong offset!");
static_assert(offsetof(UWBP_PalCommonButtonBase_C, OnButtonReleased) == 0x001528, "Member 'UWBP_PalCommonButtonBase_C::OnButtonReleased' has a wrong offset!");
