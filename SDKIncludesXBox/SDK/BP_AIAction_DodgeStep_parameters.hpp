...
static_assert(sizeof(BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep) == 0x000140, "Wrong size on BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep");
...
static_assert(offsetof(BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep, CallFunc_GetStepType_NewParam) == 0x000120, "Member 'BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep::CallFunc_GetStepType_NewParam' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep, CallFunc_PlayActionByTypeParameter_ReturnValue) == 0x000128, "Member 'BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep::CallFunc_PlayActionByTypeParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep, CallFunc_GetStepTime_StepTime) == 0x000130, "Member 'BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep::CallFunc_GetStepTime_StepTime' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep, CallFunc_Delay_Duration_ImplicitCast) == 0x000138, "Member 'BP_AIAction_DodgeStep_C_ExecuteUbergraph_BP_AIAction_DodgeStep::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(BP_AIAction_DodgeStep_C_RotateToAttacker) == 0x000088, "Wrong size on BP_AIAction_DodgeStep_C_RotateToAttacker");
...
static_assert(offsetof(BP_AIAction_DodgeStep_C_RotateToAttacker, CallFunc_BreakRotator_Roll) == 0x000058, "Member 'BP_AIAction_DodgeStep_C_RotateToAttacker::CallFunc_BreakRotator_Roll' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_RotateToAttacker, CallFunc_BreakRotator_Pitch) == 0x00005C, "Member 'BP_AIAction_DodgeStep_C_RotateToAttacker::CallFunc_BreakRotator_Pitch' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_RotateToAttacker, CallFunc_BreakRotator_Yaw) == 0x000060, "Member 'BP_AIAction_DodgeStep_C_RotateToAttacker::CallFunc_BreakRotator_Yaw' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_RotateToAttacker, CallFunc_MakeRotator_ReturnValue) == 0x000068, "Member 'BP_AIAction_DodgeStep_C_RotateToAttacker::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_DodgeStep_C_RotateToAttacker, CallFunc_K2_SetActorRotation_ReturnValue) == 0x000080, "Member 'BP_AIAction_DodgeStep_C_RotateToAttacker::CallFunc_K2_SetActorRotation_ReturnValue' has a wrong offset!");
