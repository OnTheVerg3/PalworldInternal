...
static_assert(sizeof(UWBP_GuildMemberMenuList_C) == 0x0002B8, "Wrong size on UWBP_GuildMemberMenuList_C");
...
static_assert(offsetof(UWBP_GuildMemberMenuList_C, Text_Title) == 0x000298, "Member 'UWBP_GuildMemberMenuList_C::Text_Title' has a wrong offset!");
static_assert(offsetof(UWBP_GuildMemberMenuList_C, WBP_PalInvisibleButton) == 0x0002A0, "Member 'UWBP_GuildMemberMenuList_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_GuildMemberMenuList_C, OnClicked) == 0x0002A8, "Member 'UWBP_GuildMemberMenuList_C::OnClicked' has a wrong offset!");
