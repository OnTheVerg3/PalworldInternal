...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_WBP_CompassIcon_ForPal_C;           // 0x0468(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UWBP_CompassIcon_ForPal_C) == 0x000470, "Wrong size on UWBP_CompassIcon_ForPal_C");
static_assert(offsetof(UWBP_CompassIcon_ForPal_C, UberGraphFrame_WBP_CompassIcon_ForPal_C) == 0x000468, "Member 'UWBP_CompassIcon_ForPal_C::UberGraphFrame_WBP_CompassIcon_ForPal_C' has a wrong offset!");
