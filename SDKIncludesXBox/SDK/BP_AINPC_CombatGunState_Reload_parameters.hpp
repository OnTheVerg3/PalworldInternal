...
static_assert(sizeof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload) == 0x000190, "Wrong size on BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload");
...
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_GetControllerRef_NPCAICon_1) == 0x000150, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_GetControllerRef_NPCAICon_1' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_PlayActionParameter_ReturnValue) == 0x000158, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_PlayActionParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_GetWeaponHandle_WeaponHandle_1) == 0x000160, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_GetWeaponHandle_WeaponHandle_1' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_GetTargetActor_TargetActor) == 0x000168, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_GetTargetActor_TargetActor' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_GetControllerRef_NPCAICon_2) == 0x000170, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_GetControllerRef_NPCAICon_2' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_GetWeaponHandle_WeaponHandle_2) == 0x000178, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_GetWeaponHandle_WeaponHandle_2' has a wrong offset!");
static_assert(offsetof(BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload, CallFunc_MakeVector_X_ImplicitCast) == 0x000180, "Member 'BP_AINPC_CombatGunState_Reload_C_ExecuteUbergraph_BP_AINPC_CombatGunState_Reload::CallFunc_MakeVector_X_ImplicitCast' has a wrong offset!");
