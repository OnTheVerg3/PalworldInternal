...
public:
	...
	class UWBP_MapMarker_Content_C*               WBP_MapMarker_Content_15;                          // 0x0310(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UWBP_MapMarker_Content_C*>       Markers;                                           // 0x0318(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	class UWBP_Map_IconCustom_C*                  CurrentEdittingIcon;                               // 0x0328(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TMulticastInlineDelegate<void(class UWBP_Map_IconCustom_C* Icon)> RemoveCustomIcon;              // 0x0330(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TArray<class UTexture2D*>                     Textures;                                          // 0x0340(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMulticastInlineDelegate<void(class UWBP_Map_IconCustom_C* Icon, int32 Index)> ChangeCustomIcon; // 0x0350(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	int32                                         CurrentIndex;                                      // 0x0360(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_MapMarker_Win_C) == 0x000368, "Wrong size on UWBP_MapMarker_Win_C");
...
static_assert(offsetof(UWBP_MapMarker_Win_C, WBP_MapMarker_Content_15) == 0x000310, "Member 'UWBP_MapMarker_Win_C::WBP_MapMarker_Content_15' has a wrong offset!");
static_assert(offsetof(UWBP_MapMarker_Win_C, Markers) == 0x000318, "Member 'UWBP_MapMarker_Win_C::Markers' has a wrong offset!");
static_assert(offsetof(UWBP_MapMarker_Win_C, CurrentEdittingIcon) == 0x000328, "Member 'UWBP_MapMarker_Win_C::CurrentEdittingIcon' has a wrong offset!");
static_assert(offsetof(UWBP_MapMarker_Win_C, RemoveCustomIcon) == 0x000330, "Member 'UWBP_MapMarker_Win_C::RemoveCustomIcon' has a wrong offset!");
static_assert(offsetof(UWBP_MapMarker_Win_C, Textures) == 0x000340, "Member 'UWBP_MapMarker_Win_C::Textures' has a wrong offset!");
static_assert(offsetof(UWBP_MapMarker_Win_C, ChangeCustomIcon) == 0x000350, "Member 'UWBP_MapMarker_Win_C::ChangeCustomIcon' has a wrong offset!");
static_assert(offsetof(UWBP_MapMarker_Win_C, CurrentIndex) == 0x000360, "Member 'UWBP_MapMarker_Win_C::CurrentIndex' has a wrong offset!");
