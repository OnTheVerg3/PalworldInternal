...
public:
	...
	TMap<struct FGuid, class UPalLocationBase*>   CallFunc_GetLocationMap_ReturnValue;               // 0x0060(0x0050)(ConstParm)
	...
	TDelegate<void(const struct FGuid& LocationId, class UPalLocationBase* Location)> K2Node_CreateDelegate_OutputDelegate; // 0x00EC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FGuid& LocationId, class UPalLocationBase* Location)> K2Node_CreateDelegate_OutputDelegate_1; // 0x00FC(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	bool                                          CallFunc_IsDistanceXY_ReturnValue;                 // 0x0099(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldDisplay_ReturnValue;                // 0x009A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_Ingame_Compass_C_GetVisibleIcons, CallFunc_IsDistanceXY_ReturnValue) == 0x000099, "Member 'WBP_Ingame_Compass_C_GetVisibleIcons::CallFunc_IsDistanceXY_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_GetVisibleIcons, CallFunc_ShouldDisplay_ReturnValue) == 0x00009A, "Member 'WBP_Ingame_Compass_C_GetVisibleIcons::CallFunc_ShouldDisplay_ReturnValue' has a wrong offset!");
...
public:
	...
	TMap<struct FGuid, class UPalLocationBase*>   CallFunc_GetLocationMap_ReturnValue;               // 0x02C0(0x0050)(ConstParm)
...
static_assert(offsetof(WBP_Ingame_Compass_C_Refresh_Death_Mark, CallFunc_IsDistanceXY_ReturnValue) == 0x00009C, "Member 'WBP_Ingame_Compass_C_Refresh_Death_Mark::CallFunc_IsDistanceXY_ReturnValue' has a wrong offset!");
...
public:
	...
	TDelegate<void(const struct FGuid& MarkerId)> K2Node_CreateDelegate_OutputDelegate;              // 0x00B8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	struct FGuid                                  CallFunc_Array_Get_Item;                           // 0x0018(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Get_Offset_Value_offSetValue;             // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_CompassIconBase_C*                 CallFunc_Map_Find_Value_1;                         // 0x01D0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Get_Offset_Value_offSetValue_1;           // 0x01E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_IngameCompass_DeathMark_C*         CallFunc_Array_Get_Item_2;                         // 0x0208(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Get_Offset_Value_offSetValue_2;           // 0x0218(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_UpdateVisibility_InDistance;              // 0x0228(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_229[0x7];                                      // 0x0229(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue_2;               // 0x0230(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalLocationManager*                    CallFunc_GetLocationManager_ReturnValue;           // 0x0240(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalLocationPoint*                      CallFunc_GetLocationPoint_ReturnValue;             // 0x0248(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldDisplay_ReturnValue;                // 0x0250(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_251[0x7];                                      // 0x0251(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                CallFunc_GetLocation_ReturnValue;                  // 0x0258(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsDistanceXY_ReturnValue;                 // 0x0270(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Ingame_Compass_C_Update_Icon) == 0x000278, "Wrong size on WBP_Ingame_Compass_C_Update_Icon");
...
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Array_Get_Item) == 0x000018, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Array_Length_ReturnValue) == 0x000028, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Add_IntInt_ReturnValue_1) == 0x00002C, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, Temp_int_Loop_Counter_Variable_2) == 0x00003C, "Member 'WBP_Ingame_Compass_C_Update_Icon::Temp_int_Loop_Counter_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Less_IntInt_ReturnValue) == 0x000040, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Add_IntInt_ReturnValue_2) == 0x000044, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Get_Offset_Value_offSetValue) == 0x000048, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Get_Offset_Value_offSetValue' has a wrong offset!");
...
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Array_Get_Item_1) == 0x000058, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_MakeVector2D_ReturnValue) == 0x000068, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Conv_GuidToString_ReturnValue) == 0x000078, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Conv_GuidToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Conv_StringToText_ReturnValue) == 0x000088, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Conv_StringToText_ReturnValue_1) == 0x0000A0, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, K2Node_MakeStruct_FormatArgumentData_1) == 0x000108, "Member 'WBP_Ingame_Compass_C_Update_Icon::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, K2Node_MakeArray_Array) == 0x000158, "Member 'WBP_Ingame_Compass_C_Update_Icon::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, K2Node_MakeArray_Array_1) == 0x000168, "Member 'WBP_Ingame_Compass_C_Update_Icon::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Format_ReturnValue) == 0x000178, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Format_ReturnValue_1) == 0x000190, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Conv_TextToString_ReturnValue_1) == 0x0001B8, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Conv_TextToString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Array_Length_ReturnValue_1) == 0x0001C8, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Less_IntInt_ReturnValue_1) == 0x0001CC, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Map_Find_Value_1) == 0x0001D0, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Map_Find_ReturnValue_1) == 0x0001D8, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Get_Offset_Value_offSetValue_1) == 0x0001E0, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Get_Offset_Value_offSetValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_IsVisible_ReturnValue) == 0x0001E8, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_IsVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x0001F0, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_MakeVector2D_ReturnValue_1) == 0x0001F8, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_MakeVector2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Array_Get_Item_2) == 0x000208, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Array_Length_ReturnValue_2) == 0x000210, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Less_IntInt_ReturnValue_2) == 0x000214, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Get_Offset_Value_offSetValue_2) == 0x000218, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Get_Offset_Value_offSetValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_Multiply_DoubleDouble_ReturnValue_2) == 0x000220, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_Multiply_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_UpdateVisibility_InDistance) == 0x000228, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_UpdateVisibility_InDistance' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_MakeVector2D_ReturnValue_2) == 0x000230, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_MakeVector2D_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_GetLocationManager_ReturnValue) == 0x000240, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_GetLocationManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_GetLocationPoint_ReturnValue) == 0x000248, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_GetLocationPoint_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_ShouldDisplay_ReturnValue) == 0x000250, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_ShouldDisplay_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_GetLocation_ReturnValue) == 0x000258, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_GetLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_IsDistanceXY_ReturnValue) == 0x000270, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_IsDistanceXY_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Ingame_Compass_C_Update_Icon, CallFunc_IsValid_ReturnValue) == 0x000271, "Member 'WBP_Ingame_Compass_C_Update_Icon::CallFunc_IsValid_ReturnValue' has a wrong offset!");
