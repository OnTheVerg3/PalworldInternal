...
static_assert(sizeof(ABP_ExplosionAttackBase_C) == 0x000300, "Wrong size on ABP_ExplosionAttackBase_C");
...
static_assert(offsetof(ABP_ExplosionAttackBase_C, PvPRate) == 0x0002E8, "Member 'ABP_ExplosionAttackBase_C::PvPRate' has a wrong offset!");
static_assert(offsetof(ABP_ExplosionAttackBase_C, MuteSoundForAI) == 0x0002F0, "Member 'ABP_ExplosionAttackBase_C::MuteSoundForAI' has a wrong offset!");
static_assert(offsetof(ABP_ExplosionAttackBase_C, OwnerStaticItemId) == 0x0002F4, "Member 'ABP_ExplosionAttackBase_C::OwnerStaticItemId' has a wrong offset!");
