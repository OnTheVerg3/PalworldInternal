...
static_assert(offsetof(WBP_PLLvExp_C_UpdateLevel, CallFunc_IsValid_ReturnValue) == 0x000018, "Member 'WBP_PLLvExp_C_UpdateLevel::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateLevel, CallFunc_GetLevel_ReturnValue) == 0x00001C, "Member 'WBP_PLLvExp_C_UpdateLevel::CallFunc_GetLevel_ReturnValue' has a wrong offset!");
