...
static_assert(offsetof(WBP_Paldex_ForDisplay_C_Setup, CallFunc_GetThreadSafeInt32_ReturnValue) == 0x000018, "Member 'WBP_Paldex_ForDisplay_C_Setup::CallFunc_GetThreadSafeInt32_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_ForDisplay_C_Setup, Temp_int_Loop_Counter_Variable) == 0x000020, "Member 'WBP_Paldex_ForDisplay_C_Setup::Temp_int_Loop_Counter_Variable' has a wrong offset!");
...
static_assert(offsetof(WBP_Paldex_ForDisplay_C_Setup, CallFunc_Add_IntInt_ReturnValue) == 0x000028, "Member 'WBP_Paldex_ForDisplay_C_Setup::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Paldex_ForDisplay_C_Setup, CallFunc_Add_IntInt_ReturnValue_1) == 0x00002C, "Member 'WBP_Paldex_ForDisplay_C_Setup::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
