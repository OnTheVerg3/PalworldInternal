...
public:
	...
	TDelegate<void(const struct FPalPickingGameSettingData& NewSettingData)> K2Node_CreateDelegate_OutputDelegate_5; // 0x0050(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TDelegate<void(const struct FPalPickingGameSettingData& NewSettingData)> K2Node_CreateDelegate_OutputDelegate_5; // 0x006C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
