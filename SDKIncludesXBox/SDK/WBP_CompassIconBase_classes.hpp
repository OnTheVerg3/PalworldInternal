...
public:
	...
	bool                                          bDistanceXY;                                       // 0x0448(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UWBP_CompassIconBase_C) == 0x000450, "Wrong size on UWBP_CompassIconBase_C");
...
static_assert(offsetof(UWBP_CompassIconBase_C, bDistanceXY) == 0x000448, "Member 'UWBP_CompassIconBase_C::bDistanceXY' has a wrong offset!");
