...
static_assert(offsetof(BP_PalSphere_Body_C_CalculateCaptureRate, CaptureLevel_0) == 0x000000, "Member 'BP_PalSphere_Body_C_CalculateCaptureRate::CaptureLevel_0' has a wrong offset!");
...
public:
	...
	class UPalVisualEffectBase*                   CallFunc_AddVisualEffectForActor_Local_ReturnValue_1; // 0x0238(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UNiagaraComponent*                      CallFunc_SpawnSystemAtLocation_ReturnValue_3;      // 0x04B8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector                                CallFunc_K2_GetActorLocation_ReturnValue_6;        // 0x04D8(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 CallFunc_GetOwnerCharacterOrRiderCharacter_Character; // 0x04F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class APalPlayerCharacter*                    K2Node_DynamicCast_AsPal_Player_Character;         // 0x04F8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FRotator                               CallFunc_GetCameraRotator_ReturnValue;             // 0x0508(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FVector                                CallFunc_GreaterGreater_VectorRotator_ReturnValue; // 0x0520(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_Multiply_VectorFloat_ReturnValue;         // 0x0538(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_TickMovement_HitedBall_DeltaTime_ImplicitCast; // 0x0580(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Judging_DeltaTime_ImplicitCast;           // 0x0588(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_TickMovement_MoveToSky_DeltaTime_ImplicitCast; // 0x0590(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast;              // 0x0598(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast_1;            // 0x059C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_Delay_Duration_ImplicitCast_2;            // 0x05A0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body) == 0x0005A8, "Wrong size on BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body");
...
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AddVisualEffectForActor_Local_ReturnValue) == 0x0000E8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AddVisualEffectForActor_Local_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AddVisualEffectForActor_Local_ReturnValue_1) == 0x000238, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AddVisualEffectForActor_Local_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_AddVisualEffectForActor_Local_ReturnValue_2) == 0x0003C0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_AddVisualEffectForActor_Local_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue_3) == 0x000488, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue_4) == 0x0004A0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_SpawnSystemAtLocation_ReturnValue_3) == 0x0004B8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_SpawnSystemAtLocation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue_5) == 0x0004C0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_K2_GetActorLocation_ReturnValue_6) == 0x0004D8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_K2_GetActorLocation_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetOwnerCharacterOrRiderCharacter_Character) == 0x0004F0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetOwnerCharacterOrRiderCharacter_Character' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_DynamicCast_AsPal_Player_Character) == 0x0004F8, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_DynamicCast_AsPal_Player_Character' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, K2Node_DynamicCast_bSuccess_1) == 0x000500, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GetCameraRotator_ReturnValue) == 0x000508, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GetCameraRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_GreaterGreater_VectorRotator_ReturnValue) == 0x000520, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_GreaterGreater_VectorRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Multiply_VectorFloat_ReturnValue) == 0x000538, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Multiply_VectorFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Add_VectorVector_ReturnValue) == 0x000550, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Add_VectorVector_ReturnValue_1) == 0x000568, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Add_VectorVector_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_TickMovement_HitedBall_DeltaTime_ImplicitCast) == 0x000580, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_TickMovement_HitedBall_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Judging_DeltaTime_ImplicitCast) == 0x000588, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Judging_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_TickMovement_MoveToSky_DeltaTime_ImplicitCast) == 0x000590, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_TickMovement_MoveToSky_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Delay_Duration_ImplicitCast) == 0x000598, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Delay_Duration_ImplicitCast_1) == 0x00059C, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Delay_Duration_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body, CallFunc_Delay_Duration_ImplicitCast_2) == 0x0005A0, "Member 'BP_PalSphere_Body_C_ExecuteUbergraph_BP_PalSphere_Body::CallFunc_Delay_Duration_ImplicitCast_2' has a wrong offset!");
...
static_assert(alignof(BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0) == 0x000008, "Wrong alignment on BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0");
static_assert(sizeof(BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0) == 0x000010, "Wrong size on BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0");
static_assert(offsetof(BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0, PhaseCount) == 0x000000, "Member 'BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0::PhaseCount' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0, targetHandle_0) == 0x000008, "Member 'BP_PalSphere_Body_C_OnPassingCapturePhase_イベント_0::targetHandle_0' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_GetCriticalCaptureLevel_NewParam;         // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetCriticalCaptureLevel_NewParam_1;       // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<double>                                CallFunc_CalculateCaptureRate_RateArray;           // 0x0020(0x0010)(ReferenceParm)
	bool                                          CallFunc_Array_Get_Item;                           // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AActor*                                 CallFunc_GetOwnerCharacterOrRiderCharacter_Character; // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalInstanceID                         CallFunc_GetIndividualIDByActor_ReturnValue;       // 0x0048(0x0030)(HasGetValueTypeHash)
	...
	class UPalIndividualCharacterHandle*          CallFunc_GetIndividualHandle_ReturnValue;          // 0x0080(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetCaptureLevel_level;                    // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<double>                                CallFunc_CalculateCaptureRate_RateArray_1;         // 0x0090(0x0010)(ReferenceParm)
	...
	TArray<bool>                                  CallFunc_JudgePalCapture_TryAllPhase_outJudgeFlagArray; // 0x00A8(0x0010)(ReferenceParm)
	bool                                          CallFunc_IsSkipFirstJudge_isSkip;                  // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_PalSphere_Body_C_SetupInServer) == 0x000008, "Wrong alignment on BP_PalSphere_Body_C_SetupInServer");
static_assert(sizeof(BP_PalSphere_Body_C_SetupInServer) == 0x0000C0, "Wrong size on BP_PalSphere_Body_C_SetupInServer");
...
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCriticalCaptureLevel_NewParam) == 0x000008, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCriticalCaptureLevel_NewParam' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_IsValid_ReturnValue) == 0x00000C, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCriticalCaptureLevel_NewParam_1) == 0x00001C, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCriticalCaptureLevel_NewParam_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_CalculateCaptureRate_RateArray) == 0x000020, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_CalculateCaptureRate_RateArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Array_Get_Item) == 0x000030, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_Array_Length_ReturnValue) == 0x000034, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000038, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetOwnerCharacterOrRiderCharacter_Character) == 0x000040, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetOwnerCharacterOrRiderCharacter_Character' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetIndividualIDByActor_ReturnValue) == 0x000048, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetIndividualIDByActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCharacterManager_ReturnValue) == 0x000078, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCharacterManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetIndividualHandle_ReturnValue) == 0x000080, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetIndividualHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_GetCaptureLevel_level) == 0x000088, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_GetCaptureLevel_level' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_CalculateCaptureRate_RateArray_1) == 0x000090, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_CalculateCaptureRate_RateArray_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_SelectInt_ReturnValue) == 0x0000A0, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_JudgePalCapture_TryAllPhase_outJudgeFlagArray) == 0x0000A8, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_JudgePalCapture_TryAllPhase_outJudgeFlagArray' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_Body_C_SetupInServer, CallFunc_IsSkipFirstJudge_isSkip) == 0x0000B8, "Member 'BP_PalSphere_Body_C_SetupInServer::CallFunc_IsSkipFirstJudge_isSkip' has a wrong offset!");
