...
static_assert(sizeof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged) == 0x000038, "Wrong size on BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, Sequencer) == 0x000000, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::Sequencer' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, PrevType) == 0x000008, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::PrevType' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, AfterType) == 0x000009, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::AfterType' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, ArenaNewState) == 0x00000A, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::ArenaNewState' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, CallFunc_MakeLiteralByte_ReturnValue) == 0x00000B, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::CallFunc_MakeLiteralByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, K2Node_SwitchEnum_CmpSuccess) == 0x00000C, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, CallFunc_MakeLiteralByte_ReturnValue_1) == 0x00000D, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::CallFunc_MakeLiteralByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, CallFunc_MakeLiteralByte_ReturnValue_2) == 0x00000E, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::CallFunc_MakeLiteralByte_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, CallFunc_Concat_StrStr_ReturnValue) == 0x000020, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged, CallFunc_MakeLiteralByte_ReturnValue_3) == 0x000030, "Member 'BP_PalAudioWorldSubsystem_C_OnArenaSequenceChanged::CallFunc_MakeLiteralByte_ReturnValue_3' has a wrong offset!");
