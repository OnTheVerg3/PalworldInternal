...
static_assert(sizeof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle) == 0x0000B0, "Wrong size on BP_OtomoPalHolderComponent_C_ActivatePalByHandle");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, OtomoHandle) == 0x000000, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::OtomoHandle' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, Location) == 0x000008, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::Location' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, Rotation) == 0x000020, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::Rotation' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, bKeepActigvateOtomoId) == 0x000038, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::bKeepActigvateOtomoId' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_MakeTransform_ReturnValue) == 0x000040, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_GetSlotIndexByIndividualHandle_ReturnValue) == 0x0000A0, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_GetSlotIndexByIndividualHandle_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_NotEqual_IntInt_ReturnValue) == 0x0000A4, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_ActivateOtomo_isSuccess) == 0x0000A5, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_ActivateOtomo_isSuccess' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_Not_PreBool_ReturnValue) == 0x0000A6, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_SelectInt_ReturnValue) == 0x0000A8, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ActivatePalByHandle, CallFunc_NotEqual_IntInt_ReturnValue_1) == 0x0000AC, "Member 'BP_OtomoPalHolderComponent_C_ActivatePalByHandle::CallFunc_NotEqual_IntInt_ReturnValue_1' has a wrong offset!");
...
public:
	...
	struct FPalOptionWorldSettings                CallFunc_GetOptionWorldSettings_ReturnValue;       // 0x00A0(0x01A0)(ConstParm)
	class UPalIndividualCharacterParameter*       CallFunc_TryGetIndividualParameter_ReturnValue;    // 0x0240(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_GetNickNameWithOnlineID_OutName_1;        // 0x0250(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FName                                   CallFunc_GetCharacterID_ReturnValue_1;             // 0x0260(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalLogManager*                         CallFunc_GetLogManager_ReturnValue;                // 0x0268(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalKillLogDisplayData                 K2Node_MakeStruct_PalKillLogDisplayData;           // 0x0270(0x0068)()
};
...
static_assert(sizeof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log) == 0x0002D8, "Wrong size on BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log");
...
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log, CallFunc_TryGetIndividualParameter_ReturnValue) == 0x000240, "Member 'BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log::CallFunc_TryGetIndividualParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log, CallFunc_IsValid_ReturnValue_3) == 0x000248, "Member 'BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log, CallFunc_GetNickNameWithOnlineID_OutName_1) == 0x000250, "Member 'BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log::CallFunc_GetNickNameWithOnlineID_OutName_1' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log, CallFunc_GetCharacterID_ReturnValue_1) == 0x000260, "Member 'BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log::CallFunc_GetCharacterID_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log, CallFunc_GetLogManager_ReturnValue) == 0x000268, "Member 'BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log::CallFunc_GetLogManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log, K2Node_MakeStruct_PalKillLogDisplayData) == 0x000270, "Member 'BP_OtomoPalHolderComponent_C_Add_Otomo_Down_Log::K2Node_MakeStruct_PalKillLogDisplayData' has a wrong offset!");
...
public:
	...
	struct FPalOptionWorldSettings                CallFunc_GetOptionWorldSettings_ReturnValue;       // 0x0460(0x01A0)(ConstParm)
	...
	TDelegate<void(int32 SlotIndex, class UPalIndividualCharacterHandle* LastHandle)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0604(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_614[0x4];                                      // 0x0614(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_Update_Reserve_Pal_Location_DeltaTime_ImplicitCast; // 0x0618(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent) == 0x000620, "Wrong size on BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent");
...
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent, CallFunc_EqualEqual_ObjectObject_ReturnValue_1) == 0x000600, "Member 'BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent::CallFunc_EqualEqual_ObjectObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent, K2Node_CreateDelegate_OutputDelegate_1) == 0x000604, "Member 'BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent, CallFunc_Update_Reserve_Pal_Location_DeltaTime_ImplicitCast) == 0x000618, "Member 'BP_OtomoPalHolderComponent_C_ExecuteUbergraph_BP_OtomoPalHolderComponent::CallFunc_Update_Reserve_Pal_Location_DeltaTime_ImplicitCast' has a wrong offset!");
