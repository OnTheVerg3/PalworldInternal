...
static_assert(sizeof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase) == 0x000128, "Wrong size on BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase");
...
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_Event_ControlledPawn_3) == 0x000008, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_Event_ControlledPawn_3' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_CreateDelegate_OutputDelegate) == 0x000014, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetController_ReturnValue_2) == 0x000070, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetController_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_K2_GetPawn_ReturnValue) == 0x000078, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetComponentByClass_ReturnValue_2) == 0x000080, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetComponentByClass_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_CreateDelegate_OutputDelegate_2) == 0x000090, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_DynamicCast_AsPal_AIController) == 0x0000A0, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_DynamicCast_AsPal_AIController' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_DynamicCast_bSuccess) == 0x0000A8, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetController_ReturnValue_4) == 0x0000B0, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetController_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetIsSquadBehaviour_ReturnValue) == 0x0000B8, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetIsSquadBehaviour_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_DynamicCast_AsPal_AIController_1) == 0x0000C0, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_DynamicCast_AsPal_AIController_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_DynamicCast_bSuccess_1) == 0x0000C8, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetIsSquadBehaviour_ReturnValue_1) == 0x0000C9, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetIsSquadBehaviour_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetSquad_ReturnValue) == 0x0000D0, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetSquad_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetSquad_ReturnValue_1) == 0x0000D8, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetSquad_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_IsValid_ReturnValue_1) == 0x0000E0, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_BooleanAND_ReturnValue) == 0x0000E1, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetController_ReturnValue_5) == 0x0000E8, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetController_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_Event_ControlledPawn_4) == 0x0000F0, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_Event_ControlledPawn_4' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_K2_GetPawn_ReturnValue_1) == 0x0000F8, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_K2_GetPawn_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_GetComponentByClass_ReturnValue_3) == 0x000100, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_GetComponentByClass_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, K2Node_Event_ControlledPawn) == 0x000118, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::K2Node_Event_ControlledPawn' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_IsValid_ReturnValue_2) == 0x000120, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase, CallFunc_IsValid_ReturnValue_3) == 0x000121, "Member 'BP_AIAction_CanCombatBase_C_ExecuteUbergraph_BP_AIAction_CanCombatBase::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
...
public:
	...
	TDelegate<void(const struct FPalDamageResult& DamageResult)> K2Node_CreateDelegate_OutputDelegate; // 0x0088(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalAISensorComponent*                  CallFunc_GetComponentByClass_ReturnValue_1;        // 0x00C8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class APalCharacter*                          CallFunc_SelectResponseBySenses_OutTargetCharacter; // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EPalAIResponseType                            CallFunc_SelectResponseBySenses_ReturnValue;       // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse) == 0x0000E0, "Wrong size on BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse");
...
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, K2Node_CreateDelegate_OutputDelegate) == 0x000088, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_IsValid_ReturnValue_1) == 0x000098, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_IsValid_ReturnValue_2) == 0x000099, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_Array_Add_ReturnValue) == 0x00009C, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_GetController_ReturnValue) == 0x0000A0, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_GetController_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_K2_GetPawn_ReturnValue) == 0x0000B0, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_K2_GetPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_Array_Add_ReturnValue_1) == 0x0000B8, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_Array_Add_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_GetController_ReturnValue_1) == 0x0000C0, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_GetController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_GetComponentByClass_ReturnValue_1) == 0x0000C8, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_GetComponentByClass_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_SelectResponseBySenses_OutTargetCharacter) == 0x0000D0, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_SelectResponseBySenses_OutTargetCharacter' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, CallFunc_SelectResponseBySenses_ReturnValue) == 0x0000D8, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::CallFunc_SelectResponseBySenses_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse, K2Node_SwitchEnum_CmpSuccess) == 0x0000D9, "Member 'BP_AIAction_CanCombatBase_C_Fun_Damage_AIResponse::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
