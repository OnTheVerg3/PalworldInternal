...
static_assert(sizeof(ABP_NPCCampPresetBase_C) == 0x0002C8, "Wrong size on ABP_NPCCampPresetBase_C");
...
static_assert(offsetof(ABP_NPCCampPresetBase_C, Debug_DisableRayAdjust) == 0x0002C0, "Member 'ABP_NPCCampPresetBase_C::Debug_DisableRayAdjust' has a wrong offset!");
