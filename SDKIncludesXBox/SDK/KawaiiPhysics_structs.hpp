...
static_assert(sizeof(FKawaiiPhysicsModifyBone) == 0x000100, "Wrong size on FKawaiiPhysicsModifyBone");
...
static_assert(offsetof(FKawaiiPhysicsModifyBone, LengthRateFromRoot) == 0x0000EC, "Member 'FKawaiiPhysicsModifyBone::LengthRateFromRoot' has a wrong offset!");
static_assert(offsetof(FKawaiiPhysicsModifyBone, bDummy) == 0x0000F0, "Member 'FKawaiiPhysicsModifyBone::bDummy' has a wrong offset!");
static_assert(offsetof(FKawaiiPhysicsModifyBone, bSkipSimulate) == 0x0000F1, "Member 'FKawaiiPhysicsModifyBone::bSkipSimulate' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_KawaiiPhysics) == 0x000840, "Wrong size on FAnimNode_KawaiiPhysics");
...
static_assert(offsetof(FAnimNode_KawaiiPhysics, TargetFrameRate) == 0x000118, "Member 'FAnimNode_KawaiiPhysics::TargetFrameRate' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, OverrideTargetFramerate) == 0x00011C, "Member 'FAnimNode_KawaiiPhysics::OverrideTargetFramerate' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, WarmUpFrames) == 0x000120, "Member 'FAnimNode_KawaiiPhysics::WarmUpFrames' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bUseWarmUpWhenResetDynamics) == 0x000124, "Member 'FAnimNode_KawaiiPhysics::bUseWarmUpWhenResetDynamics' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bNeedWarmUp) == 0x000125, "Member 'FAnimNode_KawaiiPhysics::bNeedWarmUp' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, TeleportDistanceThreshold) == 0x000128, "Member 'FAnimNode_KawaiiPhysics::TeleportDistanceThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, TeleportRotationThreshold) == 0x00012C, "Member 'FAnimNode_KawaiiPhysics::TeleportRotationThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, PlanarConstraint) == 0x000130, "Member 'FAnimNode_KawaiiPhysics::PlanarConstraint' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bUpdatePhysicsSettingsInGame) == 0x000131, "Member 'FAnimNode_KawaiiPhysics::bUpdatePhysicsSettingsInGame' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, ResetBoneTransformWhenBoneNotFound) == 0x000132, "Member 'FAnimNode_KawaiiPhysics::ResetBoneTransformWhenBoneNotFound' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_KawaiiPhysics, bAllowWorldCollision) == 0x0005B0, "Member 'FAnimNode_KawaiiPhysics::bAllowWorldCollision' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bOverrideCollisionParams) == 0x0005B1, "Member 'FAnimNode_KawaiiPhysics::bOverrideCollisionParams' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, CollisionChannelSettings) == 0x0005B8, "Member 'FAnimNode_KawaiiPhysics::CollisionChannelSettings' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bIgnoreSelfComponent) == 0x000748, "Member 'FAnimNode_KawaiiPhysics::bIgnoreSelfComponent' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, IgnoreBones) == 0x000750, "Member 'FAnimNode_KawaiiPhysics::IgnoreBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, IgnoreBoneNamePrefix) == 0x000760, "Member 'FAnimNode_KawaiiPhysics::IgnoreBoneNamePrefix' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, KawaiiPhysicsTag) == 0x000770, "Member 'FAnimNode_KawaiiPhysics::KawaiiPhysicsTag' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, ModifyBones) == 0x000778, "Member 'FAnimNode_KawaiiPhysics::ModifyBones' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, DeltaTime) == 0x000788, "Member 'FAnimNode_KawaiiPhysics::DeltaTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, PreSkelCompTransform) == 0x000790, "Member 'FAnimNode_KawaiiPhysics::PreSkelCompTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_KawaiiPhysics, bInitPhysicsSettings) == 0x0007F0, "Member 'FAnimNode_KawaiiPhysics::bInitPhysicsSettings' has a wrong offset!");
