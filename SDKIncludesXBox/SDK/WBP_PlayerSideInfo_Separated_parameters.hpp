...
static_assert(sizeof(WBP_PlayerSideInfo_Separated_C_OnTimer_CheckCaptureCount) == 0x000018, "Wrong size on WBP_PlayerSideInfo_Separated_C_OnTimer_CheckCaptureCount");
...
static_assert(offsetof(WBP_PlayerSideInfo_Separated_C_OnTimer_CheckCaptureCount, CallFunc_GetThreadSafeInt32_ReturnValue) == 0x00000C, "Member 'WBP_PlayerSideInfo_Separated_C_OnTimer_CheckCaptureCount::CallFunc_GetThreadSafeInt32_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PlayerSideInfo_Separated_C_OnTimer_CheckCaptureCount, CallFunc_Greater_IntInt_ReturnValue) == 0x000010, "Member 'WBP_PlayerSideInfo_Separated_C_OnTimer_CheckCaptureCount::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WBP_PlayerSideInfo_Separated_C_SetupFirstPalThrowGuide) == 0x000050, "Wrong size on WBP_PlayerSideInfo_Separated_C_SetupFirstPalThrowGuide");
...
static_assert(offsetof(WBP_PlayerSideInfo_Separated_C_SetupFirstPalThrowGuide, CallFunc_GetThreadSafeInt32_ReturnValue) == 0x000044, "Member 'WBP_PlayerSideInfo_Separated_C_SetupFirstPalThrowGuide::CallFunc_GetThreadSafeInt32_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PlayerSideInfo_Separated_C_SetupFirstPalThrowGuide, CallFunc_EqualEqual_IntInt_ReturnValue_1) == 0x000048, "Member 'WBP_PlayerSideInfo_Separated_C_SetupFirstPalThrowGuide::CallFunc_EqualEqual_IntInt_ReturnValue_1' has a wrong offset!");
