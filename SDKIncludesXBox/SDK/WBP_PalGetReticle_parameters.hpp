...
static_assert(sizeof(WBP_PalGetReticle_C_SetCaptureRateForce) == 0x000010, "Wrong size on WBP_PalGetReticle_C_SetCaptureRateForce");
...
static_assert(offsetof(WBP_PalGetReticle_C_SetCaptureRateForce, CallFunc_Less_DoubleDouble_ReturnValue) == 0x000008, "Member 'WBP_PalGetReticle_C_SetCaptureRateForce::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
