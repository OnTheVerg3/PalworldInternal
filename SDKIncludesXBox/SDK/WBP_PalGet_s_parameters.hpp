...
static_assert(sizeof(WBP_PalGet_s_C_SetupByCaptureInfo) == 0x000090, "Wrong size on WBP_PalGet_s_C_SetupByCaptureInfo");
...
static_assert(offsetof(WBP_PalGet_s_C_SetupByCaptureInfo, Temp_bool_Variable) == 0x000030, "Member 'WBP_PalGet_s_C_SetupByCaptureInfo::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_PalGet_s_C_SetupByCaptureInfo, CallFunc_GetDatabaseCharacterParameter_ReturnValue) == 0x000038, "Member 'WBP_PalGet_s_C_SetupByCaptureInfo::CallFunc_GetDatabaseCharacterParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalGet_s_C_SetupByCaptureInfo, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000040, "Member 'WBP_PalGet_s_C_SetupByCaptureInfo::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalGet_s_C_SetupByCaptureInfo, CallFunc_GetLocalizedUniqueNPCName_OutText) == 0x000048, "Member 'WBP_PalGet_s_C_SetupByCaptureInfo::CallFunc_GetLocalizedUniqueNPCName_OutText' has a wrong offset!");
static_assert(offsetof(WBP_PalGet_s_C_SetupByCaptureInfo, CallFunc_GetLocalizedCharacterName_OutText) == 0x000060, "Member 'WBP_PalGet_s_C_SetupByCaptureInfo::CallFunc_GetLocalizedCharacterName_OutText' has a wrong offset!");
static_assert(offsetof(WBP_PalGet_s_C_SetupByCaptureInfo, K2Node_Select_Default) == 0x000078, "Member 'WBP_PalGet_s_C_SetupByCaptureInfo::K2Node_Select_Default' has a wrong offset!");
