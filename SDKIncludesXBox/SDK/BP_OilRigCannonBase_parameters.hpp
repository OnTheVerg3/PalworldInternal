...
static_assert(sizeof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase) == 0x000088, "Wrong size on BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase");
...
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, CallFunc_BindOnTriggerInteract_self_CastInput) == 0x000028, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::CallFunc_BindOnTriggerInteract_self_CastInput' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, K2Node_CreateDelegate_OutputDelegate_1) == 0x000038, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, CallFunc_BindOnStartTriggerInteract_self_CastInput) == 0x000048, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::CallFunc_BindOnStartTriggerInteract_self_CastInput' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, K2Node_CreateDelegate_OutputDelegate_2) == 0x000058, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, CallFunc_BindOnEndTriggerInteract_self_CastInput) == 0x000068, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::CallFunc_BindOnEndTriggerInteract_self_CastInput' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, CallFunc_IsValid_ReturnValue_1) == 0x000078, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, K2Node_Event_DeltaSeconds) == 0x00007C, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase, CallFunc_IsDestroyedWeapon_ReturnValue) == 0x000080, "Member 'BP_OilRigCannonBase_C_ExecuteUbergraph_BP_OilRigCannonBase::CallFunc_IsDestroyedWeapon_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_OilRigCannonBase_C_Start_Animation) == 0x000140, "Wrong size on BP_OilRigCannonBase_C_Start_Animation");
...
static_assert(offsetof(BP_OilRigCannonBase_C_Start_Animation, CallFunc_PlayActionByTypeParameter_ReturnValue) == 0x000130, "Member 'BP_OilRigCannonBase_C_Start_Animation::CallFunc_PlayActionByTypeParameter_ReturnValue' has a wrong offset!");
