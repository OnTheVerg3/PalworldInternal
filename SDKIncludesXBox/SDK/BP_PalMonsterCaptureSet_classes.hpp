...
static_assert(sizeof(ABP_PalMonsterCaptureSet_C) == 0x000478, "Wrong size on ABP_PalMonsterCaptureSet_C");
...
static_assert(offsetof(ABP_PalMonsterCaptureSet_C, LoadingOriginalPalID) == 0x000418, "Member 'ABP_PalMonsterCaptureSet_C::LoadingOriginalPalID' has a wrong offset!");
static_assert(offsetof(ABP_PalMonsterCaptureSet_C, UniqueCaptureActorMap) == 0x000420, "Member 'ABP_PalMonsterCaptureSet_C::UniqueCaptureActorMap' has a wrong offset!");
static_assert(offsetof(ABP_PalMonsterCaptureSet_C, UniqueCaptureActor) == 0x000470, "Member 'ABP_PalMonsterCaptureSet_C::UniqueCaptureActor' has a wrong offset!");
