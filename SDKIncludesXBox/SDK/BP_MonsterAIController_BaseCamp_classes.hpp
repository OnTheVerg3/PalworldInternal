...
static_assert(sizeof(ABP_MonsterAIController_BaseCamp_C) == 0x000580, "Wrong size on ABP_MonsterAIController_BaseCamp_C");
static_assert(offsetof(ABP_MonsterAIController_BaseCamp_C, UberGraphFrame_BP_MonsterAIController_BaseCamp_C) == 0x000560, "Member 'ABP_MonsterAIController_BaseCamp_C::UberGraphFrame_BP_MonsterAIController_BaseCamp_C' has a wrong offset!");
static_assert(offsetof(ABP_MonsterAIController_BaseCamp_C, SpawnedPosition) == 0x000568, "Member 'ABP_MonsterAIController_BaseCamp_C::SpawnedPosition' has a wrong offset!");
