...
static_assert(alignof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed) == 0x000008, "Wrong alignment on WBP_PalNPCHPGauge_C_On_UISettinga_Changed");
static_assert(sizeof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed) == 0x000098, "Wrong size on WBP_PalNPCHPGauge_C_On_UISettinga_Changed");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, PrevSettings) == 0x000000, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::PrevSettings' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, NewSettings) == 0x00001C, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::NewSettings' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, Temp_int_Variable) == 0x000038, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, Temp_struct_Variable) == 0x000040, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, Temp_struct_Variable_1) == 0x000050, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::Temp_struct_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, Temp_struct_Variable_2) == 0x000060, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::Temp_struct_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, Temp_struct_Variable_3) == 0x000070, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::Temp_struct_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, CallFunc_Map_Find_Value) == 0x000080, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, CallFunc_Map_Find_ReturnValue) == 0x000084, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_On_UISettinga_Changed, K2Node_Select_Default) == 0x000088, "Member 'WBP_PalNPCHPGauge_C_On_UISettinga_Changed::K2Node_Select_Default' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_IsPart_ReturnValue;                       // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_29[0x3];                                       // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const struct FPalDamageResult& DamageResult)> K2Node_CreateDelegate_OutputDelegate_1; // 0x002C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool bIsBattleMode)>           K2Node_CreateDelegate_OutputDelegate_2;            // 0x003C(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalIndividualCharacterHandle*          CallFunc_GetBindedHandle_targetHandle_1;           // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsFriend_ReturnValue;                     // 0x0061(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetBattleMode_ReturnValue;                // 0x0062(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_63[0x5];                                       // 0x0063(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalFlyMeshHeightCtrlComponent*         CallFunc_GetComponentByClass_ReturnValue;          // 0x0068(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FBoxSphereBounds                       CallFunc_GetImportedBounds_ReturnValue;            // 0x0080(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(WBP_PalNPCHPGauge_C_SetupByActor) == 0x0000F0, "Wrong size on WBP_PalNPCHPGauge_C_SetupByActor");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetBindedHandle_targetHandle) == 0x000000, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetBindedHandle_targetHandle' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetPalmi_ReturnValue) == 0x000008, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetPalmi_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_TryGetIndividualActor_ReturnValue) == 0x000010, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_TryGetIndividualActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, K2Node_CreateDelegate_OutputDelegate) == 0x000018, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_IsPart_ReturnValue) == 0x000028, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_IsPart_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, K2Node_CreateDelegate_OutputDelegate_1) == 0x00002C, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, K2Node_CreateDelegate_OutputDelegate_2) == 0x00003C, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetBindedHandle_targetHandle_1) == 0x000050, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetBindedHandle_targetHandle_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_TryGetIndividualActor_ReturnValue_1) == 0x000058, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_TryGetIndividualActor_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_IsValid_ReturnValue) == 0x000060, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_IsFriend_ReturnValue) == 0x000061, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_IsFriend_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetBattleMode_ReturnValue) == 0x000062, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetBattleMode_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetComponentByClass_ReturnValue) == 0x000068, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_IsValid_ReturnValue_1) == 0x000070, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_IsValid_ReturnValue_2) == 0x000071, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetSkeletalMeshAsset_ReturnValue) == 0x000078, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetSkeletalMeshAsset_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_GetImportedBounds_ReturnValue) == 0x000080, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_GetImportedBounds_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_BreakBoxSphereBounds_Origin) == 0x0000B8, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_BreakBoxSphereBounds_Origin' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_BreakBoxSphereBounds_BoxExtent) == 0x0000D0, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_BreakBoxSphereBounds_BoxExtent' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_SetupByActor, CallFunc_BreakBoxSphereBounds_SphereRadius) == 0x0000E8, "Member 'WBP_PalNPCHPGauge_C_SetupByActor::CallFunc_BreakBoxSphereBounds_SphereRadius' has a wrong offset!");
...
public:
	...
	struct FPalInstanceID                         CallFunc_GetPalID_ReturnValue;                     // 0x0068(0x0030)(HasGetValueTypeHash)
	...
	struct FGuid                                  CallFunc_GetGroupId_ReturnValue;                   // 0x00A0(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetIsCharacterNeutral_ForPlayer_ReturnValue; // 0x00B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_B1[0x3];                                       // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  CallFunc_TryGetGuildNameModifierPlayerUId_GuildNameModifierPlayerUId; // 0x00B4(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_TryGetGuildNameModifierPlayerUId_ReturnValue; // 0x00C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_C5[0x3];                                       // 0x00C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_TryGetGuildName_OutGuildName;             // 0x00C8(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_TryGetGuildName_ReturnValue;              // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetSaveParameter_ReturnValue;             // 0x00E0(0x0320)(ConstParm)
	bool                                          CallFunc_IsEmpty_ReturnValue;                      // 0x0400(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_401[0x3];                                      // 0x0401(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  CallFunc_GetSaveParameterValue_OwnerPlayerUId_ReturnValue; // 0x0404(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_414[0x4];                                      // 0x0414(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CallFunc_SelectString_ReturnValue;                 // 0x0418(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_Guid_ReturnValue;                 // 0x0428(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_PalNPCHPGauge_C_Update_Gauge_Type) == 0x000440, "Wrong size on WBP_PalNPCHPGauge_C_Update_Gauge_Type");
...
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetPalmi_ReturnValue) == 0x000010, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetPalmi_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, Temp_bool_Variable) == 0x000018, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetGroupManager_ReturnValue) == 0x000020, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetGroupManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetLocalizedText_ReturnValue) == 0x000028, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetLocalizedText_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_Conv_TextToString_ReturnValue) == 0x000048, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_Conv_TextToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_TryGetIndividualParameter_ReturnValue) == 0x000058, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_TryGetIndividualParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_IsValid_ReturnValue) == 0x000060, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetPalID_ReturnValue) == 0x000068, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetPalID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetCharacterID_ReturnValue) == 0x000098, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetCharacterID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetGroupId_ReturnValue) == 0x0000A0, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetGroupId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetIsCharacterNeutral_ForPlayer_ReturnValue) == 0x0000B0, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetIsCharacterNeutral_ForPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_TryGetGuildNameModifierPlayerUId_GuildNameModifierPlayerUId) == 0x0000B4, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_TryGetGuildNameModifierPlayerUId_GuildNameModifierPlayerUId' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_TryGetGuildNameModifierPlayerUId_ReturnValue) == 0x0000C4, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_TryGetGuildNameModifierPlayerUId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_TryGetGuildName_OutGuildName) == 0x0000C8, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_TryGetGuildName_OutGuildName' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_TryGetGuildName_ReturnValue) == 0x0000D8, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_TryGetGuildName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetSaveParameter_ReturnValue) == 0x0000E0, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetSaveParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_IsEmpty_ReturnValue) == 0x000400, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_GetSaveParameterValue_OwnerPlayerUId_ReturnValue) == 0x000404, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_GetSaveParameterValue_OwnerPlayerUId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_SelectString_ReturnValue) == 0x000418, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_SelectString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, CallFunc_IsValid_Guid_ReturnValue) == 0x000428, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::CallFunc_IsValid_Guid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_Update_Gauge_Type, K2Node_Select_Default) == 0x000430, "Member 'WBP_PalNPCHPGauge_C_Update_Gauge_Type::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_GetHPGaugeLocation_ReturnValue) == 0x000038, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_GetHPGaugeLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_X) == 0x000050, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_X' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Y) == 0x000058, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Y' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Z) == 0x000060, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Z' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_GetMainMesh_ReturnValue) == 0x000068, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_IsFlying_ReturnValue) == 0x000070, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_IsFlying_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_X_1) == 0x000078, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_X_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Y_1) == 0x000080, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Y_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Z_1) == 0x000088, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Z_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x000090, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_X_2) == 0x000098, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_X_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Y_2) == 0x0000A0, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Y_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Z_2) == 0x0000A8, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Z_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_MakeVector_ReturnValue) == 0x0000B0, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_GetLocalPlayerController_ReturnValue) == 0x0000C8, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Add_VectorVector_ReturnValue) == 0x0000D0, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Add_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_GetActorRightVector_ReturnValue) == 0x0000E8, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_GetActorRightVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector2D_X) == 0x000100, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector2D_Y) == 0x000108, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000110, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Conv_DoubleToVector_ReturnValue) == 0x000118, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Conv_DoubleToVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000130, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Multiply_VectorVector_ReturnValue) == 0x000138, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Multiply_VectorVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Add_DoubleDouble_ReturnValue_1) == 0x000150, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Add_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_X_3) == 0x000158, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_X_3' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Y_3) == 0x000160, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Y_3' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_BreakVector_Z_3) == 0x000168, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_BreakVector_Z_3' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_IsVisible_ReturnValue) == 0x000170, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_IsVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Add_DoubleDouble_ReturnValue_2) == 0x000178, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Add_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_PalNPCHPGauge_C_UpdateWidgetPosition, CallFunc_Add_DoubleDouble_ReturnValue_3) == 0x000180, "Member 'WBP_PalNPCHPGauge_C_UpdateWidgetPosition::CallFunc_Add_DoubleDouble_ReturnValue_3' has a wrong offset!");
