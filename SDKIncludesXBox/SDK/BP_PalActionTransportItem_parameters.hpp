...
static_assert(offsetof(BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem, K2Node_Event_DeltaTime) == 0x000008, "Member 'BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem::K2Node_Event_DeltaTime' has a wrong offset!");
static_assert(offsetof(BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem, CallFunc_GetActionCharacter_ReturnValue) == 0x000010, "Member 'BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem::CallFunc_GetActionCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem, CallFunc_IsDedicatedServer_ReturnValue) == 0x000018, "Member 'BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem, CallFunc_GetMainMesh_ReturnValue) == 0x000020, "Member 'BP_PalActionTransportItem_C_ExecuteUbergraph_BP_PalActionTransportItem::CallFunc_GetMainMesh_ReturnValue' has a wrong offset!");
...
static_assert(alignof(BP_PalActionTransportItem_C_SetupItemActor) == 0x000004, "Wrong alignment on BP_PalActionTransportItem_C_SetupItemActor");
static_assert(sizeof(BP_PalActionTransportItem_C_SetupItemActor) == 0x000008, "Wrong size on BP_PalActionTransportItem_C_SetupItemActor");
static_assert(offsetof(BP_PalActionTransportItem_C_SetupItemActor, CallFunc_ReadBlackboard_StaticItemId) == 0x000000, "Member 'BP_PalActionTransportItem_C_SetupItemActor::CallFunc_ReadBlackboard_StaticItemId' has a wrong offset!");
