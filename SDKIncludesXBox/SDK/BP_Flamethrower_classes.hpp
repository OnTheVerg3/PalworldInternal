...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Flamethrower_C;                  // 0x06A8(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	double                                        UseBulletTimer;                                    // 0x06B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_Flamethrower_C) == 0x0006B8, "Wrong size on ABP_Flamethrower_C");
static_assert(offsetof(ABP_Flamethrower_C, UberGraphFrame_BP_Flamethrower_C) == 0x0006A8, "Member 'ABP_Flamethrower_C::UberGraphFrame_BP_Flamethrower_C' has a wrong offset!");
static_assert(offsetof(ABP_Flamethrower_C, UseBulletTimer) == 0x0006B0, "Member 'ABP_Flamethrower_C::UseBulletTimer' has a wrong offset!");
