...
static_assert(sizeof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo) == 0x000250, "Wrong size on WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo");
...
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, Temp_int_Array_Index_Variable) == 0x000208, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, Temp_int_Loop_Counter_Variable) == 0x00020C, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, CallFunc_Add_IntInt_ReturnValue) == 0x000210, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, CallFunc_GetAllChildren_ReturnValue) == 0x000218, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::CallFunc_GetAllChildren_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, CallFunc_Array_Length_ReturnValue) == 0x000228, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, CallFunc_Array_Get_Item) == 0x000230, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, CallFunc_Less_IntInt_ReturnValue) == 0x000238, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, K2Node_DynamicCast_AsWBP_Chara_Cre_Scroll_Box_Content_Base) == 0x000240, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::K2Node_DynamicCast_AsWBP_Chara_Cre_Scroll_Box_Content_Base' has a wrong offset!");
static_assert(offsetof(WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo, K2Node_DynamicCast_bSuccess) == 0x000248, "Member 'WBP_CharaCre_ScrollBoxContentSet_C_ApplyMakeInfo::K2Node_DynamicCast_bSuccess' has a wrong offset!");
