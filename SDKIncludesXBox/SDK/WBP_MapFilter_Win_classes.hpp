...
static_assert(sizeof(UWBP_MapFilter_Win_C) == 0x000340, "Wrong size on UWBP_MapFilter_Win_C");
...
static_assert(offsetof(UWBP_MapFilter_Win_C, WBP_MapFilter_Content_8) == 0x0002C0, "Member 'UWBP_MapFilter_Win_C::WBP_MapFilter_Content_8' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, WBP_MapFilter_Content_9) == 0x0002C8, "Member 'UWBP_MapFilter_Win_C::WBP_MapFilter_Content_9' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, Filters) == 0x0002D0, "Member 'UWBP_MapFilter_Win_C::Filters' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, FilterMsgMap) == 0x0002E0, "Member 'UWBP_MapFilter_Win_C::FilterMsgMap' has a wrong offset!");
static_assert(offsetof(UWBP_MapFilter_Win_C, OnFilterChanged) == 0x000330, "Member 'UWBP_MapFilter_Win_C::OnFilterChanged' has a wrong offset!");
