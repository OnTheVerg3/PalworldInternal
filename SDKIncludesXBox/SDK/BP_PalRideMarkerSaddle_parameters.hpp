...
static_assert(alignof(BP_PalRideMarkerSaddle_C_OnChangeRiding_イベント_0) == 0x000001, "Wrong alignment on BP_PalRideMarkerSaddle_C_OnChangeRiding_イベント_0");
static_assert(sizeof(BP_PalRideMarkerSaddle_C_OnChangeRiding_イベント_0) == 0x000001, "Wrong size on BP_PalRideMarkerSaddle_C_OnChangeRiding_イベント_0");
static_assert(offsetof(BP_PalRideMarkerSaddle_C_OnChangeRiding_イベント_0, IsEnable) == 0x000000, "Member 'BP_PalRideMarkerSaddle_C_OnChangeRiding_イベント_0::IsEnable' has a wrong offset!");
