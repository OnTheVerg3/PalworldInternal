...
static_assert(offsetof(UWBP_MainMenu_Technology_Content_C, TechnologyOpacity) == 0x000490, "Member 'UWBP_MainMenu_Technology_Content_C::TechnologyOpacity' has a wrong offset!");
