...
static_assert(sizeof(WBP_Notice_Deathlog_C_MakeDeathLogText) == 0x000238, "Wrong size on WBP_Notice_Deathlog_C_MakeDeathLogText");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, AttackerName) == 0x000068, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, DefenderName) == 0x000080, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, Reason) == 0x000098, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::Reason' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_GetDeathResonText_ReasonText) == 0x0000B0, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_GetDeathResonText_ReasonText' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_GetDisplayNickName_OutNickName) == 0x0000C8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_GetDisplayNickName_OutNickName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_IsEmpty_ReturnValue) == 0x0000D8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_GetDisplayNickName_OutNickName_1) == 0x0000E0, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_GetDisplayNickName_OutNickName_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_SelectString_ReturnValue) == 0x0000F0, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_SelectString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_IsEmpty_ReturnValue_1) == 0x000100, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_IsEmpty_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Conv_StringToText_ReturnValue) == 0x000108, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_SelectString_ReturnValue_1) == 0x000120, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_SelectString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeStruct_FormatArgumentData) == 0x000130, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000180, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeArray_Array) == 0x000198, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeStruct_FormatArgumentData_1) == 0x0001A8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Format_ReturnValue) == 0x0001F8, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, K2Node_MakeArray_Array_1) == 0x000210, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeDeathLogText, CallFunc_Format_ReturnValue_1) == 0x000220, "Member 'WBP_Notice_Deathlog_C_MakeDeathLogText::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(WBP_Notice_Deathlog_C_MakeKillLogText) == 0x000238, "Wrong size on WBP_Notice_Deathlog_C_MakeKillLogText");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, AttackerName) == 0x000068, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, DefenderName) == 0x000080, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, Reason) == 0x000098, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::Reason' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_GetDeathResonText_ReasonText) == 0x0000B0, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_GetDeathResonText_ReasonText' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_GetDisplayNickName_OutNickName) == 0x0000C8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_GetDisplayNickName_OutNickName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_IsEmpty_ReturnValue) == 0x0000D8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_GetDisplayNickName_OutNickName_1) == 0x0000E0, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_GetDisplayNickName_OutNickName_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_SelectString_ReturnValue) == 0x0000F0, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_SelectString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_IsEmpty_ReturnValue_1) == 0x000100, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_IsEmpty_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Conv_StringToText_ReturnValue) == 0x000108, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_SelectString_ReturnValue_1) == 0x000120, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_SelectString_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeStruct_FormatArgumentData) == 0x000130, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Conv_StringToText_ReturnValue_1) == 0x000180, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Conv_StringToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeArray_Array) == 0x000198, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeStruct_FormatArgumentData_1) == 0x0001A8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Format_ReturnValue) == 0x0001F8, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, K2Node_MakeArray_Array_1) == 0x000210, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_MakeKillLogText, CallFunc_Format_ReturnValue_1) == 0x000220, "Member 'WBP_Notice_Deathlog_C_MakeKillLogText::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(WBP_Notice_Deathlog_C_SetupAsDeathLog) == 0x0000B0, "Wrong size on WBP_Notice_Deathlog_C_SetupAsDeathLog");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsDeathLog, CallFunc_MakeDeathLogText_AttackerName) == 0x000068, "Member 'WBP_Notice_Deathlog_C_SetupAsDeathLog::CallFunc_MakeDeathLogText_AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsDeathLog, CallFunc_MakeDeathLogText_DefenderName) == 0x000080, "Member 'WBP_Notice_Deathlog_C_SetupAsDeathLog::CallFunc_MakeDeathLogText_DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsDeathLog, CallFunc_MakeDeathLogText_Reason) == 0x000098, "Member 'WBP_Notice_Deathlog_C_SetupAsDeathLog::CallFunc_MakeDeathLogText_Reason' has a wrong offset!");
...
static_assert(sizeof(WBP_Notice_Deathlog_C_SetupAsKillLog) == 0x0000B0, "Wrong size on WBP_Notice_Deathlog_C_SetupAsKillLog");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsKillLog, CallFunc_MakeKillLogText_AttackerName) == 0x000068, "Member 'WBP_Notice_Deathlog_C_SetupAsKillLog::CallFunc_MakeKillLogText_AttackerName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsKillLog, CallFunc_MakeKillLogText_DefenderName) == 0x000080, "Member 'WBP_Notice_Deathlog_C_SetupAsKillLog::CallFunc_MakeKillLogText_DefenderName' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupAsKillLog, CallFunc_MakeKillLogText_Reason) == 0x000098, "Member 'WBP_Notice_Deathlog_C_SetupAsKillLog::CallFunc_MakeKillLogText_Reason' has a wrong offset!");
...
static_assert(sizeof(WBP_Notice_Deathlog_C_SetupIcon) == 0x0000E8, "Wrong size on WBP_Notice_Deathlog_C_SetupIcon");
...
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000068, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetDatabaseCharacterParameter_ReturnValue) == 0x000070, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetDatabaseCharacterParameter_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetCharacterIconTexture_ReturnValue) == 0x000078, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetCharacterIconTexture_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_EqualEqual_NameName_ReturnValue_1) == 0x0000A8, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_EqualEqual_NameName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetDatabaseCharacterParameter_ReturnValue_1) == 0x0000B0, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetDatabaseCharacterParameter_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Notice_Deathlog_C_SetupIcon, CallFunc_GetCharacterIconTexture_ReturnValue_1) == 0x0000B8, "Member 'WBP_Notice_Deathlog_C_SetupIcon::CallFunc_GetCharacterIconTexture_ReturnValue_1' has a wrong offset!");
