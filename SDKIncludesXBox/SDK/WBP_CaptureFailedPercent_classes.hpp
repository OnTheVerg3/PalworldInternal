...
public:
	...
	TMulticastInlineDelegate<void(class UWBP_CaptureFailedPercent_C* SelfWidget)> OnOverClearTimer;  // 0x0458(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
