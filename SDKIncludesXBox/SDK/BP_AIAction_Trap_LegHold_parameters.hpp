...
static_assert(sizeof(BP_AIAction_Trap_LegHold_C_ExecuteUbergraph_BP_AIAction_Trap_LegHold) == 0x0001A0, "Wrong size on BP_AIAction_Trap_LegHold_C_ExecuteUbergraph_BP_AIAction_Trap_LegHold");
...
static_assert(offsetof(BP_AIAction_Trap_LegHold_C_ExecuteUbergraph_BP_AIAction_Trap_LegHold, CallFunc_PlayActionParameter_ReturnValue) == 0x000190, "Member 'BP_AIAction_Trap_LegHold_C_ExecuteUbergraph_BP_AIAction_Trap_LegHold::CallFunc_PlayActionParameter_ReturnValue' has a wrong offset!");
