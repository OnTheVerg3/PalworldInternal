...
static_assert(sizeof(UBP_ActionPalLiftup_Player_C) == 0x000180, "Wrong size on UBP_ActionPalLiftup_Player_C");
static_assert(offsetof(UBP_ActionPalLiftup_Player_C, UberGraphFrame) == 0x000170, "Member 'UBP_ActionPalLiftup_Player_C::UberGraphFrame' has a wrong offset!");
