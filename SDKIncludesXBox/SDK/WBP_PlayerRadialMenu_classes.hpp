...
public:
	...
	TMulticastInlineDelegate<void()>              OnRequestOpenChat;                                 // 0x0578(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FDataTableRowHandle                    OpenChatMsgID;                                     // 0x0588(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TArray<class FName>                           RadialIgnoreTribeList;                             // 0x0598(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UWBP_PlayerRadialMenu_C) == 0x0005A8, "Wrong size on UWBP_PlayerRadialMenu_C");
...
static_assert(offsetof(UWBP_PlayerRadialMenu_C, RadialIgnoreTribeList) == 0x000598, "Member 'UWBP_PlayerRadialMenu_C::RadialIgnoreTribeList' has a wrong offset!");
