...
static_assert(offsetof(BP_SupplyDropActor_Meteor_C_ExecuteUbergraph_BP_SupplyDropActor_Meteor, K2Node_Event_EndPlayReason) == 0x00006C, "Member 'BP_SupplyDropActor_Meteor_C_ExecuteUbergraph_BP_SupplyDropActor_Meteor::K2Node_Event_EndPlayReason' has a wrong offset!");
static_assert(offsetof(BP_SupplyDropActor_Meteor_C_ExecuteUbergraph_BP_SupplyDropActor_Meteor, K2Node_SwitchEnum_CmpSuccess) == 0x00006D, "Member 'BP_SupplyDropActor_Meteor_C_ExecuteUbergraph_BP_SupplyDropActor_Meteor::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
static_assert(alignof(BP_SupplyDropActor_Meteor_C_ReceiveEndPlay) == 0x000001, "Wrong alignment on BP_SupplyDropActor_Meteor_C_ReceiveEndPlay");
static_assert(sizeof(BP_SupplyDropActor_Meteor_C_ReceiveEndPlay) == 0x000001, "Wrong size on BP_SupplyDropActor_Meteor_C_ReceiveEndPlay");
static_assert(offsetof(BP_SupplyDropActor_Meteor_C_ReceiveEndPlay, EndPlayReason) == 0x000000, "Member 'BP_SupplyDropActor_Meteor_C_ReceiveEndPlay::EndPlayReason' has a wrong offset!");
