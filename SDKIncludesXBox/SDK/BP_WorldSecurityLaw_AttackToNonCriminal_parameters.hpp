...
static_assert(alignof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker) == 0x000008, "Wrong alignment on BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker");
static_assert(sizeof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker) == 0x000070, "Wrong size on BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker, DamageResult) == 0x000000, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker::DamageResult' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker, Attacker) == 0x000050, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker::Attacker' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker, CallFunc_GetComponentByClass_ReturnValue) == 0x000058, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker::CallFunc_GetComponentByClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker, CallFunc_IsValid_ReturnValue) == 0x000060, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker, CallFunc_IsRiding_ReturnValue) == 0x000061, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker::CallFunc_IsRiding_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker, CallFunc_GetRiderCharacter_ReturnValue) == 0x000068, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_GetAttacker::CallFunc_GetRiderCharacter_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen) == 0x000007, "Wrong size on BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen");
...
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen, CallFunc_IsEnemyOrganization_ReturnValue) == 0x000004, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen::CallFunc_IsEnemyOrganization_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen, CallFunc_Not_PreBool_ReturnValue) == 0x000005, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen, CallFunc_BooleanAND_ReturnValue) == 0x000006, "Member 'BP_WorldSecurityLaw_AttackToNonCriminal_C_IsOrganizationCitizen::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
