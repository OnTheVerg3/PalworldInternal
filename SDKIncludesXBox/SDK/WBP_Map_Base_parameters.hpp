...
public:
	...
	class UPalRandomizerManager*                  CallFunc_GetRandomizerManager_ReturnValue;         // 0x0048(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_Select_Default_2;                           // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, Temp_bool_Variable_3) == 0x00003B, "Member 'WBP_Map_Base_C_Add_Boss_Icon::Temp_bool_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, Temp_bool_Variable_4) == 0x00003C, "Member 'WBP_Map_Base_C_Add_Boss_Icon::Temp_bool_Variable_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, Temp_bool_Variable_5) == 0x00003D, "Member 'WBP_Map_Base_C_Add_Boss_Icon::Temp_bool_Variable_5' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, CallFunc_GetHUDService_ReturnValue) == 0x000040, "Member 'WBP_Map_Base_C_Add_Boss_Icon::CallFunc_GetHUDService_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, CallFunc_GetRandomizerManager_ReturnValue) == 0x000048, "Member 'WBP_Map_Base_C_Add_Boss_Icon::CallFunc_GetRandomizerManager_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, CallFunc_Array_Contains_ReturnValue) == 0x00006C, "Member 'WBP_Map_Base_C_Add_Boss_Icon::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, K2Node_Select_Default_1) == 0x000070, "Member 'WBP_Map_Base_C_Add_Boss_Icon::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, K2Node_Select_Default_2) == 0x000074, "Member 'WBP_Map_Base_C_Add_Boss_Icon::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, K2Node_Select_Default_3) == 0x000078, "Member 'WBP_Map_Base_C_Add_Boss_Icon::K2Node_Select_Default_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, CallFunc_Conv_NameToString_ReturnValue) == 0x000080, "Member 'WBP_Map_Base_C_Add_Boss_Icon::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, CallFunc_GetLocalPlayerController_ReturnValue) == 0x000090, "Member 'WBP_Map_Base_C_Add_Boss_Icon::CallFunc_GetLocalPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Add_Boss_Icon, CallFunc_Contains_ReturnValue) == 0x000098, "Member 'WBP_Map_Base_C_Add_Boss_Icon::CallFunc_Contains_ReturnValue' has a wrong offset!");
...
public:
	...
	TArray<class UWBP_Map_IconCustom_C*>          CallFunc_Map_Values_Values;                        // 0x0098(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UWBP_Map_IconBoss_C*                    CallFunc_Array_Get_Item;                           // 0x00A8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_Map_IconCustom_C*                  CallFunc_Array_Get_Item_1;                         // 0x00B0(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	TSet<EPalLocationType>                        K2Node_MakeVariable_MakeVariableOutput;            // 0x00C8(0x0050)()
	TSet<EPalLocationType>                        K2Node_MakeSet_Set;                                // 0x0118(0x0050)()
	bool                                          CallFunc_Set_Remove_ReturnValue;                   // 0x0168(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_169[0x7];                                      // 0x0169(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_Map_IconPlayer_C*                  CallFunc_Array_Get_Item_2;                         // 0x0170(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_Map_IconDeath_C*                   CallFunc_Array_Get_Item_3;                         // 0x0180(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	TArray<class UWBP_WorldMap_IconBase_NoDesign_C*> CallFunc_Map_Values_Values_1;                   // 0x0188(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UWBP_WorldMap_IconBase_NoDesign_C*      CallFunc_Array_Get_Item_4;                         // 0x0198(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Map_Base_C_ChangeFilter) == 0x0001B0, "Wrong size on WBP_Map_Base_C_ChangeFilter");
...
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Array_Index_Variable) == 0x000058, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00005C, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Loop_Counter_Variable) == 0x000060, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Add_IntInt_ReturnValue) == 0x000064, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Array_Index_Variable_1) == 0x000068, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Loop_Counter_Variable_1) == 0x00006C, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Add_IntInt_ReturnValue_1) == 0x000070, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Loop_Counter_Variable_2) == 0x000074, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Loop_Counter_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Add_IntInt_ReturnValue_2) == 0x000078, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Array_Index_Variable_2) == 0x00007C, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Array_Index_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Loop_Counter_Variable_3) == 0x000080, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Loop_Counter_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Add_IntInt_ReturnValue_3) == 0x000084, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Add_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Array_Index_Variable_3) == 0x000088, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Array_Index_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Loop_Counter_Variable_4) == 0x00008C, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Loop_Counter_Variable_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Add_IntInt_ReturnValue_4) == 0x000090, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Add_IntInt_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, Temp_int_Array_Index_Variable_4) == 0x000094, "Member 'WBP_Map_Base_C_ChangeFilter::Temp_int_Array_Index_Variable_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Map_Values_Values) == 0x000098, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Get_Item) == 0x0000A8, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Get_Item_1) == 0x0000B0, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Length_ReturnValue) == 0x0000B8, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Less_IntInt_ReturnValue) == 0x0000BC, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Length_ReturnValue_1) == 0x0000C0, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Less_IntInt_ReturnValue_1) == 0x0000C4, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, K2Node_MakeVariable_MakeVariableOutput) == 0x0000C8, "Member 'WBP_Map_Base_C_ChangeFilter::K2Node_MakeVariable_MakeVariableOutput' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, K2Node_MakeSet_Set) == 0x000118, "Member 'WBP_Map_Base_C_ChangeFilter::K2Node_MakeSet_Set' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Set_Remove_ReturnValue) == 0x000168, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Set_Remove_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Get_Item_2) == 0x000170, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Length_ReturnValue_2) == 0x000178, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Less_IntInt_ReturnValue_2) == 0x00017C, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Map_Values_Values_1) == 0x000188, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Map_Values_Values_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Get_Item_4) == 0x000198, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Get_Item_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Length_ReturnValue_3) == 0x0001A0, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Length_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Less_IntInt_ReturnValue_3) == 0x0001A4, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Less_IntInt_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Array_Length_ReturnValue_4) == 0x0001A8, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Array_Length_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ChangeFilter, CallFunc_Less_IntInt_ReturnValue_4) == 0x0001AC, "Member 'WBP_Map_Base_C_ChangeFilter::CallFunc_Less_IntInt_ReturnValue_4' has a wrong offset!");
...
public:
	...
	struct FGuid                                  CallFunc_AddLocalCustomMarker_ReturnValue;         // 0x00C0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(WBP_Map_Base_C_Enable_Custom_Mark, CallFunc_AddLocalCustomMarker_ReturnValue) == 0x0000C0, "Member 'WBP_Map_Base_C_Enable_Custom_Mark::CallFunc_AddLocalCustomMarker_ReturnValue' has a wrong offset!");
...
public:
	...
	ESlateVisibility                              Temp_byte_Variable_3;                              // 0x00E3(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable_5;                              // 0x0228(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_Conv_Vector2dToString_ReturnValue;        // 0x0278(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	class UUMGSequencePlayer*                     CallFunc_PlayAnimation_ReturnValue;                // 0x0318(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_8;            // 0x0320(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalUIActionBindData                   CallFunc_RegisterActionBinding_ReturnValue_3;      // 0x0330(0x0004)(NoDestructor)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_9;            // 0x0334(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_10;           // 0x0344(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalUIActionBindData                   CallFunc_RegisterActionBinding_ReturnValue_4;      // 0x0354(0x0004)(NoDestructor)
	class UPalWorldMapUIData*                     CallFunc_GetLocalWorldMapData_ReturnValue;         // 0x0358(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetLocalPlayerID_ReturnValue;             // 0x0368(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_UnlockMap_ReturnValue;                    // 0x036C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue_1;               // 0x0378(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FVector2D                              CallFunc_MakeVector2D_ReturnValue_2;               // 0x0398(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_MapRangeUnclamped_ReturnValue;            // 0x03B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              K2Node_Select_Default_2;                           // 0x03C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3C1[0x7];                                      // 0x03C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_DoubleToText_ReturnValue;            // 0x03C8(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData_1;            // 0x03E0(0x0050)(HasGetValueTypeHash)
	double                                        CallFunc_MapRangeUnclamped_ReturnValue_1;          // 0x0430(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalDebugSetting*                       CallFunc_GetPalDebugSetting_ReturnValue_1;         // 0x0438(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_Conv_DoubleToText_ReturnValue_1;          // 0x0440(0x0018)()
	...
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData_2;            // 0x0460(0x0050)(HasGetValueTypeHash)
	class FText                                   CallFunc_MakeLiteralText_ReturnValue;              // 0x04B0(0x0018)()
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate_11;           // 0x04C8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FText                                   K2Node_Select_Default_3;                           // 0x04D8(0x0018)()
	struct FFormatArgumentData                    K2Node_MakeStruct_FormatArgumentData_3;            // 0x04F0(0x0050)(HasGetValueTypeHash)
	struct FPalUIActionBindData                   CallFunc_RegisterActionBinding_ReturnValue_5;      // 0x0540(0x0004)(NoDestructor)
	uint8                                         Pad_544[0x4];                                      // 0x0544(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFormatArgumentData>            K2Node_MakeArray_Array_1;                          // 0x0548(0x0010)(ReferenceParm)
	class UPalHUDDispatchParameterBase*           CallFunc_GetParam_ReturnValue_1;                   // 0x0558(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class FText                                   CallFunc_Format_ReturnValue_1;                     // 0x0560(0x0018)()
	class UPalHUDDispatchParameter_WorldMap*      K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_World_Map_1; // 0x0578(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0580(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_NameName_ReturnValue;          // 0x0581(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base) == 0x000588, "Wrong size on WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base");
...
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_bool_Variable_1) == 0x000005, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_byte_Variable) == 0x000006, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_byte_Variable_1) == 0x000007, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_byte_Variable_1' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_bool_Variable_2) == 0x0000E1, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_byte_Variable_2) == 0x0000E2, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_byte_Variable_3) == 0x0000E3, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_bool_Variable_3) == 0x0000E4, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_bool_Variable_3' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_byte_Variable_4) == 0x000108, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_byte_Variable_4' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, Temp_byte_Variable_5) == 0x000228, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::Temp_byte_Variable_5' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_Select_Default_1) == 0x000260, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_MakeVector2D_ReturnValue) == 0x000268, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Conv_Vector2dToString_ReturnValue) == 0x000278, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Conv_Vector2dToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Conv_StringToText_ReturnValue) == 0x000288, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_MakeStruct_FormatArgumentData) == 0x0002A0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_MakeArray_Array) == 0x0002F0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Format_ReturnValue) == 0x000300, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_PlayAnimation_ReturnValue) == 0x000318, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_CreateDelegate_OutputDelegate_8) == 0x000320, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_CreateDelegate_OutputDelegate_8' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_RegisterActionBinding_ReturnValue_3) == 0x000330, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_RegisterActionBinding_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_CreateDelegate_OutputDelegate_9) == 0x000334, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_CreateDelegate_OutputDelegate_9' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_CreateDelegate_OutputDelegate_10) == 0x000344, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_CreateDelegate_OutputDelegate_10' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_RegisterActionBinding_ReturnValue_4) == 0x000354, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_RegisterActionBinding_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_GetLocalWorldMapData_ReturnValue) == 0x000358, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_GetLocalWorldMapData_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Conv_StringToName_ReturnValue) == 0x000360, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Conv_StringToName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_GetLocalPlayerID_ReturnValue) == 0x000368, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_GetLocalPlayerID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_UnlockMap_ReturnValue) == 0x00036C, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_UnlockMap_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_GetLocalPlayerSubsystem_ReturnValue) == 0x000370, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_GetLocalPlayerSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_MakeVector2D_ReturnValue_1) == 0x000378, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_MakeVector2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_BreakVector2D_X) == 0x000388, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_BreakVector2D_Y) == 0x000390, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_MakeVector2D_ReturnValue_2) == 0x000398, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_MakeVector2D_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_BreakVector2D_X_1) == 0x0003A8, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_BreakVector2D_X_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_BreakVector2D_Y_1) == 0x0003B0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_BreakVector2D_Y_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_MapRangeUnclamped_ReturnValue) == 0x0003B8, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_MapRangeUnclamped_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_Select_Default_2) == 0x0003C0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Conv_DoubleToText_ReturnValue) == 0x0003C8, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Conv_DoubleToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_MakeStruct_FormatArgumentData_1) == 0x0003E0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_MapRangeUnclamped_ReturnValue_1) == 0x000430, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_MapRangeUnclamped_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_GetPalDebugSetting_ReturnValue_1) == 0x000438, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_GetPalDebugSetting_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Conv_DoubleToText_ReturnValue_1) == 0x000440, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Conv_DoubleToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_IsValid_ReturnValue_2) == 0x000458, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_MakeStruct_FormatArgumentData_2) == 0x000460, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_MakeLiteralText_ReturnValue) == 0x0004B0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_CreateDelegate_OutputDelegate_11) == 0x0004C8, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_CreateDelegate_OutputDelegate_11' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_Select_Default_3) == 0x0004D8, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_Select_Default_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_MakeStruct_FormatArgumentData_3) == 0x0004F0, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_MakeStruct_FormatArgumentData_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_RegisterActionBinding_ReturnValue_5) == 0x000540, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_RegisterActionBinding_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_MakeArray_Array_1) == 0x000548, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_GetParam_ReturnValue_1) == 0x000558, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_GetParam_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_Format_ReturnValue_1) == 0x000560, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_World_Map_1) == 0x000578, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_World_Map_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, K2Node_DynamicCast_bSuccess_1) == 0x000580, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000581, "Member 'WBP_Map_Base_C_ExecuteUbergraph_WBP_Map_Base::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
...
{
public:
	class UWBP_Map_IconQuest_C*                   K2Node_DynamicCast_AsWBP_Map_Icon_Quest;           // 0x0000(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_GetQuestId_QuestId;                       // 0x000C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Map_Base_C_OnInputAction_ShowQuest) == 0x000008, "Wrong alignment on WBP_Map_Base_C_OnInputAction_ShowQuest");
static_assert(sizeof(WBP_Map_Base_C_OnInputAction_ShowQuest) == 0x000018, "Wrong size on WBP_Map_Base_C_OnInputAction_ShowQuest");
static_assert(offsetof(WBP_Map_Base_C_OnInputAction_ShowQuest, K2Node_DynamicCast_AsWBP_Map_Icon_Quest) == 0x000000, "Member 'WBP_Map_Base_C_OnInputAction_ShowQuest::K2Node_DynamicCast_AsWBP_Map_Icon_Quest' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnInputAction_ShowQuest, K2Node_DynamicCast_bSuccess) == 0x000008, "Member 'WBP_Map_Base_C_OnInputAction_ShowQuest::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnInputAction_ShowQuest, CallFunc_GetQuestId_QuestId) == 0x00000C, "Member 'WBP_Map_Base_C_OnInputAction_ShowQuest::CallFunc_GetQuestId_QuestId' has a wrong offset!");
...
public:
	...
	class UPalLocationPoint*                      CallFunc_GetLocationPoint_LocationPoint_1;         // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetLocationPoint_LocationPoint) == 0x000008, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetLocationPoint_LocationPoint' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_IsValid_ReturnValue) == 0x000010, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetLocationRotation_LocationRotation) == 0x000020, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetLocationRotation_LocationRotation' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetLocationPosition_LocationPosition) == 0x000040, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetLocationPosition_LocationPosition' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_MakeLiteralName_ReturnValue) == 0x000058, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_MakeLiteralName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetLocationPoint_LocationPoint_1) == 0x000060, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetLocationPoint_LocationPoint_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetLocation_ReturnValue) == 0x000068, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_Not_PreBool_ReturnValue) == 0x000080, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_Conv_VectorToString_ReturnValue) == 0x000088, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_Conv_VectorToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetHUDService_ReturnValue) == 0x000098, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetHUDService_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_OnRepliedDialog, CallFunc_GetLocalPlayerState_ReturnValue) == 0x0000A0, "Member 'WBP_Map_Base_C_OnRepliedDialog::CallFunc_GetLocalPlayerState_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_Add_Icon_Added;                           // 0x0188(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UPalLocationPoint*>              CallFunc_Map_Keys_Keys_1;                          // 0x0190(0x0010)(ReferenceParm)
	TArray<struct FGuid>                          CallFunc_Map_Values_Values;                        // 0x01A0(0x0010)(ReferenceParm)
	class UPalLocationPoint*                      CallFunc_Array_Get_Item_2;                         // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_Array_Get_Item_3;                         // 0x01B8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                                CallFunc_GetLocation_ReturnValue_1;                // 0x01C8(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_GuidGuid_ReturnValue_1;        // 0x01E0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1E1[0x7];                                      // 0x01E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_Vector_Distance2D_ReturnValue;            // 0x01E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue_2;               // 0x01F0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_DoubleDouble_ReturnValue;            // 0x01F4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_BooleanAND_ReturnValue_2;                 // 0x01F7(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Contains_ReturnValue;                 // 0x01F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Map_Base_C_RefreshDeathMark) == 0x000200, "Wrong size on WBP_Map_Base_C_RefreshDeathMark");
...
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_SlotAsCanvasSlot_ReturnValue) == 0x000180, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_SlotAsCanvasSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Add_Icon_Added) == 0x000188, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Add_Icon_Added' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Array_Add_ReturnValue) == 0x00018C, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Map_Keys_Keys_1) == 0x000190, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Map_Keys_Keys_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Map_Values_Values) == 0x0001A0, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Array_Get_Item_2) == 0x0001B0, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Array_Get_Item_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Array_Get_Item_3) == 0x0001B8, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Array_Get_Item_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_GetLocation_ReturnValue_1) == 0x0001C8, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_GetLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_EqualEqual_GuidGuid_ReturnValue_1) == 0x0001E0, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_EqualEqual_GuidGuid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Vector_Distance2D_ReturnValue) == 0x0001E8, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Vector_Distance2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Array_Length_ReturnValue_2) == 0x0001F0, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Array_Length_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Less_DoubleDouble_ReturnValue) == 0x0001F4, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Less_IntInt_ReturnValue_2) == 0x0001F5, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Less_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_BooleanAND_ReturnValue_1) == 0x0001F6, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_BooleanAND_ReturnValue_2) == 0x0001F7, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Map_Contains_ReturnValue) == 0x0001F8, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Map_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_Not_PreBool_ReturnValue_1) == 0x0001F9, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_RefreshDeathMark, CallFunc_BooleanAND_ReturnValue_3) == 0x0001FA, "Member 'WBP_Map_Base_C_RefreshDeathMark::CallFunc_BooleanAND_ReturnValue_3' has a wrong offset!");
...
public:
	...
	class UWBP_Map_IconQuest_C*                   CallFunc_Create_ReturnValue_1;                     // 0x0040(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsClientDedicatedServer_ReturnValue;      // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPocketpairUserSubsystem*               CallFunc_GetGameInstanceSubsystem_ReturnValue;     // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                 CallFunc_GetInviteCode_ReturnValue;                // 0x0060(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_Map_IconTreasureMapPoint_C*        CallFunc_Create_ReturnValue_2;                     // 0x0088(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_GetLocalPlayerUID_ReturnValue;            // 0x0090(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPalLocationPoint_Respawn*              K2Node_DynamicCast_AsPal_Location_Point_Respawn;   // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalLocationPoint_BossTower*            K2Node_DynamicCast_AsPal_Location_Point_Boss_Tower; // 0x00B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_B9[0x7];                                       // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APalBossTower*                          CallFunc_GetBossTower_ReturnValue;                 // 0x00C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalRespawnPointData                   CallFunc_GetDataTableRowFromName_OutRow;           // 0x00C8(0x0020)()
	...
	struct FGuid                                  CallFunc_GetLocalPlayerUID_ReturnValue_1;          // 0x00EC(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWBP_Map_IconCamp_C*                    CallFunc_Create_ReturnValue_3;                     // 0x0108(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsRequestedPlayer_ReturnValue;            // 0x0110(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalLocationPointBaseCamp*              K2Node_DynamicCast_AsPal_Location_Point_Base_Camp; // 0x0118(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalLocationPointFastTravel*            K2Node_DynamicCast_AsPal_Location_Point_Fast_Travel; // 0x0128(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_3;                     // 0x0130(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsEnableFastTravel_ReturnValue;           // 0x0131(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsEnableFastTravel_ReturnValue_1;         // 0x0132(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue;                    // 0x0133(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_GetBaseCampId_ReturnValue;                // 0x0134(0x0010)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsSameGuildWithPlayer_ReturnValue;        // 0x0144(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_145[0x3];                                      // 0x0145(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_Map_IconFTTower_C*                 CallFunc_Create_ReturnValue_4;                     // 0x0148(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                      CallFunc_GetOwningPlayer_ReturnValue_4;            // 0x0150(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UWBP_Map_IconDungeon_C*                 CallFunc_Create_ReturnValue_5;                     // 0x0158(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_WorldMap_Icon_Respawn_C*           CallFunc_Create_ReturnValue_6;                     // 0x0160(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UWBP_Map_IconTower_C*                   CallFunc_Create_ReturnValue_7;                     // 0x0168(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Map_Base_C_Setup_Icon) == 0x000178, "Wrong size on WBP_Map_Base_C_Setup_Icon");
...
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetOwningPlayer_ReturnValue_1) == 0x000030, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetOwningPlayer_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_1) == 0x000040, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_IsClientDedicatedServer_ReturnValue) == 0x000048, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_IsClientDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetGameInstanceSubsystem_ReturnValue) == 0x000050, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetGameInstanceSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Not_PreBool_ReturnValue) == 0x000058, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetInviteCode_ReturnValue) == 0x000060, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetInviteCode_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_IsEmpty_ReturnValue) == 0x000070, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetOwningPlayer_ReturnValue_2) == 0x000078, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetOwningPlayer_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_BooleanAND_ReturnValue) == 0x000080, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_2) == 0x000088, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetLocalPlayerUID_ReturnValue) == 0x000090, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetLocalPlayerUID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_AsPal_Location_Point_Respawn) == 0x0000A0, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_AsPal_Location_Point_Respawn' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_bSuccess) == 0x0000A8, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_AsPal_Location_Point_Boss_Tower) == 0x0000B0, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_AsPal_Location_Point_Boss_Tower' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_bSuccess_1) == 0x0000B8, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetBossTower_ReturnValue) == 0x0000C0, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetBossTower_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetDataTableRowFromName_OutRow) == 0x0000C8, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetDataTableRowFromName_OutRow' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x0000E8, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetLocalPlayerUID_ReturnValue_1) == 0x0000EC, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetLocalPlayerUID_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetOwningPlayer_ReturnValue_3) == 0x000100, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetOwningPlayer_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_3) == 0x000108, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_IsRequestedPlayer_ReturnValue) == 0x000110, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_IsRequestedPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_AsPal_Location_Point_Base_Camp) == 0x000118, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_AsPal_Location_Point_Base_Camp' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_bSuccess_2) == 0x000120, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_AsPal_Location_Point_Fast_Travel) == 0x000128, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_AsPal_Location_Point_Fast_Travel' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, K2Node_DynamicCast_bSuccess_3) == 0x000130, "Member 'WBP_Map_Base_C_Setup_Icon::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_IsEnableFastTravel_ReturnValue) == 0x000131, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_IsEnableFastTravel_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_IsEnableFastTravel_ReturnValue_1) == 0x000132, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_IsEnableFastTravel_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_BooleanOR_ReturnValue) == 0x000133, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetBaseCampId_ReturnValue) == 0x000134, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetBaseCampId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_IsSameGuildWithPlayer_ReturnValue) == 0x000144, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_IsSameGuildWithPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_4) == 0x000148, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_GetOwningPlayer_ReturnValue_4) == 0x000150, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_GetOwningPlayer_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_5) == 0x000158, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_6) == 0x000160, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_6' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Create_ReturnValue_7) == 0x000168, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Create_ReturnValue_7' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_Setup_Icon, CallFunc_Array_Add_ReturnValue) == 0x000170, "Member 'WBP_Map_Base_C_Setup_Icon::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
...
public:
	...
	TDelegate<void(const struct FGuid& LocationId, class UPalLocationBase* Location)> K2Node_CreateDelegate_OutputDelegate; // 0x01B0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const struct FGuid& LocationId, class UPalLocationBase* Location)> K2Node_CreateDelegate_OutputDelegate_1; // 0x01C0(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TMap<struct FGuid, class UPalLocationBase*>   CallFunc_GetLocationMap_ReturnValue;               // 0x0210(0x0050)(ConstParm)
...
public:
	...
	class UWBP_Map_IconBoss_C*                    CallFunc_Array_Get_Item;                           // 0x0018(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Add_Icon_By_Location_Added;               // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_Map_Base_C_UpdateBossIconState) == 0x000048, "Wrong size on WBP_Map_Base_C_UpdateBossIconState");
...
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_GetHUDService_ReturnValue) == 0x000010, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_GetHUDService_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_Array_Get_Item) == 0x000018, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_GetLocationPosition_LocationPosition) == 0x000020, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_GetLocationPosition_LocationPosition' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_Add_Icon_By_Location_Added) == 0x000038, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_Add_Icon_By_Location_Added' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_Array_Contains_ReturnValue) == 0x000039, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_Array_Length_ReturnValue) == 0x00003C, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_Map_Base_C_UpdateBossIconState, CallFunc_Less_IntInt_ReturnValue) == 0x000040, "Member 'WBP_Map_Base_C_UpdateBossIconState::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
