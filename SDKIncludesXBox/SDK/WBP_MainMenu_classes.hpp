...
static_assert(sizeof(UWBP_MainMenu_C) == 0x000518, "Wrong size on UWBP_MainMenu_C");
...
static_assert(offsetof(UWBP_MainMenu_C, WBP_Tab_06) == 0x0004B0, "Member 'UWBP_MainMenu_C::WBP_Tab_06' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_C, WBP_Tab_Key_L) == 0x0004B8, "Member 'UWBP_MainMenu_C::WBP_Tab_Key_L' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_C, WBP_Tab_Key_R) == 0x0004C0, "Member 'UWBP_MainMenu_C::WBP_Tab_Key_R' has a wrong offset!");
static_assert(offsetof(UWBP_MainMenu_C, TabWidgetMap) == 0x0004C8, "Member 'UWBP_MainMenu_C::TabWidgetMap' has a wrong offset!");
