...
static_assert(sizeof(UWBP_GameOver_Down_C) == 0x0004C8, "Wrong size on UWBP_GameOver_Down_C");
...
static_assert(offsetof(UWBP_GameOver_Down_C, Is_Partner_Skill_Revive) == 0x0004C0, "Member 'UWBP_GameOver_Down_C::Is_Partner_Skill_Revive' has a wrong offset!");
