...
static_assert(sizeof(WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite) == 0x000040, "Wrong size on WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite, NewIndex) == 0x000000, "Member 'WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite::NewIndex' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite, CallFunc_GetFavoriteIcon_IconTexutre) == 0x000008, "Member 'WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite::CallFunc_GetFavoriteIcon_IconTexutre' has a wrong offset!");
static_assert(offsetof(WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite, CallFunc_IsValidSoftObjectReference_ReturnValue) == 0x000038, "Member 'WBP_IngameMenu_PalBox_PalList_C_UpdateFavorite::CallFunc_IsValidSoftObjectReference_ReturnValue' has a wrong offset!");
