...
static_assert(sizeof(UBP_AIADamageReaction_C) == 0x000148, "Wrong size on UBP_AIADamageReaction_C");
...
static_assert(offsetof(UBP_AIADamageReaction_C, DefaultAIActionDeathClass) == 0x000140, "Member 'UBP_AIADamageReaction_C::DefaultAIActionDeathClass' has a wrong offset!");
