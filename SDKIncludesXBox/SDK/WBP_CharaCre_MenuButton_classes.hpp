...
static_assert(sizeof(UWBP_CharaCre_MenuButton_C) == 0x000310, "Wrong size on UWBP_CharaCre_MenuButton_C");
...
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, FocusFrame) == 0x000288, "Member 'UWBP_CharaCre_MenuButton_C::FocusFrame' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, Frame) == 0x000290, "Member 'UWBP_CharaCre_MenuButton_C::Frame' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, Text_Main) == 0x000298, "Member 'UWBP_CharaCre_MenuButton_C::Text_Main' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, WBP_PalInvisibleButton) == 0x0002A0, "Member 'UWBP_CharaCre_MenuButton_C::WBP_PalInvisibleButton' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, OnClicked) == 0x0002A8, "Member 'UWBP_CharaCre_MenuButton_C::OnClicked' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, BindCategory) == 0x0002B8, "Member 'UWBP_CharaCre_MenuButton_C::BindCategory' has a wrong offset!");
static_assert(offsetof(UWBP_CharaCre_MenuButton_C, MsgIDMap) == 0x0002C0, "Member 'UWBP_CharaCre_MenuButton_C::MsgIDMap' has a wrong offset!");
