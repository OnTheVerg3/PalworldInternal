...
static_assert(alignof(BP_AIAction_Sleep_C_OnAllActionFinishDelegate_イベント_0) == 0x000008, "Wrong alignment on BP_AIAction_Sleep_C_OnAllActionFinishDelegate_イベント_0");
static_assert(sizeof(BP_AIAction_Sleep_C_OnAllActionFinishDelegate_イベント_0) == 0x000008, "Wrong size on BP_AIAction_Sleep_C_OnAllActionFinishDelegate_イベント_0");
static_assert(offsetof(BP_AIAction_Sleep_C_OnAllActionFinishDelegate_イベント_0, ActionComponent) == 0x000000, "Member 'BP_AIAction_Sleep_C_OnAllActionFinishDelegate_イベント_0::ActionComponent' has a wrong offset!");
...
static_assert(alignof(BP_AIAction_Sleep_C_OnDamageDelegate_イベント_0) == 0x000008, "Wrong alignment on BP_AIAction_Sleep_C_OnDamageDelegate_イベント_0");
static_assert(sizeof(BP_AIAction_Sleep_C_OnDamageDelegate_イベント_0) == 0x000050, "Wrong size on BP_AIAction_Sleep_C_OnDamageDelegate_イベント_0");
static_assert(offsetof(BP_AIAction_Sleep_C_OnDamageDelegate_イベント_0, DamageResult) == 0x000000, "Member 'BP_AIAction_Sleep_C_OnDamageDelegate_イベント_0::DamageResult' has a wrong offset!");
