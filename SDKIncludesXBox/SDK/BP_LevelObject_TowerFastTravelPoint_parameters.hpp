...
public:
	...
	TDelegate<void(const struct FPalOptionWorldSettings& PrevSettings, const struct FPalOptionWorldSettings& NewSettings)> K2Node_CreateDelegate_OutputDelegate_2; // 0x0034(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalOptionWorldSettings                K2Node_CustomEvent_PrevSettings;                   // 0x0048(0x01A0)(ConstParm)
	struct FPalOptionWorldSettings                K2Node_CustomEvent_NewSettings;                    // 0x01E8(0x01A0)(ConstParm)
	struct FPalOptionWorldSettings                CallFunc_GetOptionWorldSettings_ReturnValue;       // 0x0388(0x01A0)(ConstParm)
};
...
static_assert(sizeof(BP_LevelObject_TowerFastTravelPoint_C_ExecuteUbergraph_BP_LevelObject_TowerFastTravelPoint) == 0x000528, "Wrong size on BP_LevelObject_TowerFastTravelPoint_C_ExecuteUbergraph_BP_LevelObject_TowerFastTravelPoint");
...
static_assert(offsetof(BP_LevelObject_TowerFastTravelPoint_C_ExecuteUbergraph_BP_LevelObject_TowerFastTravelPoint, K2Node_CustomEvent_NewSettings) == 0x0001E8, "Member 'BP_LevelObject_TowerFastTravelPoint_C_ExecuteUbergraph_BP_LevelObject_TowerFastTravelPoint::K2Node_CustomEvent_NewSettings' has a wrong offset!");
static_assert(offsetof(BP_LevelObject_TowerFastTravelPoint_C_ExecuteUbergraph_BP_LevelObject_TowerFastTravelPoint, CallFunc_GetOptionWorldSettings_ReturnValue) == 0x000388, "Member 'BP_LevelObject_TowerFastTravelPoint_C_ExecuteUbergraph_BP_LevelObject_TowerFastTravelPoint::CallFunc_GetOptionWorldSettings_ReturnValue' has a wrong offset!");
...
{
public:
	struct FPalOptionWorldSettings                PrevSettings;                                      // 0x0000(0x01A0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FPalOptionWorldSettings                NewSettings;                                       // 0x01A0(0x01A0)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
static_assert(sizeof(BP_LevelObject_TowerFastTravelPoint_C_OnChangeWorldSettings) == 0x000340, "Wrong size on BP_LevelObject_TowerFastTravelPoint_C_OnChangeWorldSettings");
...
static_assert(offsetof(BP_LevelObject_TowerFastTravelPoint_C_OnChangeWorldSettings, NewSettings) == 0x0001A0, "Member 'BP_LevelObject_TowerFastTravelPoint_C_OnChangeWorldSettings::NewSettings' has a wrong offset!");
