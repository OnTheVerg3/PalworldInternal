...
static_assert(sizeof(BP_PalPlayerCaptureSet_C_RequestByCharacterMakeInfo) == 0x000210, "Wrong size on BP_PalPlayerCaptureSet_C_RequestByCharacterMakeInfo");
...
static_assert(offsetof(BP_PalPlayerCaptureSet_C_RequestByCharacterMakeInfo, CallFunc_GetDisplayCharacterActor_UIDisplayPlayer) == 0x000208, "Member 'BP_PalPlayerCaptureSet_C_RequestByCharacterMakeInfo::CallFunc_GetDisplayCharacterActor_UIDisplayPlayer' has a wrong offset!");
