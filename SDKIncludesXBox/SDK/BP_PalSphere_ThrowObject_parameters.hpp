...
public:
	...
	class AActor*                                 CallFunc_GetOwnerCharacterOrRidingCharacter_RidingCharacter; // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UClass*                                 CallFunc_GetBodyClass_bodyClass;                   // 0x0050(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalOtomoAttackStopJudgeByBallList*     CallFunc_GetOtomoAttackStopJudge_ReturnValue;      // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGuid                                  CallFunc_SpawnActorBroadcast_SpawnGuid;            // 0x00F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_SpawnActorBroadcast_ReturnValue;          // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_PalSphere_ThrowObject_C_CaptureStartProcess) == 0x000110, "Wrong size on BP_PalSphere_ThrowObject_C_CaptureStartProcess");
...
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_FindOwnerPalCharacter_ReturnValue) == 0x000010, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_FindOwnerPalCharacter_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetCharacterParameterComponent_ReturnValue) == 0x000018, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetCharacterParameterComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000020, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_IsSneakAttackSuccessByLocation_ReturnValue) == 0x000038, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_IsSneakAttackSuccessByLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_BooleanAND_ReturnValue) == 0x000039, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetOwnerCharacterOrRidingCharacter_RidingCharacter) == 0x000040, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetOwnerCharacterOrRidingCharacter_RidingCharacter' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x000048, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetBodyClass_bodyClass) == 0x000050, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetBodyClass_bodyClass' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetOwner_ReturnValue) == 0x000058, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000060, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetOwner_ReturnValue_1) == 0x000078, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetOwner_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetBattleManager_ReturnValue) == 0x000080, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetBattleManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetCharacterParameterComponent_ReturnValue_1) == 0x000088, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetCharacterParameterComponent_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetTransform_ReturnValue) == 0x000090, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_GetOtomoAttackStopJudge_ReturnValue) == 0x0000F0, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_GetOtomoAttackStopJudge_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_SpawnActorBroadcast_SpawnGuid) == 0x0000F8, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_SpawnActorBroadcast_SpawnGuid' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_SpawnActorBroadcast_ReturnValue) == 0x000108, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_SpawnActorBroadcast_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_CaptureStartProcess, CallFunc_IsValid_ReturnValue) == 0x000109, "Member 'BP_PalSphere_ThrowObject_C_CaptureStartProcess::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject) == 0x0002C8, "Wrong size on BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject");
...
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_IsValid_ReturnValue) == 0x000110, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_K2_GetActorLocation_ReturnValue) == 0x000118, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_K2_GetActorLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_K2_GetActorLocation_ReturnValue_1) == 0x000130, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_K2_GetActorLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_ComponentBoundEvent_ImpactResult) == 0x000148, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_ComponentBoundEvent_ImpactResult' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_ComponentBoundEvent_ImpactVelocity) == 0x000230, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_ComponentBoundEvent_ImpactVelocity' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_Event_DeltaSeconds) == 0x000248, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_CustomEvent_BodyActor) == 0x000250, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_CustomEvent_BodyActor' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_CustomEvent_Target) == 0x000258, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_CustomEvent_Target' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_CustomEvent_Delay) == 0x000260, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_CustomEvent_Delay' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_CustomEvent_SneakAttack) == 0x000268, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_CustomEvent_SneakAttack' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_K2_GetActorRotation_ReturnValue) == 0x000270, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_K2_GetActorRotation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_CustomEvent_Actor) == 0x000288, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_CustomEvent_Actor' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_CustomEvent_PrimitiveComponent) == 0x000290, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_CustomEvent_PrimitiveComponent' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_IsCritical_bCritical) == 0x000298, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_IsCritical_bCritical' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_IsCaptureablePal_Captureable) == 0x000299, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_IsCaptureablePal_Captureable' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_IsCaptureablePal_TargetPalCharacter) == 0x0002A0, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_IsCaptureablePal_TargetPalCharacter' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_IsValid_ReturnValue_1) == 0x0002A8, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_UpdateRotator_DeltaTime_ImplicitCast) == 0x0002B0, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_UpdateRotator_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_UpdateCurve_DeltaTime_ImplicitCast) == 0x0002B8, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_UpdateCurve_DeltaTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, CallFunc_Delay_Duration_ImplicitCast) == 0x0002C0, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject, K2Node_VariableSet_ProjectileGravityScale_ImplicitCast) == 0x0002C4, "Member 'BP_PalSphere_ThrowObject_C_ExecuteUbergraph_BP_PalSphere_ThrowObject::K2Node_VariableSet_ProjectileGravityScale_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(BP_PalSphere_ThrowObject_C_SetCurveParameter, CurveID_0) == 0x000000, "Member 'BP_PalSphere_ThrowObject_C_SetCurveParameter::CurveID_0' has a wrong offset!");
