...
{
public:
	class UPalMapObjectSpawnerForwardDirectionComponent* PalMapObjectSpawnerForwardDirection;        // 0x0308(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UArrowComponent*                        Arrow1;                                            // 0x0310(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	class UStaticMeshComponent*                   LocationBenchmark;                                 // 0x0318(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_PalMapObjectSpawner_Treasure_Grass_Grade_01_C, PalMapObjectSpawnerForwardDirection) == 0x000308, "Member 'ABP_PalMapObjectSpawner_Treasure_Grass_Grade_01_C::PalMapObjectSpawnerForwardDirection' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawner_Treasure_Grass_Grade_01_C, Arrow1) == 0x000310, "Member 'ABP_PalMapObjectSpawner_Treasure_Grass_Grade_01_C::Arrow1' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawner_Treasure_Grass_Grade_01_C, LocationBenchmark) == 0x000318, "Member 'ABP_PalMapObjectSpawner_Treasure_Grass_Grade_01_C::LocationBenchmark' has a wrong offset!");
