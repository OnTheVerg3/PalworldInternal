...
static_assert(offsetof(BP_SkillEffect_Inferno_C_GetInsertIndex, Param_Index_0) == 0x000018, "Member 'BP_SkillEffect_Inferno_C_GetInsertIndex::Param_Index_0' has a wrong offset!");
