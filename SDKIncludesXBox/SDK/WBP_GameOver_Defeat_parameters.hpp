...
public:
	...
	class APalPlayerState*                        CallFunc_GetLocalPlayerState_ReturnValue;          // 0x01B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanAND_ReturnValue;                   // 0x01C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsInStage_ReturnValue;                    // 0x01C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<struct FPalLogInfo_DropPal>            K2Node_MakeArray_Array;                            // 0x01C8(0x0010)(ReferenceParm)
...
static_assert(sizeof(WBP_GameOver_Defeat_C_SetHardcoreInfo) == 0x000200, "Wrong size on WBP_GameOver_Defeat_C_SetHardcoreInfo");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, Temp_byte_Variable) == 0x000000, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, Temp_byte_Variable_1) == 0x000001, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_IsClientDedicatedServer_ReturnValue) == 0x000002, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_IsClientDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_GetOptionSubsystem_ReturnValue) == 0x000008, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_GetOptionSubsystem_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_GetOptionWorldSettings_ReturnValue) == 0x000010, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_GetOptionWorldSettings_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, Temp_bool_Variable) == 0x0001B0, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_GetLocalPlayerState_ReturnValue) == 0x0001B8, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_GetLocalPlayerState_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_BooleanAND_ReturnValue) == 0x0001C0, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_IsInStage_ReturnValue) == 0x0001C1, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_IsInStage_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, K2Node_Select_Default) == 0x0001C2, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, K2Node_MakeArray_Array) == 0x0001C8, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, CallFunc_GetLocalizedText_ReturnValue) == 0x0001D8, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::CallFunc_GetLocalizedText_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_GameOver_Defeat_C_SetHardcoreInfo, K2Node_MakeStruct_LinearColor) == 0x0001F0, "Member 'WBP_GameOver_Defeat_C_SetHardcoreInfo::K2Node_MakeStruct_LinearColor' has a wrong offset!");
