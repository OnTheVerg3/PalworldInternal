...
public:
	...
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OverlappedComponent_4;  // 0x0360(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_ComponentBoundEvent_OtherActor_4;           // 0x0368(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OtherComp_4;            // 0x0370(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_ComponentBoundEvent_OtherBodyIndex_4;       // 0x0378(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsServer_ReturnValue;                     // 0x037C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_37D[0x3];                                      // 0x037D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    K2Node_DynamicCast_AsPal_Player_Character_3;       // 0x0380(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalBossBattleManager*                  CallFunc_GetBossBattleManager_ReturnValue_1;       // 0x0390(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate;              // 0x0398(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EPalBossBattleDifficulty                      Temp_byte_Variable;                                // 0x03A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_1;                   // 0x03C0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class AActor* Other, EPalInteractiveObjectIndicatorType IndicatorType)> K2Node_CreateDelegate_OutputDelegate_1; // 0x03C8(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EPalBossBattleState                           K2Node_Event_NewState;                             // 0x03D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EPalBossBattleDifficulty                      Temp_byte_Variable_1;                              // 0x03D9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EPalBossBattleState                           CallFunc_GetBossBattleState_ReturnValue;           // 0x03DA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Array_Contains_ReturnValue;               // 0x03DB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_NotEqual_ByteByte_ReturnValue;            // 0x03DC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x03DD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_2;                    // 0x03DE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3DF[0x1];                                      // 0x03DF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_2;                   // 0x03E0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x03E8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3E9[0x7];                                      // 0x03E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class APalPlayerCharacter*                    CallFunc_GetPalmi_ReturnValue_3;                   // 0x03F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	EPalBossBattleDifficulty                      K2Node_Select_Default;                             // 0x03F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EPalBossBattleState                           CallFunc_GetBossBattleState_ReturnValue_1;         // 0x03F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue_1;        // 0x03FA(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_3;                    // 0x03FB(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue;            // 0x03FC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3FD[0x3];                                      // 0x03FD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IPalInteractiveObjectIndicatorInterface> CallFunc_SetIndicatorInterface_InIndicatorInterface_CastInput; // 0x0400(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OverlappedComponent_3;  // 0x0410(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                 K2Node_ComponentBoundEvent_OtherActor_3;           // 0x0418(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPrimitiveComponent*                    K2Node_ComponentBoundEvent_OtherComp_3;            // 0x0420(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_ComponentBoundEvent_OtherBodyIndex_3;       // 0x0428(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ComponentBoundEvent_bFromSweep_1;           // 0x042C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_42D[0x3];                                      // 0x042D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             K2Node_ComponentBoundEvent_SweepResult_1;          // 0x0430(0x00E8)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	TScriptInterface<class IPalInteractiveInterface> CallFunc_BindOnTriggerInteract_self_CastInput;  // 0x0518(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue_1;    // 0x054D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                             K2Node_ComponentBoundEvent_SweepResult;            // 0x0570(0x00E8)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue_2;    // 0x0670(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanAND_ReturnValue_1;                 // 0x0671(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_ObjectObject_ReturnValue_3;    // 0x0694(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGuid                                  CallFunc_GetLocalPlayerUID_ReturnValue;            // 0x06B0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsLocked_ReturnValue;                     // 0x06C0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_6C1[0x7];                                      // 0x06C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalQuestManager*                       CallFunc_GetLocalQuestManager_ReturnValue;         // 0x06C8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<class UPalQuestData*>                  CallFunc_GetAllOrderedQuest_ReturnValue;           // 0x06D0(0x0010)(ConstParm, ReferenceParm)
	...
	class UPalQuestData*                          CallFunc_Array_Get_Item;                           // 0x06E8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   CallFunc_GetQuestId_ReturnValue;                   // 0x06F4(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x06FC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(const class FName& QuestId)>   K2Node_CreateDelegate_OutputDelegate_2;            // 0x0700(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(const class FName& QuestId)>   K2Node_CreateDelegate_OutputDelegate_3;            // 0x0714(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower) == 0x000728, "Wrong size on BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower");
...
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, Temp_int_Array_Index_Variable) == 0x000004, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::Temp_int_Array_Index_Variable' has a wrong offset!");
...
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, Temp_int_Loop_Counter_Variable) == 0x000354, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_Add_IntInt_ReturnValue) == 0x000358, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OverlappedComponent_4) == 0x000360, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OverlappedComponent_4' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherActor_4) == 0x000368, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherActor_4' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherComp_4) == 0x000370, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherComp_4' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherBodyIndex_4) == 0x000378, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherBodyIndex_4' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsServer_ReturnValue) == 0x00037C, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_DynamicCast_AsPal_Player_Character_3) == 0x000380, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_DynamicCast_AsPal_Player_Character_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_DynamicCast_bSuccess_3) == 0x000388, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_DynamicCast_bSuccess_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetBossBattleManager_ReturnValue_1) == 0x000390, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetBossBattleManager_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_CreateDelegate_OutputDelegate) == 0x000398, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, Temp_byte_Variable) == 0x0003A8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x0003B0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetPalmi_ReturnValue) == 0x0003B8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetPalmi_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetPalmi_ReturnValue_1) == 0x0003C0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetPalmi_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_CreateDelegate_OutputDelegate_1) == 0x0003C8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_Event_NewState) == 0x0003D8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_Event_NewState' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, Temp_byte_Variable_1) == 0x0003D9, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetBossBattleState_ReturnValue) == 0x0003DA, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetBossBattleState_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_Array_Contains_ReturnValue) == 0x0003DB, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x0003DC, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsValid_ReturnValue_1) == 0x0003DD, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsValid_ReturnValue_2) == 0x0003DE, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetPalmi_ReturnValue_2) == 0x0003E0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetPalmi_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, Temp_bool_Variable) == 0x0003E8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetPalmi_ReturnValue_3) == 0x0003F0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetPalmi_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_Select_Default) == 0x0003F8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetBossBattleState_ReturnValue_1) == 0x0003F9, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetBossBattleState_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x0003FA, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsValid_ReturnValue_3) == 0x0003FB, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsValid_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsDedicatedServer_ReturnValue) == 0x0003FC, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsDedicatedServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_SetIndicatorInterface_InIndicatorInterface_CastInput) == 0x000400, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_SetIndicatorInterface_InIndicatorInterface_CastInput' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OverlappedComponent_3) == 0x000410, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OverlappedComponent_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherActor_3) == 0x000418, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherActor_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherComp_3) == 0x000420, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherComp_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherBodyIndex_3) == 0x000428, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherBodyIndex_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_bFromSweep_1) == 0x00042C, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_bFromSweep_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_SweepResult_1) == 0x000430, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_SweepResult_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_BindOnTriggerInteract_self_CastInput) == 0x000518, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_BindOnTriggerInteract_self_CastInput' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x000528, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OverlappedComponent_2) == 0x000530, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OverlappedComponent_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherActor_2) == 0x000538, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherActor_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherComp_2) == 0x000540, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherComp_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherBodyIndex_2) == 0x000548, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherBodyIndex_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_BooleanAND_ReturnValue) == 0x00054C, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_EqualEqual_ObjectObject_ReturnValue_1) == 0x00054D, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_EqualEqual_ObjectObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OverlappedComponent_1) == 0x000550, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OverlappedComponent_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherActor_1) == 0x000558, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherActor_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherComp_1) == 0x000560, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherComp_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherBodyIndex_1) == 0x000568, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherBodyIndex_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_bFromSweep) == 0x00056C, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_bFromSweep' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_SweepResult) == 0x000570, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_SweepResult' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000658, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_EqualEqual_ObjectObject_ReturnValue_2) == 0x000670, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_EqualEqual_ObjectObject_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_BooleanAND_ReturnValue_1) == 0x000671, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OverlappedComponent) == 0x000678, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OverlappedComponent' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherActor) == 0x000680, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherActor' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherComp) == 0x000688, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherComp' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_ComponentBoundEvent_OtherBodyIndex) == 0x000690, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_ComponentBoundEvent_OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_EqualEqual_ObjectObject_ReturnValue_3) == 0x000694, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_EqualEqual_ObjectObject_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_K2_GetComponentLocation_ReturnValue_1) == 0x000698, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_K2_GetComponentLocation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetLocalPlayerUID_ReturnValue) == 0x0006B0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetLocalPlayerUID_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsLocked_ReturnValue) == 0x0006C0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsLocked_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetLocalQuestManager_ReturnValue) == 0x0006C8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetLocalQuestManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetAllOrderedQuest_ReturnValue) == 0x0006D0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetAllOrderedQuest_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsValid_ReturnValue_4) == 0x0006E0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsValid_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_Array_Get_Item) == 0x0006E8, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_IsValid_ReturnValue_5) == 0x0006F0, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_IsValid_ReturnValue_5' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_GetQuestId_ReturnValue) == 0x0006F4, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_GetQuestId_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_Array_Length_ReturnValue) == 0x0006FC, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_CreateDelegate_OutputDelegate_2) == 0x000700, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_CreateDelegate_OutputDelegate_2' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, CallFunc_Less_IntInt_ReturnValue) == 0x000710, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower, K2Node_CreateDelegate_OutputDelegate_3) == 0x000714, "Member 'BP_PalBossTower_C_ExecuteUbergraph_BP_PalBossTower::K2Node_CreateDelegate_OutputDelegate_3' has a wrong offset!");
...
// Function BP_PalBossTower.BP_PalBossTower_C.OnCompleteQuestLocal
// 0x0020 (0x0020 - 0x0000)
struct BP_PalBossTower_C_OnCompleteQuestLocal final
{
public:
...
static_assert(alignof(BP_PalBossTower_C_OnCompleteQuestLocal) == 0x000008, "Wrong alignment on BP_PalBossTower_C_OnCompleteQuestLocal");
static_assert(sizeof(BP_PalBossTower_C_OnCompleteQuestLocal) == 0x000020, "Wrong size on BP_PalBossTower_C_OnCompleteQuestLocal");
static_assert(offsetof(BP_PalBossTower_C_OnCompleteQuestLocal, QuestId) == 0x000000, "Member 'BP_PalBossTower_C_OnCompleteQuestLocal::QuestId' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_OnCompleteQuestLocal, CallFunc_Map_Find_Value) == 0x000008, "Member 'BP_PalBossTower_C_OnCompleteQuestLocal::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_OnCompleteQuestLocal, CallFunc_Map_Find_ReturnValue) == 0x000018, "Member 'BP_PalBossTower_C_OnCompleteQuestLocal::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_OnCompleteQuestLocal, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000019, "Member 'BP_PalBossTower_C_OnCompleteQuestLocal::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");

// Function BP_PalBossTower.BP_PalBossTower_C.OnOrderedQuestLocal
// 0x0020 (0x0020 - 0x0000)
struct BP_PalBossTower_C_OnOrderedQuestLocal final
{
public:
	class FName                                   QuestId;                                           // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDataTableRowHandle                    CallFunc_Map_Find_Value;                           // 0x0008(0x0010)(NoDestructor)
...
static_assert(alignof(BP_PalBossTower_C_OnOrderedQuestLocal) == 0x000008, "Wrong alignment on BP_PalBossTower_C_OnOrderedQuestLocal");
static_assert(sizeof(BP_PalBossTower_C_OnOrderedQuestLocal) == 0x000020, "Wrong size on BP_PalBossTower_C_OnOrderedQuestLocal");
static_assert(offsetof(BP_PalBossTower_C_OnOrderedQuestLocal, QuestId) == 0x000000, "Member 'BP_PalBossTower_C_OnOrderedQuestLocal::QuestId' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_OnOrderedQuestLocal, CallFunc_Map_Find_Value) == 0x000008, "Member 'BP_PalBossTower_C_OnOrderedQuestLocal::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_OnOrderedQuestLocal, CallFunc_Map_Find_ReturnValue) == 0x000018, "Member 'BP_PalBossTower_C_OnOrderedQuestLocal::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_PalBossTower_C_OnOrderedQuestLocal, CallFunc_EqualEqual_NameName_ReturnValue) == 0x000019, "Member 'BP_PalBossTower_C_OnOrderedQuestLocal::CallFunc_EqualEqual_NameName_ReturnValue' has a wrong offset!");
