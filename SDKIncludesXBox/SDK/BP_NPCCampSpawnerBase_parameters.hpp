...
public:
	...
	class UPalGameSetting*                        CallFunc_GetGameSetting_ReturnValue_1;             // 0x00F0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UPalNPCManager*                         CallFunc_GetNPCManager_ReturnValue;                // 0x0108(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FPalEnemyCampStatus                    CallFunc_GetEnemyCampStatus_ReturnValue;           // 0x0110(0x0080)()
	...
	class UPalNPCManager*                         CallFunc_GetNPCManager_ReturnValue_1;              // 0x01B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Array_IsEmpty_ReturnValue;                // 0x01B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Array_RemoveItem_ReturnValue;             // 0x01B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_NPCCampSpawnerBase_C_OnEnemyDead) == 0x0001D0, "Wrong size on BP_NPCCampSpawnerBase_C_OnEnemyDead");
...
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_UtcNow_ReturnValue) == 0x0000D0, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_UtcNow_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_GetIndividualCharacterHandleByActor_ReturnValue) == 0x0000D8, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_GetIndividualCharacterHandleByActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_IsValid_ReturnValue) == 0x0000E0, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_GetGameSetting_ReturnValue) == 0x0000E8, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_GetGameSetting_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_GetGameSetting_ReturnValue_1) == 0x0000F0, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_GetGameSetting_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x0000F8, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x000100, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_GetNPCManager_ReturnValue) == 0x000108, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_GetNPCManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_GetEnemyCampStatus_ReturnValue) == 0x000110, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_GetEnemyCampStatus_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Conv_NameToString_ReturnValue) == 0x000190, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Conv_NameToString_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Concat_StrStr_ReturnValue) == 0x0001A0, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Concat_StrStr_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_GetNPCManager_ReturnValue_1) == 0x0001B0, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_GetNPCManager_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Array_IsEmpty_ReturnValue) == 0x0001B8, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Array_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Array_RemoveItem_ReturnValue) == 0x0001B9, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Array_Contains_ReturnValue) == 0x0001BA, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x0001C0, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnEnemyDead, CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1) == 0x0001C8, "Member 'BP_NPCCampSpawnerBase_C_OnEnemyDead::CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
...
public:
	...
	class UPalGameSetting*                        CallFunc_GetGameSetting_ReturnValue_1;             // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UPalNPCManager*                         CallFunc_GetNPCManager_ReturnValue_1;              // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalEnemyCampStatus                    CallFunc_GetEnemyCampStatus_ReturnValue;           // 0x00B8(0x0080)()
...
static_assert(sizeof(BP_NPCCampSpawnerBase_C_OnReceivedReward) == 0x000148, "Wrong size on BP_NPCCampSpawnerBase_C_OnReceivedReward");
...
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_GetNPCManager_ReturnValue) == 0x000080, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_GetNPCManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_UtcNow_ReturnValue) == 0x000088, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_UtcNow_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_GetGameSetting_ReturnValue) == 0x000090, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_GetGameSetting_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000098, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_GetGameSetting_ReturnValue_1) == 0x0000A0, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_GetGameSetting_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_GetNPCManager_ReturnValue_1) == 0x0000A8, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_GetNPCManager_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_Multiply_DoubleDouble_ReturnValue_1) == 0x0000B0, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_Multiply_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_GetEnemyCampStatus_ReturnValue) == 0x0000B8, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_GetEnemyCampStatus_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_Multiply_DoubleDouble_A_ImplicitCast) == 0x000138, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_Multiply_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_OnReceivedReward, CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1) == 0x000140, "Member 'BP_NPCCampSpawnerBase_C_OnReceivedReward::CallFunc_Multiply_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
...
static_assert(sizeof(BP_NPCCampSpawnerBase_C_RandomLottery) == 0x000118, "Wrong size on BP_NPCCampSpawnerBase_C_RandomLottery");
...
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, SelectedIndex) == 0x000008, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::SelectedIndex' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, RandomValue) == 0x000010, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::RandomValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, AddWeight) == 0x000018, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::AddWeight' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, TotalWeight) == 0x000020, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::TotalWeight' has a wrong offset!");
...
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, Temp_int_Loop_Counter_Variable) == 0x00002C, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Add_IntInt_ReturnValue) == 0x000030, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, Temp_int_Array_Index_Variable_1) == 0x000034, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_GetNPCManager_ReturnValue) == 0x000038, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_GetNPCManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_GetEnemyCampStatus_ReturnValue) == 0x000040, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_GetEnemyCampStatus_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_IsProbabilitySuccess_Success) == 0x0000C0, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_IsProbabilitySuccess_Success' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Array_IsValidIndex_ReturnValue) == 0x0000C1, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, Temp_int_Loop_Counter_Variable_1) == 0x0000C4, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Array_Get_Item) == 0x0000C8, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Array_Length_ReturnValue) == 0x0000D8, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Less_IntInt_ReturnValue) == 0x0000DC, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Add_IntInt_ReturnValue_1) == 0x0000E0, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Array_Get_Item_1) == 0x0000E8, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Array_Length_ReturnValue_1) == 0x0000F8, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Less_IntInt_ReturnValue_1) == 0x0000FC, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_GreaterEqual_DoubleDouble_ReturnValue) == 0x0000FD, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_GreaterEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000100, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_RandomFloatInRange_ReturnValue) == 0x000108, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_RandomFloatInRange_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_RandomLottery, CallFunc_Add_DoubleDouble_ReturnValue_1) == 0x000110, "Member 'BP_NPCCampSpawnerBase_C_RandomLottery::CallFunc_Add_DoubleDouble_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(BP_NPCCampSpawnerBase_C_SetupCampStatus) == 0x000130, "Wrong size on BP_NPCCampSpawnerBase_C_SetupCampStatus");
...
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_CalcRemainRespawnTime_ReturnValue) == 0x000080, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_CalcRemainRespawnTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_CalcRemainDespawnTime_ReturnValue) == 0x000084, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_CalcRemainDespawnTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_Less_DoubleDouble_ReturnValue) == 0x000088, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_GetNPCManager_ReturnValue) == 0x000090, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_GetNPCManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_GetEnemyCampStatus_ReturnValue) == 0x000098, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_GetEnemyCampStatus_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_StartRespawnTimer_RespawnTime_ImplicitCast) == 0x000118, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_StartRespawnTimer_RespawnTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_StartDespawnTimer_DespawnTime_ImplicitCast) == 0x000120, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_StartDespawnTimer_DespawnTime_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_SetupCampStatus, CallFunc_Less_DoubleDouble_A_ImplicitCast) == 0x000128, "Member 'BP_NPCCampSpawnerBase_C_SetupCampStatus::CallFunc_Less_DoubleDouble_A_ImplicitCast' has a wrong offset!");
...
public:
	...
	struct FPalEnemyCampStatus                    CallFunc_GetEnemyCampStatus_ReturnValue;           // 0x0010(0x0080)()
	TDelegate<void(class UPalIndividualCharacterHandle* NewParam)> K2Node_CreateDelegate_OutputDelegate; // 0x0090(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class UClass*                                 CallFunc_RandomLottery_ResultClass;                // 0x00A8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_RandomLottery_SelectedIndex;              // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FPalEnemyCampStatus                    K2Node_MakeStruct_PalEnemyCampStatus;              // 0x0120(0x0080)()
...
static_assert(sizeof(BP_NPCCampSpawnerBase_C_TryCampSpawn) == 0x0001C0, "Wrong size on BP_NPCCampSpawnerBase_C_TryCampSpawn");
...
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_GetEnemyCampStatus_ReturnValue) == 0x000010, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_GetEnemyCampStatus_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, K2Node_CreateDelegate_OutputDelegate) == 0x000090, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_BooleanOR_ReturnValue) == 0x0000A0, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_IsValid_ReturnValue) == 0x0000A1, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_RandomLottery_ResultClass) == 0x0000A8, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_RandomLottery_ResultClass' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_RandomLottery_SelectedIndex) == 0x0000B0, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_RandomLottery_SelectedIndex' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_GetTransform_ReturnValue) == 0x0000C0, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_GetTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, K2Node_MakeStruct_PalEnemyCampStatus) == 0x000120, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::K2Node_MakeStruct_PalEnemyCampStatus' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue) == 0x0001A0, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_FinishSpawningActor_ReturnValue) == 0x0001A8, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_FinishSpawningActor_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_NPCCampSpawnerBase_C_TryCampSpawn, CallFunc_IsValidClass_ReturnValue) == 0x0001B0, "Member 'BP_NPCCampSpawnerBase_C_TryCampSpawn::CallFunc_IsValidClass_ReturnValue' has a wrong offset!");
