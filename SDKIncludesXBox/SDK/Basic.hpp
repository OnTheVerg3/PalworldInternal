...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0873F760;
	constexpr int32 AppendString      = 0x02F9AED0;
	constexpr int32 GNames            = 0x086A03C0;
	constexpr int32 GWorld            = 0x088ADFA0;
	constexpr int32 ProcessEvent      = 0x031190A0;
