...
namespace Offsets
{
	constexpr int32 GObjects          = 0x086E1E60;
	constexpr int32 AppendString      = 0x02F5E7F0;
	constexpr int32 GNames            = 0x08642AC0;
	constexpr int32 GWorld            = 0x088506A0;
	constexpr int32 ProcessEvent      = 0x030DB960;
