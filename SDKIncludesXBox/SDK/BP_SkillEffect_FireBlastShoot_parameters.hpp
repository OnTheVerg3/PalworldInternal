...
static_assert(alignof(BP_SkillEffect_FireBlastShoot_C_OnDestroyed_イベント_0) == 0x000008, "Wrong alignment on BP_SkillEffect_FireBlastShoot_C_OnDestroyed_イベント_0");
static_assert(sizeof(BP_SkillEffect_FireBlastShoot_C_OnDestroyed_イベント_0) == 0x000008, "Wrong size on BP_SkillEffect_FireBlastShoot_C_OnDestroyed_イベント_0");
static_assert(offsetof(BP_SkillEffect_FireBlastShoot_C_OnDestroyed_イベント_0, DestroyedActor) == 0x000000, "Member 'BP_SkillEffect_FireBlastShoot_C_OnDestroyed_イベント_0::DestroyedActor' has a wrong offset!");
...
static_assert(alignof(BP_SkillEffect_FireBlastShoot_C_OnSystemFinished_イベント_0) == 0x000008, "Wrong alignment on BP_SkillEffect_FireBlastShoot_C_OnSystemFinished_イベント_0");
static_assert(sizeof(BP_SkillEffect_FireBlastShoot_C_OnSystemFinished_イベント_0) == 0x000008, "Wrong size on BP_SkillEffect_FireBlastShoot_C_OnSystemFinished_イベント_0");
static_assert(offsetof(BP_SkillEffect_FireBlastShoot_C_OnSystemFinished_イベント_0, PSystem) == 0x000000, "Member 'BP_SkillEffect_FireBlastShoot_C_OnSystemFinished_イベント_0::PSystem' has a wrong offset!");
