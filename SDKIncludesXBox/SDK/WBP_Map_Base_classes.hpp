...
public:
	...
	class UWBP_WorldMap_IconBase_NoDesign_C*      CurrentSelectedFTIcon;                             // 0x06B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class FName                                   ShowQuestActionName;                               // 0x06C0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TMulticastInlineDelegate<void(class FName QuestId)> OnRequestShowQuest;                          // 0x06C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TArray<class UWBP_Map_IconBoss_C*>            NewVar;                                            // 0x06D8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
...
static_assert(sizeof(UWBP_Map_Base_C) == 0x0006E8, "Wrong size on UWBP_Map_Base_C");
...
static_assert(offsetof(UWBP_Map_Base_C, CurrentSelectedFTIcon) == 0x0006B8, "Member 'UWBP_Map_Base_C::CurrentSelectedFTIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, ShowQuestActionName) == 0x0006C0, "Member 'UWBP_Map_Base_C::ShowQuestActionName' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, OnRequestShowQuest) == 0x0006C8, "Member 'UWBP_Map_Base_C::OnRequestShowQuest' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, NewVar) == 0x0006D8, "Member 'UWBP_Map_Base_C::NewVar' has a wrong offset!");
