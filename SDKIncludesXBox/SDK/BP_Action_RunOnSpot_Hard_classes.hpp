...
static_assert(sizeof(UBP_Action_RunOnSpot_Hard_C) == 0x000170, "Wrong size on UBP_Action_RunOnSpot_Hard_C");
static_assert(offsetof(UBP_Action_RunOnSpot_Hard_C, UberGraphFrame_BP_Action_RunOnSpot_Hard_C) == 0x000168, "Member 'UBP_Action_RunOnSpot_Hard_C::UberGraphFrame_BP_Action_RunOnSpot_Hard_C' has a wrong offset!");
