...
static_assert(sizeof(UBP_AIAction_CanCombatBase_C) == 0x000160, "Wrong size on UBP_AIAction_CanCombatBase_C");
...
static_assert(offsetof(UBP_AIAction_CanCombatBase_C, KeepDamageReaction) == 0x000158, "Member 'UBP_AIAction_CanCombatBase_C::KeepDamageReaction' has a wrong offset!");
